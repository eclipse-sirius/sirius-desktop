...
cp -a "$BUILD_TYPE/$FULL_VERSION/$PLATFORM/targets" "$TARGET_ROOT/$VERSION/$PLATFORM/targets"
...
cp -a "$BUILD_TYPE/$FULL_VERSION/$PLATFORM/targets" "$TARGET_ROOT/$STREAM/$PLATFORM/targets"
