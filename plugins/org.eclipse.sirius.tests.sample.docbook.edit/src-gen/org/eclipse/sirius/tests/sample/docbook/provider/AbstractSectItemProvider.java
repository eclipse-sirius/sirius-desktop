 ...
 * {@link org.eclipse.sirius.tests.sample.docbook.AbstractSect} object. <!--
...
IItemPropertySource {
     ...
     * @generated
     */
    public AbstractSectItemProvider(AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DocbookPackage.Literals.ABSTRACT_SECT__TITLE);
            childrenFeatures.add(DocbookPackage.Literals.ABSTRACT_SECT__PARA);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(AbstractSect.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(DocbookPackage.Literals.ABSTRACT_SECT__TITLE, DocbookFactory.eINSTANCE.createTitle()));

        newChildDescriptors.add(createChildParameter(DocbookPackage.Literals.ABSTRACT_SECT__PARA, DocbookFactory.eINSTANCE.createPara()));
    }
