 ...
 *
 */
public class Sect1PropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, Sect1PropertiesEditionPart {
     ...
     *
     */
    public Sect1PropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
        ...
        composer = new PartComposer(sect1Step) {
            ...
            public Composite addToPart(Composite parent, Object key) {
                ...
                if (key == DocbookViewsRepository.Sect1.Properties.sect2) {
                    return createSect2AdvancedTableComposition(parent);
                }
                return parent;
            }
        };
    ...
    protected Composite createPropertiesGroup(Composite parent) {
        ...
        propertiesGroup.setText(DocbookMessages.Sect1PropertiesEditionPart_PropertiesGroupLabel);
    ...
    protected Composite createParaAdvancedTableComposition(Composite parent) {
        this.para = new ReferencesTable(getDescription(DocbookViewsRepository.Sect1.Properties.para, DocbookMessages.Sect1PropertiesEditionPart_ParaLabel), new ReferencesTableListener() {
            ...
            public void handleAdd() {
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(Sect1PropertiesEditionPartImpl.this, DocbookViewsRepository.Sect1.Properties.para,
        ...
        this.para.setHelpText(propertiesEditionComponent.getHelpContent(DocbookViewsRepository.Sect1.Properties.para, DocbookViewsRepository.SWT_KIND));
    ...
    protected Composite createIdText(Composite parent) {
        ...
        SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(DocbookViewsRepository.Sect1.Properties.id, DocbookViewsRepository.SWT_KIND), null);
     ...
     *
     */
    protected Composite createSect2AdvancedTableComposition(Composite parent) {
        this.sect2 = new ReferencesTable(getDescription(DocbookViewsRepository.Sect1.Properties.sect2, DocbookMessages.Sect1PropertiesEditionPart_Sect2Label), new ReferencesTableListener() {
            @Override
            public void handleAdd() {
                propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(Sect1PropertiesEditionPartImpl.this, DocbookViewsRepository.Sect1.Properties.sect2,
                        PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
                sect2.refresh();
            }
        ...
        this.sect2.setHelpText(propertiesEditionComponent.getHelpContent(DocbookViewsRepository.Sect1.Properties.sect2, DocbookViewsRepository.SWT_KIND));
        this.sect2.createControls(parent);
        ...
        // Start of user code for createSect2AdvancedTableComposition
