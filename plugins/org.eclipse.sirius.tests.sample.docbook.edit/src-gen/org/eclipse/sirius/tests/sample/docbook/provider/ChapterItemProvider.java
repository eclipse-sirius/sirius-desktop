 ...
 * {@link org.eclipse.sirius.tests.sample.docbook.Chapter} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ChapterItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DocbookPackage.Literals.CHAPTER__TITLE);
            childrenFeatures.add(DocbookPackage.Literals.CHAPTER__PARA);
            childrenFeatures.add(DocbookPackage.Literals.CHAPTER__SECT1);
        }
    ...
    /**
     * This returns Chapter.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(Chapter.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(DocbookPackage.Literals.CHAPTER__TITLE, DocbookFactory.eINSTANCE.createTitle()));

        newChildDescriptors.add(createChildParameter(DocbookPackage.Literals.CHAPTER__PARA, DocbookFactory.eINSTANCE.createPara()));

        newChildDescriptors.add(createChildParameter(DocbookPackage.Literals.CHAPTER__SECT1, DocbookFactory.eINSTANCE.createSect1()));
    }
