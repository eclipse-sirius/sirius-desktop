...
import org.eclipse.sirius.model.business.internal.metamodel.description.tool.spec.GroupMenuSpec;
import org.eclipse.sirius.model.business.internal.metamodel.description.tool.spec.PasteDescriptionSpec;
...
public class ToolFactoryImpl extends EFactoryImpl implements ToolFactory {
    ...
    public PasteDescription createPasteDescription() {
        ...
        newViewContainer.setName("containerView"); //$NON-NLS-1$
        DropContainerVariable newContainer = createDropContainerVariable();
        newContainer.setName("container"); //$NON-NLS-1$

        ElementVariable copiedElement = createElementVariable();
        copiedElement.setName("copiedElement"); //$NON-NLS-1$
        ElementViewVariable copiedView = createElementViewVariable();
        copiedView.setName("copiedView"); //$NON-NLS-1$
