...
public class ExtReferenceWidgetStyleItemProvider extends WidgetStyleItemProvider implements IItemStyledLabelProvider {
     ...
     * @generated
     */
    public ExtReferenceWidgetStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtReferenceWidgetStyle")); //$NON-NLS-1$
    }
    ...
    public Object getStyledText(Object object) {
        String label = ((ExtReferenceWidgetStyle) object).getLabelFontNameExpression();
        StyledString styledLabel = new StyledString();
        if (label == null || label.length() == 0) {
            styledLabel.append(getString("_UI_ExtReferenceWidgetStyle_type"), StyledString.Style.QUALIFIER_STYLER); //$NON-NLS-1$
        } else {
            styledLabel.append(getString("_UI_ExtReferenceWidgetStyle_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
