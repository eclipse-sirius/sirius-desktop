...
* The method @org.eclipse.sirius.ui.tools.api.assist.TextContentProposalProvider.bindCompletionProcessor(final AbstractPropertySection section, final Text text)@ has been added to create the binding between a property section and the auto-completion list.
