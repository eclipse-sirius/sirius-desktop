...
* The @ContainerMapping.createContainer()@ EOperation has been removed. Although its usage is discouraged, if you really need to  you can use the internal @ContainerMappingHelper@ instead: @new ContainerMappingHelper(SiriusPlugin.getDefault().getInterpreterRegistry().getInterpreter(semanticParent)).createContainer(mapping, semanticElement, semanticParent, diagram)@.
* The @ContainerMapping.updateContainer()@ EOperation has been removed. Although its usage is discouraged, if you really need to  you can use the internal @ContainerMappingHelper@ instead: @new ContainerMappingHelper(SiriusPlugin.getDefault().getInterpreterRegistry().getInterpreter(containerView)).updateContainer(mapping, containerView)@.
