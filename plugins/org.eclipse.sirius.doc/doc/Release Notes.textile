...
* The methods @org.eclipse.sirius.table.business.api.helper.TableHelper.getColumn()@ has been removed because they are not useful, @TableHelper.getColumn(line, columnIndex)@ can be replaced by @DTable.getColumns().get(columnIndex)@ and @TableHelper.getColumn(table, featureName)@ should not be used as we can have several columns with a same featureName.
* The method @org.eclipse.sirius.table.business.api.helper.TableHelper.getEClassifier(line, columnIndex)@ has been removed because it is not useful, use @TableHelper.getEClassifier(line, column)@ instead.
* The method @org.eclipse.sirius.table.business.api.helper.TableHelper.getTableElement(tableElementStyle)@ has been removed because it is not useful, @DTableElementStyle.eContainer()@ can be used instead.
* The methods @org.eclipse.sirius.table.business.api.helper.TableHelper.getCell()@ has been removed because they are not useful, use @DCellStyle.eContainer@ instead.
* The method @org.eclipse.sirius.table.business.api.helper.TableHelper.getCreateCellTool()@ has been removed because it is not useful, use @TableHelper.getCreateCellTool(line, column)@ instead.
