...
* The methods @org.eclipse.sirius.table.business.api.helper.TableHelper.getCell(DCellStyle)@ has been removedhas been removed because they are not useful, use @DCellStyle.eContainer@ instead.
