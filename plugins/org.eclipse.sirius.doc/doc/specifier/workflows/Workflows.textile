...
* The name of the project and its description. The description is an element stored in the .project file, in a @<comment>An UMLDesigner test project</comment>@ tag
