...
* <span class="label label-success">Added</span> @org.eclipse.sirius.tests.swtbot.support.api.editor.SWTBotSiriusDiagramEditor.dragCentered(String, Class<? extends EditPart>, int, int)@ method has been added to provide the EditPart class of the element that should be dragged by the center.
