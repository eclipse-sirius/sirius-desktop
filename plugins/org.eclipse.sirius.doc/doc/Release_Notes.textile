...
h2(#sirius7.0.8). Changes in Sirius 7.0.8

h3. User-Visible Changes

Minor release to provide auto-size or layout optimizations for containers with compartments. Those optimizations are disabled by default and can be enabled via three system properties:
...
h2(#sirius7.0.7). Changes in Sirius 7.0.7
...
h2(#sirius7.0.6). Changes in Sirius 7.0.6
...
* <span class="label label-info">Modified</span> Moved from Apache Batik 1.14 to version 1.16.
* <span class="label label-info">Modified</span> Moved from GEF Classic 3.11 to version 3.14.
* <span class="label label-info">Modified</span> Moved from GMF Notation 1.13.0 to version 1.13.1 (no code change).
* <span class="label label-info">Modified</span> Moved from GMF Runtime 1.14.2 to version 1.15.3.
* <span class="label label-info">Modified</span> Moved from EEF 2.1.5 to version 2.1.6.

h2(#sirius7.0.5). Changes in Sirius 7.0.5
