...
* <span class="label label-info">Modified</span>JRE17 is required to use Sirius.
...
* <span class="label label-info">Modified</span>Java 17 is required as BREE and source level. But the runtime compatibility is already effective since Sirius 7.0.
