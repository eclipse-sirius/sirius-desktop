...
h2(#sirius7.1.1). Changes in Sirius 7.1.2

This release contains a single fix for [a small bug on diagrams](https://github.com/eclipse-sirius/sirius-desktop/issues/193) and no other visible change.

h2(#sirius7.1.1). Changes in Sirius 7.1.1
