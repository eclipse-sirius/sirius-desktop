...
* The addition of an 'interaction container mapping' to the sequence metamodel introduced new API classes such as:</br>
	- @org.eclipse.sirius.diagram.sequence.business.internal.elements.InteractionContainer@ to determine a View element should be represented as an InteractionContainer; </br>
	- @org.eclipse.sirius.diagram.sequence.description.InteractionContainerMapping@ to specify an 'interaction container mapping' in a sequence diagram</br> 
