...
* <span class="label label-success">Added</span> A new condition is available to wait that a view is activated: @org.eclipse.sirius.tests.swtbot.support.api.condition.ViewIsActivatedCondition@.
