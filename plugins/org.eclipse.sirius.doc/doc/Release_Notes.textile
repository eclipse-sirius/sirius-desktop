...
* <span class="label label-danger">Removed</span> The deprecated method @org.eclipse.sirius.common.tools.api.interpreter.IInterpreterContext#getTargetTypes()@ has been removed. Use @getTargetType()@ instead: it returns a @VariableType@ which supports multiple possible types directly.
...
* Constants have been added in @org.eclipse.sirius.diagram.ui.tools.api.image.DiagramImagesPath@ for the icon path of the four new straighten actions.
