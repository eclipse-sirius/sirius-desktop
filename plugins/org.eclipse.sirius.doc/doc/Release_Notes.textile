...
* <span class="label label-success">Added</span> Opening a sequence diagram where there are message with proxy anchors now warn the user by logging a message in the error log about the message to move to reset it, or the diagram to delete (see "bugzilla #525684":https://bugs.eclipse.org/bugs/show_bug.cgi?id=525684 for more details).
