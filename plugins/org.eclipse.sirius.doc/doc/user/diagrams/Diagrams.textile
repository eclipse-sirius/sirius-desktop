...
* It is not possible to pin/unpin compartments.
* For edges, the default layout behavior can be different according to the source/target pinned status:
...
__Customize__. You can locally customize your palette by editing name, description or hiding tools and tools sections. Tools sections can also be opened or pinned at start-up.

	!images/palette_customize_popup.png!

	!images/palette_customize_dialog.png!
