 ...
 * @author ymortier
 */
public class MandatoryDomainClassConstraint extends AbstractConstraint {
    ...
    private Object[] checkError(final EStructuralFeature domainClassFeature, final EObject eObj) {
        ...
        if ((value == null || (value instanceof String && StringUtil.isEmpty((String) value))) && !canHaveNullDomainClass) {
            return new Object[] {};
        }
        return null;
    }
