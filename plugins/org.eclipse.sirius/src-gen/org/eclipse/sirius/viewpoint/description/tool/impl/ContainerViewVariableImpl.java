...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Container View Variable</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.viewpoint.description.tool.impl.ContainerViewVariableImpl#getSubVariables <em>Sub
 * Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContainerViewVariableImpl extends AbstractVariableImpl implements ContainerViewVariable {
    /**
     ...
     * @generated
     */
    protected ContainerViewVariableImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.CONTAINER_VIEW_VARIABLE;
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == VariableContainer.class) {
            ...
            case ToolPackage.VARIABLE_CONTAINER__SUB_VARIABLES:
                return ToolPackage.CONTAINER_VIEW_VARIABLE__SUB_VARIABLES;
            default:
                return -1;
            }
        }
