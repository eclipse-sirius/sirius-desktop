 ...
 * <em><b>Conditional Node Style</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.description.impl.ConditionalNodeStyleDescriptionImpl#getStyle
 * <em>Style</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ConditionalNodeStyleDescriptionImpl extends ConditionalStyleDescriptionImpl implements ConditionalNodeStyleDescription {
    ...
    public NodeStyleDescription getStyle() {
        if (style != null && style.eIsProxy()) {
            ...
            if (style != oldStyle) {
                ...
                NotificationChain msgs = oldStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DescriptionPackage.CONDITIONAL_NODE_STYLE_DESCRIPTION__STYLE, null, null);
                if (newStyle.eInternalContainer() == null) {
                    msgs = newStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DescriptionPackage.CONDITIONAL_NODE_STYLE_DESCRIPTION__STYLE, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
    ...
    public void setStyle(NodeStyleDescription newStyle) {
        if (newStyle != style) {
            ...
            if (style != null)
                msgs = ((InternalEObject) style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DescriptionPackage.CONDITIONAL_NODE_STYLE_DESCRIPTION__STYLE, null, msgs);
            if (newStyle != null)
                msgs = ((InternalEObject) newStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DescriptionPackage.CONDITIONAL_NODE_STYLE_DESCRIPTION__STYLE, null, msgs);
