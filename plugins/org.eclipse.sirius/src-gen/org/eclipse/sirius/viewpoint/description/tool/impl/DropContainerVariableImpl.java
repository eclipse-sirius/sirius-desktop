...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Drop Container Variable</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.viewpoint.description.tool.impl.DropContainerVariableImpl#getSubVariables <em>Sub
 * Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DropContainerVariableImpl extends AbstractVariableImpl implements DropContainerVariable {
    /**
     ...
     * @generated
     */
    protected DropContainerVariableImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.DROP_CONTAINER_VARIABLE;
    }
    ...
    public EList<SubVariable> getSubVariables() {
        if (subVariables == null) {
            subVariables = new EObjectContainmentEList.Resolving<SubVariable>(SubVariable.class, this, ToolPackage.DROP_CONTAINER_VARIABLE__SUB_VARIABLES);
        }
        return subVariables;
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == VariableContainer.class) {
            ...
            case ToolPackage.VARIABLE_CONTAINER__SUB_VARIABLES:
                return ToolPackage.DROP_CONTAINER_VARIABLE__SUB_VARIABLES;
            default:
                return -1;
            }
        }
