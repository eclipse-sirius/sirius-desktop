...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Element Variable</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.viewpoint.description.tool.impl.ElementVariableImpl#getSubVariables <em>Sub
 * Variables</em>}</li>
 * </ul>
 *
 * @generated
...
public class ElementVariableImpl extends AbstractVariableImpl implements ElementVariable {
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.ELEMENT_VARIABLE;
    }
    ...
    public EList<SubVariable> getSubVariables() {
        if (subVariables == null) {
            subVariables = new EObjectContainmentEList.Resolving<SubVariable>(SubVariable.class, this, ToolPackage.ELEMENT_VARIABLE__SUB_VARIABLES);
        }
        return subVariables;
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == VariableContainer.class) {
            ...
            case ToolPackage.VARIABLE_CONTAINER__SUB_VARIABLES:
                return ToolPackage.ELEMENT_VARIABLE__SUB_VARIABLES;
            default:
                return -1;
            }
        }
