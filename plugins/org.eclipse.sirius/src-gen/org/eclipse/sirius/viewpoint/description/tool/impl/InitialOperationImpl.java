...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Initial Operation</b></em>'. <!-- end-user-doc
 * -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.viewpoint.description.tool.impl.InitialOperationImpl#getFirstModelOperations <em>First
 * Model Operations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitialOperationImpl extends MinimalEObjectImpl.Container implements InitialOperation {
    /**
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.INITIAL_OPERATION;
    }
    ...
    public ModelOperation getFirstModelOperations() {
        if (firstModelOperations != null && firstModelOperations.eIsProxy()) {
            ...
            if (firstModelOperations != oldFirstModelOperations) {
                ...
                NotificationChain msgs = oldFirstModelOperations.eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, null, null);
                if (newFirstModelOperations.eInternalContainer() == null) {
                    msgs = newFirstModelOperations.eInverseAdd(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, null, msgs);
                }
                if (msgs != null) {
                    msgs.dispatch();
                }
                if (eNotificationRequired()) {
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, oldFirstModelOperations, firstModelOperations));
                }
            }
        }
    ...
    public NotificationChain basicSetFirstModelOperations(ModelOperation newFirstModelOperations, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, oldFirstModelOperations, newFirstModelOperations);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setFirstModelOperations(ModelOperation newFirstModelOperations) {
        if (newFirstModelOperations != firstModelOperations) {
            ...
            if (firstModelOperations != null) {
                msgs = ((InternalEObject) firstModelOperations).eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, null, msgs);
            }
            if (newFirstModelOperations != null) {
                msgs = ((InternalEObject) newFirstModelOperations).eInverseAdd(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, newFirstModelOperations, newFirstModelOperations));
        }
    }
