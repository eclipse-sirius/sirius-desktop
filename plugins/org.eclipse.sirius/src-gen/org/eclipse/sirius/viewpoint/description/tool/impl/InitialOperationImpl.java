    ...
    public ModelOperation getFirstModelOperations() {
        if (firstModelOperations != null && firstModelOperations.eIsProxy()) {
            ...
            if (firstModelOperations != oldFirstModelOperations) {
                ...
                NotificationChain msgs = oldFirstModelOperations.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, null, null);
                if (newFirstModelOperations.eInternalContainer() == null) {
                    msgs = newFirstModelOperations.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
    ...
    public void setFirstModelOperations(ModelOperation newFirstModelOperations) {
        if (newFirstModelOperations != firstModelOperations) {
            ...
            if (firstModelOperations != null)
                msgs = ((InternalEObject) firstModelOperations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, null, msgs);
            if (newFirstModelOperations != null)
                msgs = ((InternalEObject) newFirstModelOperations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.INITIAL_OPERATION__FIRST_MODEL_OPERATIONS, null, msgs);
