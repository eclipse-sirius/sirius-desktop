 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.EllipseImpl#getHorizontalDiameter
 * <em>Horizontal Diameter</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.EllipseImpl#getVerticalDiameter
 * <em>Vertical Diameter</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.EllipseImpl#getColor <em>Color
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class EllipseImpl extends NodeStyleImpl implements Ellipse {
    ...
    protected EClass eStaticClass() {
        return ViewpointPackage.Literals.ELLIPSE;
    }
    ...
    public void setHorizontalDiameter(Integer newHorizontalDiameter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.ELLIPSE__HORIZONTAL_DIAMETER, oldHorizontalDiameter, horizontalDiameter));
    }
    ...
    public void setVerticalDiameter(Integer newVerticalDiameter) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.ELLIPSE__VERTICAL_DIAMETER, oldVerticalDiameter, verticalDiameter));
    }
    ...
    public RGBValues getColor() {
        if (color != null && color.eIsProxy()) {
            ...
            if (color != oldColor) {
                ...
                NotificationChain msgs = oldColor.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.ELLIPSE__COLOR, null, null);
                if (newColor.eInternalContainer() == null) {
                    msgs = newColor.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.ELLIPSE__COLOR, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.ELLIPSE__COLOR, oldColor, color));
            }
        }
        return color;
    }
    ...
    public NotificationChain basicSetColor(RGBValues newColor, NotificationChain msgs) {
        ...
        color = newColor;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewpointPackage.ELLIPSE__COLOR, oldColor, newColor);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setColor(RGBValues newColor) {
        if (newColor != color) {
            ...
            if (color != null)
                msgs = ((InternalEObject) color).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.ELLIPSE__COLOR, null, msgs);
            if (newColor != null)
                msgs = ((InternalEObject) newColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.ELLIPSE__COLOR, null, msgs);
            msgs = basicSetColor(newColor, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.ELLIPSE__COLOR, newColor, newColor));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ViewpointPackage.ELLIPSE__COLOR:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewpointPackage.ELLIPSE__HORIZONTAL_DIAMETER:
            return getHorizontalDiameter();
        case ViewpointPackage.ELLIPSE__VERTICAL_DIAMETER:
