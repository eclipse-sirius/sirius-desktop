 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ModelElement2ViewVariableImpl#getTypedKey
 * <em>Key</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ModelElement2ViewVariableImpl#getTypedValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ModelElement2ViewVariableImpl extends EObjectImpl implements BasicEMap.Entry<EObject, EMap<EObject, EMap<EObject, StyleDescription>>> {
    ...
    protected EClass eStaticClass() {
        return ViewpointPackage.Literals.MODEL_ELEMENT2_VIEW_VARIABLE;
    }
        ...
        if (key != null && key.eIsProxy()) {
            ...
            if (key != oldKey) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.MODEL_ELEMENT2_VIEW_VARIABLE__KEY, oldKey, key));
            }
        }
        return key;
    }
    ...
    public void setTypedKey(EObject newKey) {
        ...
        key = newKey;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.MODEL_ELEMENT2_VIEW_VARIABLE__KEY, oldKey, key));
    }
    ...
    public EMap<EObject, EMap<EObject, StyleDescription>> getTypedValue() {
        if (value == null) {
            value = new EcoreEMap<EObject, EMap<EObject, StyleDescription>>(ViewpointPackage.Literals.VIEW_VARIABLE2_CONTAINER_VARIABLE, ViewVariable2ContainerVariableImpl.class, this,
                    ViewpointPackage.MODEL_ELEMENT2_VIEW_VARIABLE__VALUE);
        }
        return value;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewpointPackage.MODEL_ELEMENT2_VIEW_VARIABLE__KEY:
            if (resolve)
                return getTypedKey();
