 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ContainerVariable2StyleDescriptionImpl#getTypedKey
 * <em>Key</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ContainerVariable2StyleDescriptionImpl#getTypedValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ContainerVariable2StyleDescriptionImpl extends EObjectImpl implements BasicEMap.Entry<EObject, StyleDescription> {
    ...
    protected EClass eStaticClass() {
        return ViewpointPackage.Literals.CONTAINER_VARIABLE2_STYLE_DESCRIPTION;
    }
        ...
        if (key != null && key.eIsProxy()) {
            ...
            if (key != oldKey) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.CONTAINER_VARIABLE2_STYLE_DESCRIPTION__KEY, oldKey, key));
            }
        }
        return key;
    }
    ...
    public void setTypedKey(EObject newKey) {
        ...
        key = newKey;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.CONTAINER_VARIABLE2_STYLE_DESCRIPTION__KEY, oldKey, key));
    }
    ...
    public StyleDescription getTypedValue() {
        if (value != null && value.eIsProxy()) {
            ...
            if (value != oldValue) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.CONTAINER_VARIABLE2_STYLE_DESCRIPTION__VALUE, oldValue, value));
            }
        }
        return value;
    }
    ...
    public void setTypedValue(StyleDescription newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.CONTAINER_VARIABLE2_STYLE_DESCRIPTION__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewpointPackage.CONTAINER_VARIABLE2_STYLE_DESCRIPTION__KEY:
            if (resolve)
                return getTypedKey();
            return basicGetTypedKey();
        case ViewpointPackage.CONTAINER_VARIABLE2_STYLE_DESCRIPTION__VALUE:
            if (resolve)
