 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ContainerStyleImpl#getDescription
 * <em>Description</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ContainerStyleImpl#getBorderSize
 * <em>Border Size</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ContainerStyleImpl#getBorderSizeComputationExpression
 * <em>Border Size Computation Expression</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ContainerStyleImpl#getBorderColor
...
public abstract class ContainerStyleImpl extends LabelStyleImpl implements ContainerStyle {
    ...
    protected EClass eStaticClass() {
        return ViewpointPackage.Literals.CONTAINER_STYLE;
    }
        ...
        if (description != null && description.eIsProxy()) {
            ...
            if (description != oldDescription) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.CONTAINER_STYLE__DESCRIPTION, oldDescription, description));
            }
        }
        return description;
    }
    ...
    public void setDescription(StyleDescription newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.CONTAINER_STYLE__DESCRIPTION, oldDescription, description));
    }
    ...
    public void setBorderSize(Integer newBorderSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.CONTAINER_STYLE__BORDER_SIZE, oldBorderSize, borderSize));
    }
    ...
    public void setBorderSizeComputationExpression(String newBorderSizeComputationExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.CONTAINER_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION, oldBorderSizeComputationExpression,
    ...
    public RGBValues getBorderColor() {
        if (borderColor != null && borderColor.eIsProxy()) {
            ...
            if (borderColor != oldBorderColor) {
                ...
                NotificationChain msgs = oldBorderColor.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR, null, null);
                if (newBorderColor.eInternalContainer() == null) {
                    msgs = newBorderColor.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR, oldBorderColor, borderColor));
            }
        }
        return borderColor;
    }
    ...
    public NotificationChain basicSetBorderColor(RGBValues newBorderColor, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR, oldBorderColor, newBorderColor);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setBorderColor(RGBValues newBorderColor) {
        if (newBorderColor != borderColor) {
            ...
            if (borderColor != null)
                msgs = ((InternalEObject) borderColor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR, null, msgs);
            if (newBorderColor != null)
                msgs = ((InternalEObject) newBorderColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR, null, msgs);
            msgs = basicSetBorderColor(newBorderColor, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR, newBorderColor, newBorderColor));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewpointPackage.CONTAINER_STYLE__DESCRIPTION:
            if (resolve)
                return getDescription();
            return basicGetDescription();
        case ViewpointPackage.CONTAINER_STYLE__BORDER_SIZE:
            return getBorderSize();
        case ViewpointPackage.CONTAINER_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION:
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == Style.class) {
            ...
            case ViewpointPackage.STYLE__DESCRIPTION:
                return ViewpointPackage.CONTAINER_STYLE__DESCRIPTION;
            default:
                return -1;
            }
        }
        if (baseClass == BorderedStyle.class) {
            ...
            case ViewpointPackage.BORDERED_STYLE__BORDER_SIZE:
                return ViewpointPackage.CONTAINER_STYLE__BORDER_SIZE;
            case ViewpointPackage.BORDERED_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION:
                return ViewpointPackage.CONTAINER_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION;
            case ViewpointPackage.BORDERED_STYLE__BORDER_COLOR:
                return ViewpointPackage.CONTAINER_STYLE__BORDER_COLOR;
            default:
                return -1;
            }
        }
