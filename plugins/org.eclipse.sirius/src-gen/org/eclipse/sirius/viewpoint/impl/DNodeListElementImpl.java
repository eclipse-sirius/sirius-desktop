 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DNodeListElementImpl#getOwnedBorderedNodes
 * <em>Owned Bordered Nodes</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DNodeListElementImpl#getArrangeConstraints
 * <em>Arrange Constraints</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DNodeListElementImpl#getOwnedStyle
 * <em>Owned Style</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DNodeListElementImpl#getOriginalStyle
 * <em>Original Style</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DNodeListElementImpl#getActualMapping
 * <em>Actual Mapping</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DNodeListElementImpl#getCandidatesMapping
...
public class DNodeListElementImpl extends DDiagramElementImpl implements DNodeListElement {
    ...
    public EList<DNode> getOwnedBorderedNodes() {
        if (ownedBorderedNodes == null) {
            ownedBorderedNodes = new EObjectContainmentEList.Resolving<DNode>(DNode.class, this, ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_BORDERED_NODES);
        }
    ...
    public NodeStyle getOwnedStyle() {
        if (ownedStyle != null && ownedStyle.eIsProxy()) {
            ...
            if (ownedStyle != oldOwnedStyle) {
                ...
                NotificationChain msgs = oldOwnedStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE, null, null);
                if (newOwnedStyle.eInternalContainer() == null) {
                    msgs = newOwnedStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE, oldOwnedStyle, ownedStyle));
            }
        }
        return ownedStyle;
    }
    ...
    public NotificationChain basicSetOwnedStyle(NodeStyle newOwnedStyle, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE, oldOwnedStyle, newOwnedStyle);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setOwnedStyle(NodeStyle newOwnedStyle) {
        if (newOwnedStyle != ownedStyle) {
            ...
            if (ownedStyle != null)
                msgs = ((InternalEObject) ownedStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE, null, msgs);
            if (newOwnedStyle != null)
                msgs = ((InternalEObject) newOwnedStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE, null, msgs);
            msgs = basicSetOwnedStyle(newOwnedStyle, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE, newOwnedStyle, newOwnedStyle));
    }
    ...
    public Style getOriginalStyle() {
        if (originalStyle != null && originalStyle.eIsProxy()) {
            ...
            if (originalStyle != oldOriginalStyle) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.DNODE_LIST_ELEMENT__ORIGINAL_STYLE, oldOriginalStyle, originalStyle));
            }
        }
    ...
    public void setOriginalStyle(Style newOriginalStyle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.DNODE_LIST_ELEMENT__ORIGINAL_STYLE, oldOriginalStyle, originalStyle));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_BORDERED_NODES:
            return ((InternalEList<?>) getOwnedBorderedNodes()).basicRemove(otherEnd, msgs);
        case ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case ViewpointPackage.DNODE_LIST_ELEMENT__ARRANGE_CONSTRAINTS:
            return getArrangeConstraints();
        case ViewpointPackage.DNODE_LIST_ELEMENT__OWNED_STYLE:
            if (resolve)
                return getOwnedStyle();
            return basicGetOwnedStyle();
        case ViewpointPackage.DNODE_LIST_ELEMENT__ORIGINAL_STYLE:
            if (resolve)
                return getOriginalStyle();
            return basicGetOriginalStyle();
        case ViewpointPackage.DNODE_LIST_ELEMENT__ACTUAL_MAPPING:
            if (resolve)
                return getActualMapping();
            return basicGetActualMapping();
        case ViewpointPackage.DNODE_LIST_ELEMENT__CANDIDATES_MAPPING:
