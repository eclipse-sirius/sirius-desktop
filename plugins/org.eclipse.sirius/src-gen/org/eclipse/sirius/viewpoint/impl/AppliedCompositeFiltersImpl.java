 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.AppliedCompositeFiltersImpl#getCompositeFilterDescriptions
...
public class AppliedCompositeFiltersImpl extends EObjectImpl implements AppliedCompositeFilters {
    ...
    protected EClass eStaticClass() {
        return ViewpointPackage.Literals.APPLIED_COMPOSITE_FILTERS;
    }
    ...
    public EList<CompositeFilterDescription> getCompositeFilterDescriptions() {
        if (compositeFilterDescriptions == null) {
            compositeFilterDescriptions = new EObjectResolvingEList<CompositeFilterDescription>(CompositeFilterDescription.class, this,
                    ViewpointPackage.APPLIED_COMPOSITE_FILTERS__COMPOSITE_FILTER_DESCRIPTIONS);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewpointPackage.APPLIED_COMPOSITE_FILTERS__COMPOSITE_FILTER_DESCRIPTIONS:
