 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.NodeStyleImpl#getDescription
 * <em>Description</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.NodeStyleImpl#getBorderSize <em>
 * Border Size</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.NodeStyleImpl#getBorderSizeComputationExpression
 * <em>Border Size Computation Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.NodeStyleImpl#getBorderColor
 * <em>Border Color</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.NodeStyleImpl#getLabelPosition
 * <em>Label Position</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.NodeStyleImpl#isHideLabelByDefault
...
public abstract class NodeStyleImpl extends LabelStyleImpl implements NodeStyle {
    ...
    protected EClass eStaticClass() {
        return ViewpointPackage.Literals.NODE_STYLE;
    }
        ...
        if (description != null && description.eIsProxy()) {
            ...
            if (description != oldDescription) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.NODE_STYLE__DESCRIPTION, oldDescription, description));
            }
        }
        return description;
    }
    ...
    public void setDescription(StyleDescription newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.NODE_STYLE__DESCRIPTION, oldDescription, description));
    }
    ...
    public void setBorderSize(Integer newBorderSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.NODE_STYLE__BORDER_SIZE, oldBorderSize, borderSize));
    }
    ...
    public void setBorderSizeComputationExpression(String newBorderSizeComputationExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.NODE_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION, oldBorderSizeComputationExpression, borderSizeComputationExpression));
    }
    ...
    public RGBValues getBorderColor() {
        if (borderColor != null && borderColor.eIsProxy()) {
            ...
            if (borderColor != oldBorderColor) {
                ...
                NotificationChain msgs = oldBorderColor.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.NODE_STYLE__BORDER_COLOR, null, null);
                if (newBorderColor.eInternalContainer() == null) {
                    msgs = newBorderColor.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.NODE_STYLE__BORDER_COLOR, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.NODE_STYLE__BORDER_COLOR, oldBorderColor, borderColor));
            }
        }
        return borderColor;
    }
    ...
    public NotificationChain basicSetBorderColor(RGBValues newBorderColor, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewpointPackage.NODE_STYLE__BORDER_COLOR, oldBorderColor, newBorderColor);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setBorderColor(RGBValues newBorderColor) {
        if (newBorderColor != borderColor) {
            ...
            if (borderColor != null)
                msgs = ((InternalEObject) borderColor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.NODE_STYLE__BORDER_COLOR, null, msgs);
            if (newBorderColor != null)
                msgs = ((InternalEObject) newBorderColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.NODE_STYLE__BORDER_COLOR, null, msgs);
            msgs = basicSetBorderColor(newBorderColor, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.NODE_STYLE__BORDER_COLOR, newBorderColor, newBorderColor));
    }
    ...
    public void setLabelPosition(LabelPosition newLabelPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.NODE_STYLE__LABEL_POSITION, oldLabelPosition, labelPosition));
    }
    ...
    public void setHideLabelByDefault(boolean newHideLabelByDefault) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.NODE_STYLE__HIDE_LABEL_BY_DEFAULT, oldHideLabelByDefault, hideLabelByDefault));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewpointPackage.NODE_STYLE__DESCRIPTION:
            if (resolve)
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == BorderedStyle.class) {
            switch (derivedFeatureID) {
            case ViewpointPackage.NODE_STYLE__BORDER_SIZE:
                return ViewpointPackage.BORDERED_STYLE__BORDER_SIZE;
            case ViewpointPackage.NODE_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION:
                return ViewpointPackage.BORDERED_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION;
            case ViewpointPackage.NODE_STYLE__BORDER_COLOR:
                return ViewpointPackage.BORDERED_STYLE__BORDER_COLOR;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == Style.class) {
            ...
            case ViewpointPackage.STYLE__DESCRIPTION:
                return ViewpointPackage.NODE_STYLE__DESCRIPTION;
            default:
                return -1;
            }
        }
        if (baseClass == BorderedStyle.class) {
            ...
            case ViewpointPackage.BORDERED_STYLE__BORDER_SIZE:
                return ViewpointPackage.NODE_STYLE__BORDER_SIZE;
            case ViewpointPackage.BORDERED_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION:
                return ViewpointPackage.NODE_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION;
            case ViewpointPackage.BORDERED_STYLE__BORDER_COLOR:
                return ViewpointPackage.NODE_STYLE__BORDER_COLOR;
            default:
                return -1;
            }
        }
