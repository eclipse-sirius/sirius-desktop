 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.GaugeCompositeStyleImpl#getAlignment
 * <em>Alignment</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.GaugeCompositeStyleImpl#getSections
 * <em>Sections</em>}</li>
 * </ul>
 * </p>
 * 
...
public class GaugeCompositeStyleImpl extends NodeStyleImpl implements GaugeCompositeStyle {
    ...
    public void setAlignment(AlignmentKind newAlignment) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.GAUGE_COMPOSITE_STYLE__ALIGNMENT, oldAlignment, alignment));
    }
    ...
    public EList<GaugeSection> getSections() {
        if (sections == null) {
            sections = new EObjectContainmentEList.Resolving<GaugeSection>(GaugeSection.class, this, ViewpointPackage.GAUGE_COMPOSITE_STYLE__SECTIONS);
        }
        return sections;
    }
