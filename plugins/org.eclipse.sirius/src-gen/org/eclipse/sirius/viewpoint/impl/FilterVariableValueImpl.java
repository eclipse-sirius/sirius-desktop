 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.FilterVariableValueImpl#getVariableDefinition
 * <em>Variable Definition</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.FilterVariableValueImpl#getModelElement
...
public class FilterVariableValueImpl extends EObjectImpl implements FilterVariableValue {
    ...
    protected EClass eStaticClass() {
        return ViewpointPackage.Literals.FILTER_VARIABLE_VALUE;
    }
        ...
        if (variableDefinition != null && variableDefinition.eIsProxy()) {
            ...
            if (variableDefinition != oldVariableDefinition) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.FILTER_VARIABLE_VALUE__VARIABLE_DEFINITION, oldVariableDefinition, variableDefinition));
            }
        }
    ...
    public void setVariableDefinition(FilterVariable newVariableDefinition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.FILTER_VARIABLE_VALUE__VARIABLE_DEFINITION, oldVariableDefinition, variableDefinition));
    }
    ...
    public EObject getModelElement() {
        if (modelElement != null && modelElement.eIsProxy()) {
            ...
            if (modelElement != oldModelElement) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.FILTER_VARIABLE_VALUE__MODEL_ELEMENT, oldModelElement, modelElement));
            }
        }
        return modelElement;
    }
    ...
    public void setModelElement(EObject newModelElement) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.FILTER_VARIABLE_VALUE__MODEL_ELEMENT, oldModelElement, modelElement));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewpointPackage.FILTER_VARIABLE_VALUE__VARIABLE_DEFINITION:
            if (resolve)
                return getVariableDefinition();
            return basicGetVariableDefinition();
        case ViewpointPackage.FILTER_VARIABLE_VALUE__MODEL_ELEMENT:
            if (resolve)
