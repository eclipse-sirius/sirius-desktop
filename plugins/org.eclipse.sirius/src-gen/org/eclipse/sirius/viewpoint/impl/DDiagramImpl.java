 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getOwnedDiagramElements
 * <em>Owned Diagram Elements</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getDiagramElements
 * <em>Diagram Elements</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getDescription <em>
 * Description</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getInfo <em>Info
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getSubDiagrams <em>
 * Sub Diagrams</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getEdges <em>Edges
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getNodes <em>Nodes
 * </em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getNodeListElements
 * <em>Node List Elements</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getContainers <em>
 * Containers</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getCurrentConcern
 * <em>Current Concern</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getActivatedFilters
 * <em>Activated Filters</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getAllFilters <em>
 * All Filters</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getActivatedRules
 * <em>Activated Rules</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getActivateBehaviors
 * <em>Activate Behaviors</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getFilterVariableHistory
 * <em>Filter Variable History</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getActivatedLayers
 * <em>Activated Layers</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#isSynchronized <em>
 * Synchronized</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getHiddenElements
 * <em>Hidden Elements</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#isIsInLayoutingMode
 * <em>Is In Layouting Mode</em>}</li>
 * <li>{@link org.eclipse.sirius.viewpoint.impl.DDiagramImpl#getHeaderHeight
...
public class DDiagramImpl extends DRepresentationImpl implements DDiagram {
    ...
    public EList<DDiagramElement> getOwnedDiagramElements() {
        if (ownedDiagramElements == null) {
            ownedDiagramElements = new EObjectContainmentEList.Resolving<DDiagramElement>(DDiagramElement.class, this, ViewpointPackage.DDIAGRAM__OWNED_DIAGRAM_ELEMENTS);
        }
        ...
        if (description != null && description.eIsProxy()) {
            ...
            if (description != oldDescription) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.DDIAGRAM__DESCRIPTION, oldDescription, description));
            }
        }
        return description;
    }
    ...
    public void setDescription(DiagramDescription newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.DDIAGRAM__DESCRIPTION, oldDescription, description));
    }
    ...
    public void setInfo(String newInfo) {
        ...
        info = newInfo;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.DDIAGRAM__INFO, oldInfo, info));
    }
    ...
    public EList<DDiagram> getSubDiagrams() {
        if (subDiagrams == null) {
            subDiagrams = new EObjectContainmentEList.Resolving<DDiagram>(DDiagram.class, this, ViewpointPackage.DDIAGRAM__SUB_DIAGRAMS);
        }
        return subDiagrams;
    }
    ...
    public ConcernDescription getCurrentConcern() {
        if (currentConcern != null && currentConcern.eIsProxy()) {
            ...
            if (currentConcern != oldCurrentConcern) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.DDIAGRAM__CURRENT_CONCERN, oldCurrentConcern, currentConcern));
            }
        }
    ...
    public void setCurrentConcern(ConcernDescription newCurrentConcern) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.DDIAGRAM__CURRENT_CONCERN, oldCurrentConcern, currentConcern));
    }
    ...
    public EList<FilterDescription> getActivatedFilters() {
        if (activatedFilters == null) {
            activatedFilters = new EObjectResolvingEList<FilterDescription>(FilterDescription.class, this, ViewpointPackage.DDIAGRAM__ACTIVATED_FILTERS);
        }
    ...
    public EList<ValidationRule> getActivatedRules() {
        if (activatedRules == null) {
            activatedRules = new EObjectResolvingEList<ValidationRule>(ValidationRule.class, this, ViewpointPackage.DDIAGRAM__ACTIVATED_RULES);
        }
    ...
    public EList<BehaviorTool> getActivateBehaviors() {
        if (activateBehaviors == null) {
            activateBehaviors = new EObjectResolvingEList<BehaviorTool>(BehaviorTool.class, this, ViewpointPackage.DDIAGRAM__ACTIVATE_BEHAVIORS);
        }
    ...
    public FilterVariableHistory getFilterVariableHistory() {
        if (filterVariableHistory != null && filterVariableHistory.eIsProxy()) {
            ...
            if (filterVariableHistory != oldFilterVariableHistory) {
                ...
                NotificationChain msgs = oldFilterVariableHistory.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY, null, null);
                if (newFilterVariableHistory.eInternalContainer() == null) {
                    msgs = newFilterVariableHistory.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY, oldFilterVariableHistory, filterVariableHistory));
            }
        }
    ...
    public NotificationChain basicSetFilterVariableHistory(FilterVariableHistory newFilterVariableHistory, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY, oldFilterVariableHistory, newFilterVariableHistory);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setFilterVariableHistory(FilterVariableHistory newFilterVariableHistory) {
        if (newFilterVariableHistory != filterVariableHistory) {
            ...
            if (filterVariableHistory != null)
                msgs = ((InternalEObject) filterVariableHistory).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY, null, msgs);
            if (newFilterVariableHistory != null)
                msgs = ((InternalEObject) newFilterVariableHistory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY, null, msgs);
            msgs = basicSetFilterVariableHistory(newFilterVariableHistory, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY, newFilterVariableHistory, newFilterVariableHistory));
    }
    ...
    public EList<Layer> getActivatedLayers() {
        if (activatedLayers == null) {
            activatedLayers = new EObjectResolvingEList<Layer>(Layer.class, this, ViewpointPackage.DDIAGRAM__ACTIVATED_LAYERS);
        }
    ...
    public void setSynchronized(boolean newSynchronized) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.DDIAGRAM__SYNCHRONIZED, oldSynchronized, synchronized_));
    }
    ...
    public EList<DDiagramElement> getHiddenElements() {
        if (hiddenElements == null) {
            hiddenElements = new EObjectResolvingEList<DDiagramElement>(DDiagramElement.class, this, ViewpointPackage.DDIAGRAM__HIDDEN_ELEMENTS);
        }
    ...
    public void setIsInLayoutingMode(boolean newIsInLayoutingMode) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ViewpointPackage.DDIAGRAM__IS_IN_LAYOUTING_MODE, oldIsInLayoutingMode, isInLayoutingMode));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ViewpointPackage.DDIAGRAM__OWNED_DIAGRAM_ELEMENTS:
            return ((InternalEList<?>) getOwnedDiagramElements()).basicRemove(otherEnd, msgs);
        case ViewpointPackage.DDIAGRAM__SUB_DIAGRAMS:
            return ((InternalEList<?>) getSubDiagrams()).basicRemove(otherEnd, msgs);
        case ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case ViewpointPackage.DDIAGRAM__DIAGRAM_ELEMENTS:
            return getDiagramElements();
        case ViewpointPackage.DDIAGRAM__DESCRIPTION:
            if (resolve)
                return getDescription();
            return basicGetDescription();
        case ViewpointPackage.DDIAGRAM__INFO:
            return getInfo();
        case ViewpointPackage.DDIAGRAM__SUB_DIAGRAMS:
            return getSubDiagrams();
        case ViewpointPackage.DDIAGRAM__EDGES:
            return getEdges();
        case ViewpointPackage.DDIAGRAM__NODES:
            return getNodes();
        case ViewpointPackage.DDIAGRAM__NODE_LIST_ELEMENTS:
            return getNodeListElements();
        case ViewpointPackage.DDIAGRAM__CONTAINERS:
            return getContainers();
        case ViewpointPackage.DDIAGRAM__CURRENT_CONCERN:
            if (resolve)
                return getCurrentConcern();
            return basicGetCurrentConcern();
        case ViewpointPackage.DDIAGRAM__ACTIVATED_FILTERS:
            return getActivatedFilters();
        case ViewpointPackage.DDIAGRAM__ALL_FILTERS:
            return getAllFilters();
        case ViewpointPackage.DDIAGRAM__ACTIVATED_RULES:
            return getActivatedRules();
        case ViewpointPackage.DDIAGRAM__ACTIVATE_BEHAVIORS:
            return getActivateBehaviors();
        case ViewpointPackage.DDIAGRAM__FILTER_VARIABLE_HISTORY:
            if (resolve)
                return getFilterVariableHistory();
            return basicGetFilterVariableHistory();
        case ViewpointPackage.DDIAGRAM__ACTIVATED_LAYERS:
            return getActivatedLayers();
        case ViewpointPackage.DDIAGRAM__SYNCHRONIZED:
            return isSynchronized();
        case ViewpointPackage.DDIAGRAM__HIDDEN_ELEMENTS:
            return getHiddenElements();
        case ViewpointPackage.DDIAGRAM__IS_IN_LAYOUTING_MODE:
            return isIsInLayoutingMode();
        case ViewpointPackage.DDIAGRAM__HEADER_HEIGHT:
