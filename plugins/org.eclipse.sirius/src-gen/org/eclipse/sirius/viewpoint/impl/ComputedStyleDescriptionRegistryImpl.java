 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ComputedStyleDescriptionRegistryImpl#getComputedStyleDescriptions
 * <em>Computed Style Descriptions</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.viewpoint.impl.ComputedStyleDescriptionRegistryImpl#getCache
 * <em>Cache</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ComputedStyleDescriptionRegistryImpl extends EObjectImpl implements ComputedStyleDescriptionRegistry {
    ...
    protected EClass eStaticClass() {
        return ViewpointPackage.Literals.COMPUTED_STYLE_DESCRIPTION_REGISTRY;
    }
    ...
    public EList<StyleDescription> getComputedStyleDescriptions() {
        if (computedStyleDescriptions == null) {
            computedStyleDescriptions = new EObjectContainmentEList.Resolving<StyleDescription>(StyleDescription.class, this,
                    ViewpointPackage.COMPUTED_STYLE_DESCRIPTION_REGISTRY__COMPUTED_STYLE_DESCRIPTIONS);
        }
    ...
    public EMap<DiagramElementMapping, EMap<EObject, EMap<EObject, EMap<EObject, StyleDescription>>>> getCache() {
        if (cache == null) {
            cache = new EcoreEMap<DiagramElementMapping, EMap<EObject, EMap<EObject, EMap<EObject, StyleDescription>>>>(ViewpointPackage.Literals.DIAGRAM_ELEMENT_MAPPING2_MODEL_ELEMENT,
                    DiagramElementMapping2ModelElementImpl.class, this, ViewpointPackage.COMPUTED_STYLE_DESCRIPTION_REGISTRY__CACHE);
        }
        return cache;
    }
