 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.DDiagramElement#isVisible <em>Visible</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagramElement#getTooltipText <em>Tooltip
 * Text</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagramElement#getParentLayers <em>Parent
 * Layers</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagramElement#getDecorations <em>
 * Decorations</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagramElement#getDiagramElementMapping
 * <em>Diagram Element Mapping</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagramElement#getGraphicalFilters <em>
 * Graphical Filters</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.sirius.SiriusPackage#getDDiagramElement()
 * @model abstract="true"
 * @generated
 */
public interface DDiagramElement extends DRepresentationElement, DValidable, DNavigable {
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSiriusElement_Visible()
     * @model default="true"
     * @generated
     */
    boolean isVisible();
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagramElement_TooltipText()
     * @model
     * @generated
     */
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagramElement_ParentLayers()
     * @model
     * @generated
     */
     ...
     * {@link org.eclipse.sirius.Decoration}. <!-- begin-user-doc -->
     * <p>
     ...
     *         list.
     * @see org.eclipse.sirius.SiriusPackage#getDDiagramElement_Decorations()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagramElement_DiagramElementMapping()
     ...
     * reference list. The list contents are of type
     * {@link org.eclipse.sirius.GraphicalFilter}. <!-- begin-user-doc -->
     * <!-- end-user-doc --> <!-- begin-model-doc --> Graphical filters allowing
     * to handle this element. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Graphical Filters</em>' containment
     *         reference list.
     * @see org.eclipse.sirius.SiriusPackage#getDDiagramElement_GraphicalFilters()
     * @model containment="true" resolveProxies="true"
     * @generated
     */
