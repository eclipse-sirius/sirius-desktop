 ...
 * 
 * <!-- begin-model-doc --> Sirius is the type of all diagrams in AIR. A
 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.DDiagram#getOwnedDiagramElements <em>Owned
 * Diagram Elements</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getDiagramElements <em>Diagram
 * Elements</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getDescription <em>Description
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getInfo <em>Info</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getSubDiagrams <em>Sub Diagrams
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getEdges <em>Edges</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getNodes <em>Nodes</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getNodeListElements <em>Node List
 * Elements</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getContainers <em>Containers</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getCurrentConcern <em>Current
 * Concern</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getActivatedFilters <em>Activated
 * Filters</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getAllFilters <em>All Filters</em>}
 * </li>
 * <li>{@link org.eclipse.sirius.DDiagram#getActivatedRules <em>Activated
 * Rules</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getActivateBehaviors <em>Activate
 * Behaviors</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getFilterVariableHistory <em>Filter
 * Variable History</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getActivatedLayers <em>Activated
 * Layers</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#isSynchronized <em>Synchronized
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getHiddenElements <em>Hidden
 * Elements</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#isIsInLayoutingMode <em>Is In
 * Layouting Mode</em>}</li>
 * <li>{@link org.eclipse.sirius.DDiagram#getHeaderHeight <em>Header Height
 * </em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.sirius.SiriusPackage#getDDiagram()
 * @model
 * @generated
 */
public interface DDiagram extends DRepresentation, DocumentedElement, DragAndDropTarget, DValidable, DContainer {
     ...
     * {@link org.eclipse.sirius.DDiagramElement}. <!-- begin-user-doc -->
     ...
     *         reference list.
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_OwnedDiagramElements()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_DiagramElements()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_Description()
     * @model
     * @generated
     */
     ...
     * @see #setInfo(String)
     * @see org.eclipse.sirius.SiriusPackage#getSirius_Info()
     * @model default=""
     * @generated
     */
    String getInfo();
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.DDiagram#getInfo
     * <em>Info</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     ...
     * {@link org.eclipse.sirius.DDiagram}. <!-- begin-user-doc --> <!--
     ...
     *         list.
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_SubDiagrams()
     ...
     * contents are of type {@link org.eclipse.sirius.DEdge}. <!--
     * begin-user-doc -->
     * <p>
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_Edges()
     ...
     * contents are of type {@link org.eclipse.sirius.DNode}. <!--
     * begin-user-doc -->
     * <p>
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_Nodes()
     ...
     * list. The list contents are of type
     * {@link org.eclipse.sirius.DNodeListElement}. <!-- begin-user-doc -->
     * <!-- end-user-doc --> <!-- begin-model-doc --> All nodes of the diagram.
     * It is a subset of ownedDiagramElements <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Node List Elements</em>' reference list.
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_NodeListElements()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_Containers()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_CurrentConcern()
     * @model
     * @generated
     */
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_ActivatedFilters()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_AllFilters()
     * @model type="viewpoint.description.filter.FilterDescription"
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_ActivatedRules()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getSirius_ActivateBehaviors()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_FilterVariableHistory()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_ActivatedLayers()
     * @model
     * @generated
     */
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_Synchronized()
     * @model default="true"
     * @generated
     */
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_HiddenElements()
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_IsInLayoutingMode()
     * @model transient="true"
     * @generated
     */
     ...
     * @see org.eclipse.sirius.SiriusPackage#getDDiagram_HeaderHeight()
     * @model default="1"
     * @generated
     */
    int getHeaderHeight();
