 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.NodeStyle#getLabelPosition <em>Label
 * Position</em>}</li>
 * <li>{@link org.eclipse.sirius.NodeStyle#isHideLabelByDefault <em>Hide
 * Label By Default</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.sirius.SiriusPackage#getNodeStyle()
 * @model abstract="true"
 * @generated
 */
public interface NodeStyle extends LabelStyle, Style, BorderedStyle {
     ...
     * BORDER : The label is around the node, on the border. NODE : the label is
     * in the node. <!-- end-model-doc -->
     * 
     ...
     * @see org.eclipse.sirius.SiriusPackage#getNodeStyle_LabelPosition()
     * @model
     * @generated
     */
     ...
     * @see org.eclipse.sirius.SiriusPackage#getNodeStyle_HideLabelByDefault()
     * @model default="false"
     * @generated
     */
