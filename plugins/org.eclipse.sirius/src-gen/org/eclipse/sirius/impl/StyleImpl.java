 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.StyleImpl#getCustomFeatures <em>Custom
 * Features</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.StyleImpl#getDescription <em>
 * Description</em>}</li>
 * </ul>
 * </p>
 * 
...
public abstract class StyleImpl extends EObjectImpl implements Style {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.STYLE;
    }
    ...
    public EList<String> getCustomFeatures() {
        if (customFeatures == null) {
            customFeatures = new EDataTypeUniqueEList<String>(String.class, this, SiriusPackage.STYLE__CUSTOM_FEATURES);
        }
        ...
        if (description != null && description.eIsProxy()) {
            ...
            if (description != oldDescription) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.STYLE__DESCRIPTION, oldDescription, description));
            }
        }
        return description;
    }
    ...
    public void setDescription(StyleDescription newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.STYLE__DESCRIPTION, oldDescription, description));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SiriusPackage.STYLE__CUSTOM_FEATURES:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Customizable.class) {
            ...
            case SiriusPackage.STYLE__CUSTOM_FEATURES:
                return SiriusPackage.CUSTOMIZABLE__CUSTOM_FEATURES;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Customizable.class) {
            ...
            case SiriusPackage.CUSTOMIZABLE__CUSTOM_FEATURES:
                return SiriusPackage.STYLE__CUSTOM_FEATURES;
            default:
                return -1;
            }
        }
