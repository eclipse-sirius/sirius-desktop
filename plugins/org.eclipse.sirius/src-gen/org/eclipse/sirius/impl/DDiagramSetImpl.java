 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.DDiagramSetImpl#getDescription <em>
 * Description</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DDiagramSetImpl#getDiagrams <em>
 * Diagrams</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DDiagramSetImpl#getView <em>View</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class DDiagramSetImpl extends EObjectImpl implements DDiagramSet {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.DDIAGRAM_SET;
    }
        ...
        if (description != null && description.eIsProxy()) {
            ...
            if (description != oldDescription) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DDIAGRAM_SET__DESCRIPTION, oldDescription, description));
            }
        }
        return description;
    }
    ...
    public void setDescription(DiagramDescription newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DDIAGRAM_SET__DESCRIPTION, oldDescription, description, !oldDescriptionESet));
    }
    ...
    public void unsetDescription() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, SiriusPackage.DDIAGRAM_SET__DESCRIPTION, oldDescription, null, oldDescriptionESet));
    }
    ...
    public EList<DDiagram> getDiagrams() {
        if (diagrams == null) {
            diagrams = new EObjectResolvingEList<DDiagram>(DDiagram.class, this, SiriusPackage.DDIAGRAM_SET__DIAGRAMS);
        }
        return diagrams;
    }
    ...
    public DRepresentationContainer getView() {
        if (view != null && view.eIsProxy()) {
            ...
            if (view != oldView) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DDIAGRAM_SET__VIEW, oldView, view));
            }
        }
        return view;
    }
    ...
    public void setView(DRepresentationContainer newView) {
        ...
        view = newView;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DDIAGRAM_SET__VIEW, oldView, view));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SiriusPackage.DDIAGRAM_SET__DESCRIPTION:
            if (resolve)
                return getDescription();
            return basicGetDescription();
        case SiriusPackage.DDIAGRAM_SET__DIAGRAMS:
            return getDiagrams();
        case SiriusPackage.DDIAGRAM_SET__VIEW:
            if (resolve)
                return getView();
            return basicGetView();
        }
