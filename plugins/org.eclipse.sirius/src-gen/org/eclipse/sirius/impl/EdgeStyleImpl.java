 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getStrokeColor <em>Stroke
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getLineStyle <em>Line
 * Style</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getSourceArrow <em>Source
 * Arrow</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getTargetArrow <em>Target
 * Arrow</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getFoldingStyle <em>
 * Folding Style</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getSize <em>Size</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getRoutingStyle <em>
 * Routing Style</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getBeginLabelStyle <em>
 * Begin Label Style</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getCenterLabelStyle <em>
 * Center Label Style</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.EdgeStyleImpl#getEndLabelStyle <em>End
 * Label Style</em>}</li>
 * </ul>
 * </p>
 * 
...
public class EdgeStyleImpl extends StyleImpl implements EdgeStyle {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.EDGE_STYLE;
    }
    ...
    public RGBValues getStrokeColor() {
        if (strokeColor != null && strokeColor.eIsProxy()) {
            ...
            if (strokeColor != oldStrokeColor) {
                ...
                NotificationChain msgs = oldStrokeColor.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__STROKE_COLOR, null, null);
                if (newStrokeColor.eInternalContainer() == null) {
                    msgs = newStrokeColor.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__STROKE_COLOR, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.EDGE_STYLE__STROKE_COLOR, oldStrokeColor, strokeColor));
            }
        }
        return strokeColor;
    }
    ...
    public NotificationChain basicSetStrokeColor(RGBValues newStrokeColor, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__STROKE_COLOR, oldStrokeColor, newStrokeColor);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setStrokeColor(RGBValues newStrokeColor) {
        if (newStrokeColor != strokeColor) {
            ...
            if (strokeColor != null)
                msgs = ((InternalEObject) strokeColor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__STROKE_COLOR, null, msgs);
            if (newStrokeColor != null)
                msgs = ((InternalEObject) newStrokeColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__STROKE_COLOR, null, msgs);
            msgs = basicSetStrokeColor(newStrokeColor, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__STROKE_COLOR, newStrokeColor, newStrokeColor));
    }
    ...
    public void setLineStyle(LineStyle newLineStyle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__LINE_STYLE, oldLineStyle, lineStyle));
    }
    ...
    public void setSourceArrow(EdgeArrows newSourceArrow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__SOURCE_ARROW, oldSourceArrow, sourceArrow));
    }
    ...
    public void setTargetArrow(EdgeArrows newTargetArrow) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__TARGET_ARROW, oldTargetArrow, targetArrow));
    }
    ...
    public void setFoldingStyle(FoldingStyle newFoldingStyle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__FOLDING_STYLE, oldFoldingStyle, foldingStyle));
    }
    ...
    public void setSize(Integer newSize) {
        ...
        size = newSize;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__SIZE, oldSize, size));
    }
    ...
    public void setRoutingStyle(EdgeRouting newRoutingStyle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__ROUTING_STYLE, oldRoutingStyle, routingStyle));
    }
    ...
    public BeginLabelStyle getBeginLabelStyle() {
        if (beginLabelStyle != null && beginLabelStyle.eIsProxy()) {
            ...
            if (beginLabelStyle != oldBeginLabelStyle) {
                ...
                NotificationChain msgs = oldBeginLabelStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__BEGIN_LABEL_STYLE, null, null);
                if (newBeginLabelStyle.eInternalContainer() == null) {
                    msgs = newBeginLabelStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__BEGIN_LABEL_STYLE, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.EDGE_STYLE__BEGIN_LABEL_STYLE, oldBeginLabelStyle, beginLabelStyle));
            }
        }
    ...
    public NotificationChain basicSetBeginLabelStyle(BeginLabelStyle newBeginLabelStyle, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__BEGIN_LABEL_STYLE, oldBeginLabelStyle, newBeginLabelStyle);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setBeginLabelStyle(BeginLabelStyle newBeginLabelStyle) {
        if (newBeginLabelStyle != beginLabelStyle) {
            ...
            if (beginLabelStyle != null)
                msgs = ((InternalEObject) beginLabelStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__BEGIN_LABEL_STYLE, null, msgs);
            if (newBeginLabelStyle != null)
                msgs = ((InternalEObject) newBeginLabelStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__BEGIN_LABEL_STYLE, null, msgs);
            msgs = basicSetBeginLabelStyle(newBeginLabelStyle, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__BEGIN_LABEL_STYLE, newBeginLabelStyle, newBeginLabelStyle));
    }
    ...
    public CenterLabelStyle getCenterLabelStyle() {
        if (centerLabelStyle != null && centerLabelStyle.eIsProxy()) {
            ...
            if (centerLabelStyle != oldCenterLabelStyle) {
                ...
                NotificationChain msgs = oldCenterLabelStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__CENTER_LABEL_STYLE, null, null);
                if (newCenterLabelStyle.eInternalContainer() == null) {
                    msgs = newCenterLabelStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__CENTER_LABEL_STYLE, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.EDGE_STYLE__CENTER_LABEL_STYLE, oldCenterLabelStyle, centerLabelStyle));
            }
        }
    ...
    public NotificationChain basicSetCenterLabelStyle(CenterLabelStyle newCenterLabelStyle, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__CENTER_LABEL_STYLE, oldCenterLabelStyle, newCenterLabelStyle);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setCenterLabelStyle(CenterLabelStyle newCenterLabelStyle) {
        if (newCenterLabelStyle != centerLabelStyle) {
            ...
            if (centerLabelStyle != null)
                msgs = ((InternalEObject) centerLabelStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__CENTER_LABEL_STYLE, null, msgs);
            if (newCenterLabelStyle != null)
                msgs = ((InternalEObject) newCenterLabelStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__CENTER_LABEL_STYLE, null, msgs);
            msgs = basicSetCenterLabelStyle(newCenterLabelStyle, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__CENTER_LABEL_STYLE, newCenterLabelStyle, newCenterLabelStyle));
    }
    ...
    public EndLabelStyle getEndLabelStyle() {
        if (endLabelStyle != null && endLabelStyle.eIsProxy()) {
            ...
            if (endLabelStyle != oldEndLabelStyle) {
                ...
                NotificationChain msgs = oldEndLabelStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__END_LABEL_STYLE, null, null);
                if (newEndLabelStyle.eInternalContainer() == null) {
                    msgs = newEndLabelStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__END_LABEL_STYLE, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.EDGE_STYLE__END_LABEL_STYLE, oldEndLabelStyle, endLabelStyle));
            }
        }
    ...
    public NotificationChain basicSetEndLabelStyle(EndLabelStyle newEndLabelStyle, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__END_LABEL_STYLE, oldEndLabelStyle, newEndLabelStyle);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setEndLabelStyle(EndLabelStyle newEndLabelStyle) {
        if (newEndLabelStyle != endLabelStyle) {
            ...
            if (endLabelStyle != null)
                msgs = ((InternalEObject) endLabelStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__END_LABEL_STYLE, null, msgs);
            if (newEndLabelStyle != null)
                msgs = ((InternalEObject) newEndLabelStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.EDGE_STYLE__END_LABEL_STYLE, null, msgs);
            msgs = basicSetEndLabelStyle(newEndLabelStyle, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.EDGE_STYLE__END_LABEL_STYLE, newEndLabelStyle, newEndLabelStyle));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SiriusPackage.EDGE_STYLE__STROKE_COLOR:
            return basicSetStrokeColor(null, msgs);
        case SiriusPackage.EDGE_STYLE__BEGIN_LABEL_STYLE:
            return basicSetBeginLabelStyle(null, msgs);
        case SiriusPackage.EDGE_STYLE__CENTER_LABEL_STYLE:
            return basicSetCenterLabelStyle(null, msgs);
        case SiriusPackage.EDGE_STYLE__END_LABEL_STYLE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case SiriusPackage.EDGE_STYLE__LINE_STYLE:
            return getLineStyle();
        case SiriusPackage.EDGE_STYLE__SOURCE_ARROW:
            return getSourceArrow();
        case SiriusPackage.EDGE_STYLE__TARGET_ARROW:
            return getTargetArrow();
        case SiriusPackage.EDGE_STYLE__FOLDING_STYLE:
            return getFoldingStyle();
        case SiriusPackage.EDGE_STYLE__SIZE:
            return getSize();
        case SiriusPackage.EDGE_STYLE__ROUTING_STYLE:
