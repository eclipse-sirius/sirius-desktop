 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.NodeStyleImpl#getDescription <em>
 * Description</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.NodeStyleImpl#getBorderSize <em>Border
 * Size</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.impl.NodeStyleImpl#getBorderSizeComputationExpression
 * <em>Border Size Computation Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.NodeStyleImpl#getBorderColor <em>Border
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.NodeStyleImpl#getLabelPosition <em>
 * Label Position</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.NodeStyleImpl#isHideLabelByDefault <em>
 * Hide Label By Default</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public abstract class NodeStyleImpl extends LabelStyleImpl implements NodeStyle {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.NODE_STYLE;
    }
        ...
        if (description != null && description.eIsProxy()) {
            ...
            if (description != oldDescription) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.NODE_STYLE__DESCRIPTION, oldDescription, description));
            }
        }
        return description;
    }
    ...
    public void setDescription(StyleDescription newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.NODE_STYLE__DESCRIPTION, oldDescription, description));
    }
    ...
    public void setBorderSize(Integer newBorderSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.NODE_STYLE__BORDER_SIZE, oldBorderSize, borderSize));
    }
    ...
    public void setBorderSizeComputationExpression(String newBorderSizeComputationExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.NODE_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION, oldBorderSizeComputationExpression, borderSizeComputationExpression));
    }
    ...
    public RGBValues getBorderColor() {
        if (borderColor != null && borderColor.eIsProxy()) {
            ...
            if (borderColor != oldBorderColor) {
                ...
                NotificationChain msgs = oldBorderColor.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.NODE_STYLE__BORDER_COLOR, null, null);
                if (newBorderColor.eInternalContainer() == null) {
                    msgs = newBorderColor.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.NODE_STYLE__BORDER_COLOR, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.NODE_STYLE__BORDER_COLOR, oldBorderColor, borderColor));
            }
        }
        return borderColor;
    }
    ...
    public NotificationChain basicSetBorderColor(RGBValues newBorderColor, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.NODE_STYLE__BORDER_COLOR, oldBorderColor, newBorderColor);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setBorderColor(RGBValues newBorderColor) {
        if (newBorderColor != borderColor) {
            ...
            if (borderColor != null)
                msgs = ((InternalEObject) borderColor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.NODE_STYLE__BORDER_COLOR, null, msgs);
            if (newBorderColor != null)
                msgs = ((InternalEObject) newBorderColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.NODE_STYLE__BORDER_COLOR, null, msgs);
            msgs = basicSetBorderColor(newBorderColor, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.NODE_STYLE__BORDER_COLOR, newBorderColor, newBorderColor));
    }
    ...
    public void setLabelPosition(LabelPosition newLabelPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.NODE_STYLE__LABEL_POSITION, oldLabelPosition, labelPosition));
    }
    ...
    public void setHideLabelByDefault(boolean newHideLabelByDefault) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.NODE_STYLE__HIDE_LABEL_BY_DEFAULT, oldHideLabelByDefault, hideLabelByDefault));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SiriusPackage.NODE_STYLE__BORDER_COLOR:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SiriusPackage.NODE_STYLE__DESCRIPTION:
            if (resolve)
                return getDescription();
            return basicGetDescription();
        case SiriusPackage.NODE_STYLE__BORDER_SIZE:
            return getBorderSize();
        case SiriusPackage.NODE_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION:
            return getBorderSizeComputationExpression();
        case SiriusPackage.NODE_STYLE__BORDER_COLOR:
            if (resolve)
                return getBorderColor();
            return basicGetBorderColor();
        case SiriusPackage.NODE_STYLE__LABEL_POSITION:
            return getLabelPosition();
        case SiriusPackage.NODE_STYLE__HIDE_LABEL_BY_DEFAULT:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == Style.class) {
            switch (derivedFeatureID) {
            case SiriusPackage.NODE_STYLE__DESCRIPTION:
                return SiriusPackage.STYLE__DESCRIPTION;
            default:
                return -1;
            }
        }
        if (baseClass == BorderedStyle.class) {
            switch (derivedFeatureID) {
            case SiriusPackage.NODE_STYLE__BORDER_SIZE:
                return SiriusPackage.BORDERED_STYLE__BORDER_SIZE;
            case SiriusPackage.NODE_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION:
                return SiriusPackage.BORDERED_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION;
            case SiriusPackage.NODE_STYLE__BORDER_COLOR:
                return SiriusPackage.BORDERED_STYLE__BORDER_COLOR;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == Style.class) {
            switch (baseFeatureID) {
            case SiriusPackage.STYLE__DESCRIPTION:
                return SiriusPackage.NODE_STYLE__DESCRIPTION;
            default:
                return -1;
            }
        }
        if (baseClass == BorderedStyle.class) {
            switch (baseFeatureID) {
            case SiriusPackage.BORDERED_STYLE__BORDER_SIZE:
                return SiriusPackage.NODE_STYLE__BORDER_SIZE;
            case SiriusPackage.BORDERED_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION:
                return SiriusPackage.NODE_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION;
            case SiriusPackage.BORDERED_STYLE__BORDER_COLOR:
                return SiriusPackage.NODE_STYLE__BORDER_COLOR;
            default:
                return -1;
            }
        }
