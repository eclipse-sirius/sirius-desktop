 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getOutgoingEdges <em>Outgoing
 * Edges</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getIncomingEdges <em>Incoming
 * Edges</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getOwnedStyle <em>Owned Style
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getSize <em>Size</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getSourceNode <em>Source Node
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getTargetNode <em>Target Node
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getActualMapping <em>Actual
 * Mapping</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getRoutingStyle <em>Routing
 * Style</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#isIsFold <em>Is Fold</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#isIsMockEdge <em>Is Mock Edge
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getOriginalStyle <em>Original
 * Style</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getPath <em>Path</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getArrangeConstraints <em>
 * Arrange Constraints</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getBeginLabel <em>Begin Label
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DEdgeImpl#getEndLabel <em>End Label
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class DEdgeImpl extends DDiagramElementImpl implements DEdge {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.DEDGE;
    }
    ...
    public EList<DEdge> getOutgoingEdges() {
        if (outgoingEdges == null) {
            outgoingEdges = new EObjectWithInverseResolvingEList<DEdge>(DEdge.class, this, SiriusPackage.DEDGE__OUTGOING_EDGES, SiriusPackage.DEDGE__SOURCE_NODE);
        }
    ...
    public EList<DEdge> getIncomingEdges() {
        if (incomingEdges == null) {
            incomingEdges = new EObjectWithInverseResolvingEList<DEdge>(DEdge.class, this, SiriusPackage.DEDGE__INCOMING_EDGES, SiriusPackage.DEDGE__TARGET_NODE);
        }
    ...
    public EdgeStyle getOwnedStyle() {
        if (ownedStyle != null && ownedStyle.eIsProxy()) {
            ...
            if (ownedStyle != oldOwnedStyle) {
                ...
                NotificationChain msgs = oldOwnedStyle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.DEDGE__OWNED_STYLE, null, null);
                if (newOwnedStyle.eInternalContainer() == null) {
                    msgs = newOwnedStyle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.DEDGE__OWNED_STYLE, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DEDGE__OWNED_STYLE, oldOwnedStyle, ownedStyle));
            }
        }
        return ownedStyle;
    }
    ...
    public NotificationChain basicSetOwnedStyle(EdgeStyle newOwnedStyle, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__OWNED_STYLE, oldOwnedStyle, newOwnedStyle);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setOwnedStyle(EdgeStyle newOwnedStyle) {
        if (newOwnedStyle != ownedStyle) {
            ...
            if (ownedStyle != null)
                msgs = ((InternalEObject) ownedStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.DEDGE__OWNED_STYLE, null, msgs);
            if (newOwnedStyle != null)
                msgs = ((InternalEObject) newOwnedStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.DEDGE__OWNED_STYLE, null, msgs);
            msgs = basicSetOwnedStyle(newOwnedStyle, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__OWNED_STYLE, newOwnedStyle, newOwnedStyle));
    }
    ...
    public void setSize(Integer newSize) {
        ...
        size = newSize;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__SIZE, oldSize, size));
    }
    ...
    public EdgeTarget getSourceNode() {
        if (sourceNode != null && sourceNode.eIsProxy()) {
            ...
            if (sourceNode != oldSourceNode) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DEDGE__SOURCE_NODE, oldSourceNode, sourceNode));
            }
        }
        return sourceNode;
    }
    ...
    public NotificationChain basicSetSourceNode(EdgeTarget newSourceNode, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__SOURCE_NODE, oldSourceNode, newSourceNode);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setSourceNode(EdgeTarget newSourceNode) {
        if (newSourceNode != sourceNode) {
            NotificationChain msgs = null;
            if (sourceNode != null)
                msgs = ((InternalEObject) sourceNode).eInverseRemove(this, SiriusPackage.EDGE_TARGET__OUTGOING_EDGES, EdgeTarget.class, msgs);
            if (newSourceNode != null)
                msgs = ((InternalEObject) newSourceNode).eInverseAdd(this, SiriusPackage.EDGE_TARGET__OUTGOING_EDGES, EdgeTarget.class, msgs);
            msgs = basicSetSourceNode(newSourceNode, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__SOURCE_NODE, newSourceNode, newSourceNode));
    }
    ...
    public EdgeTarget getTargetNode() {
        if (targetNode != null && targetNode.eIsProxy()) {
            ...
            if (targetNode != oldTargetNode) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DEDGE__TARGET_NODE, oldTargetNode, targetNode));
            }
        }
        return targetNode;
    }
    ...
    public NotificationChain basicSetTargetNode(EdgeTarget newTargetNode, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__TARGET_NODE, oldTargetNode, newTargetNode);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setTargetNode(EdgeTarget newTargetNode) {
        if (newTargetNode != targetNode) {
            NotificationChain msgs = null;
            if (targetNode != null)
                msgs = ((InternalEObject) targetNode).eInverseRemove(this, SiriusPackage.EDGE_TARGET__INCOMING_EDGES, EdgeTarget.class, msgs);
            if (newTargetNode != null)
                msgs = ((InternalEObject) newTargetNode).eInverseAdd(this, SiriusPackage.EDGE_TARGET__INCOMING_EDGES, EdgeTarget.class, msgs);
            msgs = basicSetTargetNode(newTargetNode, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__TARGET_NODE, newTargetNode, newTargetNode));
    }
    ...
    public IEdgeMapping getActualMapping() {
        if (actualMapping != null && actualMapping.eIsProxy()) {
            ...
            if (actualMapping != oldActualMapping) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DEDGE__ACTUAL_MAPPING, oldActualMapping, actualMapping));
            }
        }
    ...
    public void setActualMapping(IEdgeMapping newActualMapping) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__ACTUAL_MAPPING, oldActualMapping, actualMapping));
    }
    ...
    public void setRoutingStyle(EdgeRouting newRoutingStyle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__ROUTING_STYLE, oldRoutingStyle, routingStyle));
    }
    ...
    public void setIsFold(boolean newIsFold) {
        ...
        isFold = newIsFold;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__IS_FOLD, oldIsFold, isFold));
    }
    ...
    public void setIsMockEdge(boolean newIsMockEdge) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__IS_MOCK_EDGE, oldIsMockEdge, isMockEdge));
    }
    ...
    public Style getOriginalStyle() {
        if (originalStyle != null && originalStyle.eIsProxy()) {
            ...
            if (originalStyle != oldOriginalStyle) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DEDGE__ORIGINAL_STYLE, oldOriginalStyle, originalStyle));
            }
        }
    ...
    public void setOriginalStyle(Style newOriginalStyle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__ORIGINAL_STYLE, oldOriginalStyle, originalStyle));
    }
    ...
    public EList<ArrangeConstraint> getArrangeConstraints() {
        if (arrangeConstraints == null) {
            arrangeConstraints = new EDataTypeUniqueEList<ArrangeConstraint>(ArrangeConstraint.class, this, SiriusPackage.DEDGE__ARRANGE_CONSTRAINTS);
        }
    ...
    public void setBeginLabel(String newBeginLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__BEGIN_LABEL, oldBeginLabel, beginLabel));
    }
    ...
    public void setEndLabel(String newEndLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DEDGE__END_LABEL, oldEndLabel, endLabel));
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SiriusPackage.DEDGE__OUTGOING_EDGES:
            return ((InternalEList<InternalEObject>) (InternalEList<?>) getOutgoingEdges()).basicAdd(otherEnd, msgs);
        case SiriusPackage.DEDGE__INCOMING_EDGES:
            return ((InternalEList<InternalEObject>) (InternalEList<?>) getIncomingEdges()).basicAdd(otherEnd, msgs);
        case SiriusPackage.DEDGE__SOURCE_NODE:
            if (sourceNode != null)
                msgs = ((InternalEObject) sourceNode).eInverseRemove(this, SiriusPackage.EDGE_TARGET__OUTGOING_EDGES, EdgeTarget.class, msgs);
            return basicSetSourceNode((EdgeTarget) otherEnd, msgs);
        case SiriusPackage.DEDGE__TARGET_NODE:
            if (targetNode != null)
                msgs = ((InternalEObject) targetNode).eInverseRemove(this, SiriusPackage.EDGE_TARGET__INCOMING_EDGES, EdgeTarget.class, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        ...
        case SiriusPackage.DEDGE__OWNED_STYLE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case SiriusPackage.DEDGE__SIZE:
            return getSize();
        case SiriusPackage.DEDGE__SOURCE_NODE:
            if (resolve)
        ...
        case SiriusPackage.DEDGE__ACTUAL_MAPPING:
            if (resolve)
                return getActualMapping();
            return basicGetActualMapping();
        case SiriusPackage.DEDGE__ROUTING_STYLE:
            return getRoutingStyle();
        case SiriusPackage.DEDGE__IS_FOLD:
            return isIsFold();
        case SiriusPackage.DEDGE__IS_MOCK_EDGE:
            return isIsMockEdge();
        case SiriusPackage.DEDGE__ORIGINAL_STYLE:
            if (resolve)
                return getOriginalStyle();
            return basicGetOriginalStyle();
        case SiriusPackage.DEDGE__PATH:
            return getPath();
        case SiriusPackage.DEDGE__ARRANGE_CONSTRAINTS:
            return getArrangeConstraints();
        case SiriusPackage.DEDGE__BEGIN_LABEL:
            return getBeginLabel();
        case SiriusPackage.DEDGE__END_LABEL:
            return getEndLabel();
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == EdgeTarget.class) {
            ...
            case SiriusPackage.EDGE_TARGET__OUTGOING_EDGES:
                return SiriusPackage.DEDGE__OUTGOING_EDGES;
            case SiriusPackage.EDGE_TARGET__INCOMING_EDGES:
                return SiriusPackage.DEDGE__INCOMING_EDGES;
            default:
                return -1;
            }
        }
