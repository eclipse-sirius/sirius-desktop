 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.CustomizableImpl#getCustomFeatures <em>
...
public abstract class CustomizableImpl extends EObjectImpl implements Customizable {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.CUSTOMIZABLE;
    }
    ...
    public EList<String> getCustomFeatures() {
        if (customFeatures == null) {
            customFeatures = new EDataTypeUniqueEList<String>(String.class, this, SiriusPackage.CUSTOMIZABLE__CUSTOM_FEATURES);
        }
