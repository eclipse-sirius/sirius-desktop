 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.DRepresentationElementImpl#getTarget
 * <em>Target</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DRepresentationElementImpl#getName <em>
 * Name</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.impl.DRepresentationElementImpl#getSemanticElements
...
public abstract class DRepresentationElementImpl extends EObjectImpl implements DRepresentationElement {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.DREPRESENTATION_ELEMENT;
    }
        ...
        if (target != null && target.eIsProxy()) {
            ...
            if (target != oldTarget) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DREPRESENTATION_ELEMENT__TARGET, oldTarget, target));
            }
        }
        return target;
    }
    ...
    public void setTarget(EObject newTarget) {
        ...
        target = newTarget;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DREPRESENTATION_ELEMENT__TARGET, oldTarget, target));
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DREPRESENTATION_ELEMENT__NAME, oldName, name));
    }
    ...
    public EList<EObject> getSemanticElements() {
        if (semanticElements == null) {
            semanticElements = new EObjectResolvingEList<EObject>(EObject.class, this, SiriusPackage.DREPRESENTATION_ELEMENT__SEMANTIC_ELEMENTS);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SiriusPackage.DREPRESENTATION_ELEMENT__TARGET:
            if (resolve)
                return getTarget();
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == DSemanticDecorator.class) {
            ...
            case SiriusPackage.DSEMANTIC_DECORATOR__TARGET:
                return SiriusPackage.DREPRESENTATION_ELEMENT__TARGET;
            default:
                return -1;
            }
        }
