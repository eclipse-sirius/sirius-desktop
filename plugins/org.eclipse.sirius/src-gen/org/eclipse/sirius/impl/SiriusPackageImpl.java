...
public class SiriusPackageImpl extends EPackageImpl implements SiriusPackage {
     ...
     * @generated
     */
    private EClass extensibleRepresentationEClass = null;
     ...
     * @see org.eclipse.sirius.SiriusPackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public static SiriusPackage init() {
        ...
        SiriusPackageImpl theSiriusPackage = (SiriusPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SiriusPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
     ...
     * @generated
     */
    public EClass getExtensibleRepresentation() {
        return extensibleRepresentationEClass;
    }
     ...
     * @generated
     */
    public EReference getExtensibleRepresentation_EffectiveDescription() {
        return (EReference) extensibleRepresentationEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EReference getExtensibleRepresentation_ContributionPoints() {
        return (EReference) extensibleRepresentationEClass.getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public EReference getDView_Sirius() {
     ...
     * @generated
     */
    public EReference getDAnalysisSessionEObject_ActivatedSiriuss() {
    ...
    public void createPackageContents() {
        ...
        extensibleRepresentationEClass = createEClass(EXTENSIBLE_REPRESENTATION);
        createEReference(extensibleRepresentationEClass, EXTENSIBLE_REPRESENTATION__EFFECTIVE_DESCRIPTION);
        createEReference(extensibleRepresentationEClass, EXTENSIBLE_REPRESENTATION__CONTRIBUTION_POINTS);
    ...
    public void initializePackageContents() {
        ...
        initEClass(extensibleRepresentationEClass, ExtensibleRepresentation.class, "ExtensibleRepresentation", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getExtensibleRepresentation_EffectiveDescription(), theDescriptionPackage.getRepresentationDescription(), null, "effectiveDescription", null, 0, 1,
                ExtensibleRepresentation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getExtensibleRepresentation_ContributionPoints(), theContributionPackage.getContributionPoint(), null, "contributionPoints", null, 0, -1, ExtensibleRepresentation.class,
        ...
        initEAttribute(getDView_Initialized(), theEcorePackage.getEBoolean(), "initialized", null, 1, 1, DView.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        initEReference(getDView_Sirius(), theDescriptionPackage.getSirius(), null, "viewpoint", null, 1, 1, DView.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getAbstractDNode_OwnedBorderedNodes(), this.getDNode(), null, "ownedBorderedNodes", null, 0, -1, AbstractDNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
                IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getAbstractDNode_ArrangeConstraints(), this.getArrangeConstraint(), "arrangeConstraints", "", 0, -1, AbstractDNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getDEdge_Path(), this.getEdgeTarget(), null, "path", null, 0, -1, DEdge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
                !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDEdge_ArrangeConstraints(), this.getArrangeConstraint(), "arrangeConstraints", "", 0, -1, DEdge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
                IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getDAnalysisSessionEObject_ActivatedSiriuss(), theDescriptionPackage.getSirius(), null, "activatedSiriuss", null, 0, -1, DAnalysisSessionEObject.class, !IS_TRANSIENT,
                !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getDAnalysisSessionEObject_Analyses(), this.getDAnalysis(), null, "analyses", null, 0, -1, DAnalysisSessionEObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getDAnalysisSessionEObject_SynchronizationStatus(), this.getSyncStatus(), "synchronizationStatus", "0", 1, 1, DAnalysisSessionEObject.class, !IS_TRANSIENT, !IS_VOLATILE,
                IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
