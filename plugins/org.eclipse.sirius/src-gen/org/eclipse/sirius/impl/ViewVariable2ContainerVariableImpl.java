 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.impl.ViewVariable2ContainerVariableImpl#getTypedKey
 * <em>Key</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.impl.ViewVariable2ContainerVariableImpl#getTypedValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
...
public class ViewVariable2ContainerVariableImpl extends EObjectImpl implements BasicEMap.Entry<EObject, EMap<EObject, StyleDescription>> {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.VIEW_VARIABLE2_CONTAINER_VARIABLE;
    }
        ...
        if (key != null && key.eIsProxy()) {
            ...
            if (key != oldKey) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.VIEW_VARIABLE2_CONTAINER_VARIABLE__KEY, oldKey, key));
            }
        }
        return key;
    }
    ...
    public void setTypedKey(EObject newKey) {
        ...
        key = newKey;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.VIEW_VARIABLE2_CONTAINER_VARIABLE__KEY, oldKey, key));
    }
    ...
    public EMap<EObject, StyleDescription> getTypedValue() {
        if (value == null) {
            value = new EcoreEMap<EObject, StyleDescription>(SiriusPackage.Literals.CONTAINER_VARIABLE2_STYLE_DESCRIPTION, ContainerVariable2StyleDescriptionImpl.class, this,
                    SiriusPackage.VIEW_VARIABLE2_CONTAINER_VARIABLE__VALUE);
        }
        return value;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SiriusPackage.VIEW_VARIABLE2_CONTAINER_VARIABLE__KEY:
            if (resolve)
                return getTypedKey();
