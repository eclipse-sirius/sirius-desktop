 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.DAnalysisImpl#getReferencedAnalysis
 * <em>Referenced Analysis</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DAnalysisImpl#getModels <em>Models
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DAnalysisImpl#getEAnnotations <em>
 * EAnnotations</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DAnalysisImpl#getOwnedViews <em>Owned
 * Views</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DAnalysisImpl#getSelectedViews <em>
 * Selected Views</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.impl.DAnalysisImpl#getOwnedFeatureExtensions
 * <em>Owned Feature Extensions</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DAnalysisImpl#getVersion <em>Version
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class DAnalysisImpl extends EObjectImpl implements DAnalysis {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.DANALYSIS;
    }
    ...
    public EList<DView> getOwnedViews() {
        if (ownedViews == null) {
            ownedViews = new EObjectContainmentEList.Resolving<DView>(DView.class, this, SiriusPackage.DANALYSIS__OWNED_VIEWS);
        }
        return ownedViews;
    }
    ...
    public EList<DView> getSelectedViews() {
        if (selectedViews == null) {
            selectedViews = new EObjectResolvingEList<DView>(DView.class, this, SiriusPackage.DANALYSIS__SELECTED_VIEWS);
        }
    ...
    public EList<DFeatureExtension> getOwnedFeatureExtensions() {
        if (ownedFeatureExtensions == null) {
            ownedFeatureExtensions = new EObjectContainmentEList.Resolving<DFeatureExtension>(DFeatureExtension.class, this, SiriusPackage.DANALYSIS__OWNED_FEATURE_EXTENSIONS);
        }
    ...
    public void setVersion(String newVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DANALYSIS__VERSION, oldVersion, version));
    }
    ...
    public EList<DAnalysis> getReferencedAnalysis() {
        if (referencedAnalysis == null) {
            referencedAnalysis = new EObjectResolvingEList<DAnalysis>(DAnalysis.class, this, SiriusPackage.DANALYSIS__REFERENCED_ANALYSIS);
        }
    ...
    public EList<EObject> getModels() {
        if (models == null) {
            models = new EObjectResolvingEList<EObject>(EObject.class, this, SiriusPackage.DANALYSIS__MODELS);
        }
        return models;
    }
    ...
    public EList<DAnnotationEntry> getEAnnotations() {
        if (eAnnotations == null) {
            eAnnotations = new EObjectContainmentEList<DAnnotationEntry>(DAnnotationEntry.class, this, SiriusPackage.DANALYSIS__EANNOTATIONS);
        }
        return eAnnotations;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SiriusPackage.DANALYSIS__EANNOTATIONS:
            return ((InternalEList<?>) getEAnnotations()).basicRemove(otherEnd, msgs);
        case SiriusPackage.DANALYSIS__OWNED_VIEWS:
            return ((InternalEList<?>) getOwnedViews()).basicRemove(otherEnd, msgs);
        case SiriusPackage.DANALYSIS__OWNED_FEATURE_EXTENSIONS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SiriusPackage.DANALYSIS__REFERENCED_ANALYSIS:
            return getReferencedAnalysis();
        case SiriusPackage.DANALYSIS__MODELS:
            return getModels();
        case SiriusPackage.DANALYSIS__EANNOTATIONS:
            return getEAnnotations();
        case SiriusPackage.DANALYSIS__OWNED_VIEWS:
            return getOwnedViews();
        case SiriusPackage.DANALYSIS__SELECTED_VIEWS:
            return getSelectedViews();
        case SiriusPackage.DANALYSIS__OWNED_FEATURE_EXTENSIONS:
            return getOwnedFeatureExtensions();
        case SiriusPackage.DANALYSIS__VERSION:
            return getVersion();
        }
