 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.DNavigableImpl#getOwnedNavigationLinks
...
public abstract class DNavigableImpl extends EObjectImpl implements DNavigable {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.DNAVIGABLE;
    }
    ...
    public EList<DNavigationLink> getOwnedNavigationLinks() {
        if (ownedNavigationLinks == null) {
            ownedNavigationLinks = new EObjectContainmentEList.Resolving<DNavigationLink>(DNavigationLink.class, this, SiriusPackage.DNAVIGABLE__OWNED_NAVIGATION_LINKS);
        }
