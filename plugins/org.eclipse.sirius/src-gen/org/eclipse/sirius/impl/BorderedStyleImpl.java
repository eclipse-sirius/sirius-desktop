 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.BorderedStyleImpl#getBorderSize <em>
 * Border Size</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.impl.BorderedStyleImpl#getBorderSizeComputationExpression
 * <em>Border Size Computation Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.BorderedStyleImpl#getBorderColor <em>
 * Border Color</em>}</li>
 * </ul>
 * </p>
 * 
...
public class BorderedStyleImpl extends StyleImpl implements BorderedStyle {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.BORDERED_STYLE;
    }
    ...
    public void setBorderSize(Integer newBorderSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.BORDERED_STYLE__BORDER_SIZE, oldBorderSize, borderSize));
    }
    ...
    public void setBorderSizeComputationExpression(String newBorderSizeComputationExpression) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.BORDERED_STYLE__BORDER_SIZE_COMPUTATION_EXPRESSION, oldBorderSizeComputationExpression,
    ...
    public RGBValues getBorderColor() {
        if (borderColor != null && borderColor.eIsProxy()) {
            ...
            if (borderColor != oldBorderColor) {
                ...
                NotificationChain msgs = oldBorderColor.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.BORDERED_STYLE__BORDER_COLOR, null, null);
                if (newBorderColor.eInternalContainer() == null) {
                    msgs = newBorderColor.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.BORDERED_STYLE__BORDER_COLOR, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.BORDERED_STYLE__BORDER_COLOR, oldBorderColor, borderColor));
            }
        }
        return borderColor;
    }
    ...
    public NotificationChain basicSetBorderColor(RGBValues newBorderColor, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SiriusPackage.BORDERED_STYLE__BORDER_COLOR, oldBorderColor, newBorderColor);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setBorderColor(RGBValues newBorderColor) {
        if (newBorderColor != borderColor) {
            ...
            if (borderColor != null)
                msgs = ((InternalEObject) borderColor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.BORDERED_STYLE__BORDER_COLOR, null, msgs);
            if (newBorderColor != null)
                msgs = ((InternalEObject) newBorderColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SiriusPackage.BORDERED_STYLE__BORDER_COLOR, null, msgs);
            msgs = basicSetBorderColor(newBorderColor, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.BORDERED_STYLE__BORDER_COLOR, newBorderColor, newBorderColor));
    }
