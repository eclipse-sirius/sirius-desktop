 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.impl.DNodeContainerImpl#getOwnedDiagramElements
 * <em>Owned Diagram Elements</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.impl.DNodeContainerImpl#getChildrenPresentation
...
public class DNodeContainerImpl extends DDiagramElementContainerImpl implements DNodeContainer {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.DNODE_CONTAINER;
    }
    ...
    public EList<DDiagramElement> getOwnedDiagramElements() {
        if (ownedDiagramElements == null) {
            ownedDiagramElements = new EObjectContainmentEList.Resolving<DDiagramElement>(DDiagramElement.class, this, SiriusPackage.DNODE_CONTAINER__OWNED_DIAGRAM_ELEMENTS);
        }
    ...
    public void setChildrenPresentation(ContainerLayout newChildrenPresentation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DNODE_CONTAINER__CHILDREN_PRESENTATION, oldChildrenPresentation, childrenPresentation));
    }
