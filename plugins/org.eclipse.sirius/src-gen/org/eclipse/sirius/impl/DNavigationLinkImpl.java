 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.impl.DNavigationLinkImpl#getTargetType <em>
 * Target Type</em>}</li>
 * <li>{@link org.eclipse.sirius.impl.DNavigationLinkImpl#getLabel <em>Label
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public abstract class DNavigationLinkImpl extends EObjectImpl implements DNavigationLink {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.DNAVIGATION_LINK;
    }
    ...
    public void setTargetType(NavigationTargetType newTargetType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DNAVIGATION_LINK__TARGET_TYPE, oldTargetType, targetType));
    }
    ...
    public void setLabel(String newLabel) {
        ...
        label = newLabel;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DNAVIGATION_LINK__LABEL, oldLabel, label));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SiriusPackage.DNAVIGATION_LINK__TARGET_TYPE:
            return getTargetType();
        case SiriusPackage.DNAVIGATION_LINK__LABEL:
            return getLabel();
        }
