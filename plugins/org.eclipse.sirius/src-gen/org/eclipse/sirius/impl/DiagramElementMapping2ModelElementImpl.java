 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.impl.DiagramElementMapping2ModelElementImpl#getTypedKey
 * <em>Key</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.impl.DiagramElementMapping2ModelElementImpl#getTypedValue
 * <em>Value</em>}</li>
 * </ul>
 * </p>
 * 
...
public class DiagramElementMapping2ModelElementImpl extends EObjectImpl implements BasicEMap.Entry<DiagramElementMapping, EMap<EObject, EMap<EObject, EMap<EObject, StyleDescription>>>> {
    ...
    protected EClass eStaticClass() {
        return SiriusPackage.Literals.DIAGRAM_ELEMENT_MAPPING2_MODEL_ELEMENT;
    }
        ...
        if (key != null && key.eIsProxy()) {
            ...
            if (key != oldKey) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SiriusPackage.DIAGRAM_ELEMENT_MAPPING2_MODEL_ELEMENT__KEY, oldKey, key));
            }
        }
        return key;
    }
    ...
    public void setTypedKey(DiagramElementMapping newKey) {
        ...
        key = newKey;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SiriusPackage.DIAGRAM_ELEMENT_MAPPING2_MODEL_ELEMENT__KEY, oldKey, key));
    }
    ...
    public EMap<EObject, EMap<EObject, EMap<EObject, StyleDescription>>> getTypedValue() {
        if (value == null) {
            value = new EcoreEMap<EObject, EMap<EObject, EMap<EObject, StyleDescription>>>(SiriusPackage.Literals.MODEL_ELEMENT2_VIEW_VARIABLE, ModelElement2ViewVariableImpl.class, this,
                    SiriusPackage.DIAGRAM_ELEMENT_MAPPING2_MODEL_ELEMENT__VALUE);
        }
        return value;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case SiriusPackage.DIAGRAM_ELEMENT_MAPPING2_MODEL_ELEMENT__KEY:
            if (resolve)
                return getTypedKey();
