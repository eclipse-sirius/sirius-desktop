 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.description.Layer#getNodeMappings <em>Node
 * Mappings</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getEdgeMappings <em>Edge
 * Mappings</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getEdgeMappingImports <em>
 * Edge Mapping Imports</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getContainerMappings <em>
 * Container Mappings</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getReusedMappings <em>
 * Reused Mappings</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getAllTools <em>All Tools
 * </em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getToolSections <em>Tool
 * Sections</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getReusedTools <em>Reused
 * Tools</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.description.Layer#getDecorationDescriptionsSet
 * <em>Decoration Descriptions Set</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getIcon <em>Icon</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getAllEdgeMappings <em>All
 * Edge Mappings</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.description.Layer#getAllActivatedEdgeMappings
 * <em>All Activated Edge Mappings</em>}</li>
 * <li>{@link org.eclipse.sirius.description.Layer#getCustomization <em>
 * Customization</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.sirius.description.DescriptionPackage#getLayer()
 * @model
 * @generated
 */
public interface Layer extends DocumentedElement, EndUserDocumentedElement, IdentifiedElement {
     ...
     *         list.
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_NodeMappings()
     ...
     *         list.
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_EdgeMappings()
     * @model containment="true" resolveProxies="true" keys="name"
     * @generated
     */
     ...
     *         reference list.
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_EdgeMappingImports()
     * @model containment="true" resolveProxies="true" keys="name"
     * @generated
     */
     ...
     *         reference list.
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_ContainerMappings()
     * @model containment="true" resolveProxies="true" keys="name"
     * @generated
     */
     ...
     * here any mapping you want to reuse from another layer or diagram. <!--
     * end-model-doc -->
     * 
     * @return the value of the '<em>Reused Mappings</em>' reference list.
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_ReusedMappings()
     * @model
     * @generated
     */
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_AllTools()
     ...
     *         list.
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_ToolSections()
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_ReusedTools()
     * @model
     * @generated
     */
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_DecorationDescriptionsSet()
     * @model containment="true" resolveProxies="true"
     * @generated
     */
     ...
     * @see #setIcon(String)
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_Icon()
     * @model
     * @generated
     */
    String getIcon();
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_AllEdgeMappings()
     * @model transient="true" changeable="false" volatile="true" derived="true"
     * @generated
     */
     ...
     *         list.
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_AllActivatedEdgeMappings()
     * @model transient="true" changeable="false" volatile="true" derived="true"
     * @generated
     */
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getLayer_Customization()
     * @model containment="true" resolveProxies="true"
     * @generated
     */
