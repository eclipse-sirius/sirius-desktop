...
public interface DescriptionFactory extends EFactory {
     ...
     * @generated
     */
    DescriptionFactory eINSTANCE = org.eclipse.sirius.description.impl.DescriptionFactoryImpl.init();
    ...
    /**
     * Returns a new object of class '<em>Sirius</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @return a new object of class '<em>Sirius</em>'.
     * @generated
     */
    Sirius createSirius();
