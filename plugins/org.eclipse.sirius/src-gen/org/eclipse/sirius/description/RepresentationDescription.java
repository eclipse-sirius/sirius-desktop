 ...
 * </p>
 * 
 * @see org.eclipse.sirius.description.DescriptionPackage#getRepresentationDescription()
...
public interface RepresentationDescription extends DocumentedElement, EndUserDocumentedElement, IdentifiedElement {
     ...
     * representation. (new + name if empty) <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Title Expression</em>' attribute.
     * @see #setTitleExpression(String)
     * @see org.eclipse.sirius.description.DescriptionPackage#getRepresentationDescription_TitleExpression()
     * @model default=""
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getRepresentationDescription_Initialisation()
     * @model required="true"
     * @generated
     */
     ...
     * might use this reference to statically bind your representation with a
     * set of Ecore packages. Keep in mind that this is not mandatory. <!--
     * end-model-doc -->
     * 
     * @return the value of the '<em>Metamodel</em>' reference list.
     * @see org.eclipse.sirius.description.DescriptionPackage#getRepresentationDescription_Metamodel()
     * @model
     * @generated
     */
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getRepresentationDescription_ShowOnStartup()
     * @model
     * @generated
     */
