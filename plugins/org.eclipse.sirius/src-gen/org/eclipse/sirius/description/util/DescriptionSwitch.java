...
public class DescriptionSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case DescriptionPackage.VIEWPOINT: {
            Sirius viewpoint = (Sirius) theEObject;
            T result = caseSirius(viewpoint);
            if (result == null)
    ...
    /**
     * Returns the result of interpreting the object as an instance of '
     * <em>Sirius</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!--
     * end-user-doc -->
     * 
     * @param object
     ...
     * @generated
     */
    public T caseSirius(Sirius object) {
        return null;
    }
