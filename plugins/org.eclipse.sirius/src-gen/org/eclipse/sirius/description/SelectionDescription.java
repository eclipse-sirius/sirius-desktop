 ...
 * <em><b>Selection Description</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
 ...
 * <li>{@link org.eclipse.sirius.description.SelectionDescription#isMultiple
 * <em>Multiple</em>}</li>
 * <li>{@link org.eclipse.sirius.description.SelectionDescription#isTree <em>
 * Tree</em>}</li>
 * <li>
 ...
 * <li>{@link org.eclipse.sirius.description.SelectionDescription#getMessage
 * <em>Message</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.sirius.description.DescriptionPackage#getSelectionDescription()
...
public interface SelectionDescription extends EObject {
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getSelectionDescription_CandidatesExpression()
     ...
     *        annotation=
     *        "http://www.eclipse.org/sirius/interpreted/expression/variables diagram='viewpoint.DDiagram | the current DDiagram.' containerView='viewpoint.DSemanticDecorator | the view of the container.' container='ecore.EObject | the semantic element of the container.'"
     * @generated
     */
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getSelectionDescription_Multiple()
     * @model required="true"
     * @generated
     */
    boolean isMultiple();
     ...
     * @see #setTree(boolean)
     * @see org.eclipse.sirius.description.DescriptionPackage#getSelectionDescription_Tree()
     * @model required="true"
     * @generated
     */
    boolean isTree();
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getSelectionDescription_RootExpression()
     * @model dataType="org.eclipse.sirius.description.InterpretedExpression"
     *        annotation=
     *        "http://www.eclipse.org/sirius/interpreted/expression/returnType returnType='a Collection<EObject> or an EObject.'"
     *        annotation=
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getSelectionDescription_ChildrenExpression()
     * @model dataType="org.eclipse.sirius.description.InterpretedExpression"
     *        annotation=
     *        "http://www.eclipse.org/sirius/interpreted/expression/returnType returnType='a Collection<EObject> or an EObject.'"
     *        annotation=
     ...
     * @see org.eclipse.sirius.description.DescriptionPackage#getSelectionDescription_Message()
     * @model
     * @generated
     */
    String getMessage();
