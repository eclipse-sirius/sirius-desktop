...
import org.eclipse.sirius.description.audit.AuditFactory;
...
public class AuditFactoryImpl extends EFactoryImpl implements AuditFactory {
    ...
    public static AuditFactory init() {
        try {
            AuditFactory theAuditFactory = (AuditFactory) EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/sirius/description/audit/1.1.0");
