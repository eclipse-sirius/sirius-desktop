...
public class DescriptionFactoryImpl extends EFactoryImpl implements DescriptionFactory {
    ...
    public static DescriptionFactory init() {
        try {
            DescriptionFactory theDescriptionFactory = (DescriptionFactory) EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/sirius/description/1.1.0");
     ...
     * @not-generated
     */
    public Sirius createSirius() {
        SiriusImpl viewpoint = new SiriusSpec();
        return viewpoint;
    }
