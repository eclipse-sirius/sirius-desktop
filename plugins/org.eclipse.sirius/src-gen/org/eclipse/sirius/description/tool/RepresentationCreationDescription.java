 ...
 * </p>
 * 
 * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationCreationDescription()
 * @model abstract="true"
 * @generated
 */
public interface RepresentationCreationDescription extends AbstractToolDescription {
     ...
     * end-user-doc --> <!-- begin-model-doc --> The default title of the
     * representation to create. (new + name if empty) <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Title Expression</em>' attribute.
     * @see #setTitleExpression(String)
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationCreationDescription_TitleExpression()
     * @model default=""
     ...
     * You might put here an expression to browse the semantic model to get to a
     * new place before creating the representation. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Browse Expression</em>' attribute.
     * @see #setBrowseExpression(String)
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationCreationDescription_BrowseExpression()
     ...
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationCreationDescription_RepresentationDescription()
     ...
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationCreationDescription_InitialOperation()
     ...
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationCreationDescription_ContainerViewVariable()
     ...
     * name of the created representation. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Representation Name Variable</em>'
     *         containment reference.
     * @see #setRepresentationNameVariable(NameVariable)
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationCreationDescription_RepresentationNameVariable()
     * @model containment="true" resolveProxies="true" required="true"
     *        annotation=
