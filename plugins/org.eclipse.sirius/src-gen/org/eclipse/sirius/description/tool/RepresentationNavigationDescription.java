 ...
 * </p>
 * 
 * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationNavigationDescription()
 * @model abstract="true"
 * @generated
 */
public interface RepresentationNavigationDescription extends AbstractToolDescription {
     ...
     * Expression returning the navigation target. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Browse Expression</em>' attribute.
     * @see #setBrowseExpression(String)
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationNavigationDescription_BrowseExpression()
    ...
    /**
     * Returns the value of the '<em><b>Navigation Name Expression</b></em>'
     * attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Navigation Name Expression</em>' attribute
     ...
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationNavigationDescription_NavigationNameExpression()
     * @model dataType="org.eclipse.sirius.description.InterpretedExpression"
     *        annotation=
     ...
     * 
     * @param value
     *            the new value of the '<em>Navigation Name Expression</em>'
     *            attribute.
    ...
    /**
     * Returns the value of the '<em><b>Representation Description</b></em>'
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Representation Description</em>' reference
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Representation Description</em>' reference.
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationNavigationDescription_RepresentationDescription()
     ...
     * clickedView (instance of Sirius or SiriusElement). <!--
     * end-model-doc -->
     * 
     * @return the value of the '<em>Container View Variable</em>' containment
     *         reference.
     * @see #setContainerViewVariable(ContainerViewVariable)
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationNavigationDescription_ContainerViewVariable()
     ...
     * 
     * @param value
     *            the new value of the '<em>Container View Variable</em>'
    ...
    /**
     * Returns the value of the '<em><b>Container Variable</b></em>' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The variable container that represents the semantic
     * element of the clicked view. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Container Variable</em>' containment
     *         reference.
     * @see #setContainerVariable(ElementSelectVariable)
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationNavigationDescription_ContainerVariable()
     * @model containment="true" resolveProxies="true" required="true"
     *        annotation=
     ...
     * 
     * @param value
     *            the new value of the '<em>Container Variable</em>' containment
     *            reference.
    ...
    /**
     * Returns the value of the '<em><b>Representation Name Variable</b></em>'
     * containment reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The variable representationName that represents the
     * name of the representation to open. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Representation Name Variable</em>'
     *         containment reference.
     * @see #setRepresentationNameVariable(NameVariable)
     * @see org.eclipse.sirius.description.tool.ToolPackage#getRepresentationNavigationDescription_RepresentationNameVariable()
     * @model containment="true" resolveProxies="true" required="true"
     *        annotation=
     ...
     * 
     * @param value
     *            the new value of the '<em>Representation Name Variable</em>'
     *            containment reference.
