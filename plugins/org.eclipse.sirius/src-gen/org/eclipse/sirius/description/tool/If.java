 ...
 * all operations contains by this If statement will be executed, otherwise all
 * operations will be ignored. <!-- end-model-doc -->
 * 
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link org.eclipse.sirius.description.tool.If#getConditionExpression
 * <em>Condition Expression</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.sirius.description.tool.ToolPackage#getIf()
 * @model
 * @generated
 */
public interface If extends ContainerModelOperation {
     ...
     * <p>
     * If the meaning of the '<em>Condition Expression</em>' attribute isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc --> <!-- begin-model-doc --> Expression representing
     * the condition, if it returns true, every operation contained by this
     * statement will be executed. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Condition Expression</em>' attribute.
     * @see #setConditionExpression(String)
     * @see org.eclipse.sirius.description.tool.ToolPackage#getIf_ConditionExpression()
