...
public class ToolPackageImpl extends EPackageImpl implements ToolPackage {
     ...
     * @see org.eclipse.sirius.description.tool.ToolPackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public void initializePackageContents() {
        ...
        addEParameter(op, theSiriusPackage.getEdgeTarget(), "source", 0, 1, IS_UNIQUE, IS_ORDERED);
        addEParameter(op, theSiriusPackage.getEdgeTarget(), "target", 0, 1, IS_UNIQUE, IS_ORDERED);
        ...
        addEParameter(op, theSiriusPackage.getDragAndDropTarget(), "targetContainer", 0, 1, IS_UNIQUE, IS_ORDERED);
