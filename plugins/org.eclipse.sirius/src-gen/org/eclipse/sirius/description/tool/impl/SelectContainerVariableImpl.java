 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.description.tool.impl.SelectContainerVariableImpl#getSubVariables
...
public class SelectContainerVariableImpl extends AbstractVariableImpl implements SelectContainerVariable {
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.SELECT_CONTAINER_VARIABLE;
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == VariableContainer.class) {
            ...
            case ToolPackage.VARIABLE_CONTAINER__SUB_VARIABLES:
                return ToolPackage.SELECT_CONTAINER_VARIABLE__SUB_VARIABLES;
            default:
                return -1;
            }
        }
