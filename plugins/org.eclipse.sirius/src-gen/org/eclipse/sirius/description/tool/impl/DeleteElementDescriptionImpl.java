...
import org.eclipse.sirius.description.tool.ElementDeleteVariable;
 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.description.tool.impl.DeleteElementDescriptionImpl#getElement
 * <em>Element</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.description.tool.impl.DeleteElementDescriptionImpl#getElementView
 * <em>Element View</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.description.tool.impl.DeleteElementDescriptionImpl#getContainerView
 * <em>Container View</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.description.tool.impl.DeleteElementDescriptionImpl#getInitialOperation
 * <em>Initial Operation</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.description.tool.impl.DeleteElementDescriptionImpl#getHook
 * <em>Hook</em>}</li>
 * </ul>
 * </p>
 * 
...
public class DeleteElementDescriptionImpl extends MappingBasedToolDescriptionImpl implements DeleteElementDescription {
    ...
    public ElementDeleteVariable getElement() {
        if (element != null && element.eIsProxy()) {
            ...
            if (element != oldElement) {
                ...
                NotificationChain msgs = oldElement.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__ELEMENT, null, null);
                if (newElement.eInternalContainer() == null) {
                    msgs = newElement.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__ELEMENT, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
    ...
    public void setElement(ElementDeleteVariable newElement) {
        if (newElement != element) {
            ...
            if (element != null)
                msgs = ((InternalEObject) element).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__ELEMENT, null, msgs);
            if (newElement != null)
                msgs = ((InternalEObject) newElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__ELEMENT, null, msgs);
    ...
    public ElementDeleteVariable getElementView() {
        if (elementView != null && elementView.eIsProxy()) {
            ...
            if (elementView != oldElementView) {
                ...
                NotificationChain msgs = oldElementView.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__ELEMENT_VIEW, null, null);
                if (newElementView.eInternalContainer() == null) {
                    msgs = newElementView.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__ELEMENT_VIEW, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
    ...
    public void setElementView(ElementDeleteVariable newElementView) {
        if (newElementView != elementView) {
            NotificationChain msgs = null;
            if (elementView != null)
                msgs = ((InternalEObject) elementView).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__ELEMENT_VIEW, null, msgs);
            if (newElementView != null)
                msgs = ((InternalEObject) newElementView).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__ELEMENT_VIEW, null, msgs);
    ...
    public ContainerViewVariable getContainerView() {
        if (containerView != null && containerView.eIsProxy()) {
            ...
            if (containerView != oldContainerView) {
                ...
                NotificationChain msgs = oldContainerView.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__CONTAINER_VIEW, null, null);
                if (newContainerView.eInternalContainer() == null) {
                    msgs = newContainerView.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__CONTAINER_VIEW, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
    ...
    public void setContainerView(ContainerViewVariable newContainerView) {
        if (newContainerView != containerView) {
            ...
            if (containerView != null)
                msgs = ((InternalEObject) containerView).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__CONTAINER_VIEW, null, msgs);
            if (newContainerView != null)
                msgs = ((InternalEObject) newContainerView).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__CONTAINER_VIEW, null, msgs);
    ...
    public InitialOperation getInitialOperation() {
        if (initialOperation != null && initialOperation.eIsProxy()) {
            ...
            if (initialOperation != oldInitialOperation) {
                ...
                NotificationChain msgs = oldInitialOperation.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__INITIAL_OPERATION, null, null);
                if (newInitialOperation.eInternalContainer() == null) {
                    msgs = newInitialOperation.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__INITIAL_OPERATION, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
    ...
    public void setInitialOperation(InitialOperation newInitialOperation) {
        if (newInitialOperation != initialOperation) {
            ...
            if (initialOperation != null)
                msgs = ((InternalEObject) initialOperation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__INITIAL_OPERATION, null, msgs);
            if (newInitialOperation != null)
                msgs = ((InternalEObject) newInitialOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__INITIAL_OPERATION, null, msgs);
    ...
    public DeleteHook getHook() {
        if (hook != null && hook.eIsProxy()) {
            ...
            if (hook != oldHook) {
                ...
                NotificationChain msgs = oldHook.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__HOOK, null, null);
                if (newHook.eInternalContainer() == null) {
                    msgs = newHook.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__HOOK, null, msgs);
                }
                if (msgs != null)
                    msgs.dispatch();
                if (eNotificationRequired())
    ...
    public void setHook(DeleteHook newHook) {
        if (newHook != hook) {
            NotificationChain msgs = null;
            if (hook != null)
                msgs = ((InternalEObject) hook).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__HOOK, null, msgs);
            if (newHook != null)
                msgs = ((InternalEObject) newHook).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.DELETE_ELEMENT_DESCRIPTION__HOOK, null, msgs);
