 ...
 * <em><b>Node Creation Variable</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.description.tool.impl.NodeCreationVariableImpl#getSubVariables
...
public class NodeCreationVariableImpl extends AbstractVariableImpl implements NodeCreationVariable {
     ...
     * @generated
     */
    protected NodeCreationVariableImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.NODE_CREATION_VARIABLE;
    }
    ...
    public EList<SubVariable> getSubVariables() {
        if (subVariables == null) {
            subVariables = new EObjectContainmentEList.Resolving<SubVariable>(SubVariable.class, this, ToolPackage.NODE_CREATION_VARIABLE__SUB_VARIABLES);
        }
        return subVariables;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ToolPackage.NODE_CREATION_VARIABLE__SUB_VARIABLES:
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == VariableContainer.class) {
            ...
            case ToolPackage.VARIABLE_CONTAINER__SUB_VARIABLES:
                return ToolPackage.NODE_CREATION_VARIABLE__SUB_VARIABLES;
            default:
                return -1;
            }
        }
