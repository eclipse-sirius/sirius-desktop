 ...
 * <em><b>Element View Variable</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.description.tool.impl.ElementViewVariableImpl#getSubVariables
...
public class ElementViewVariableImpl extends AbstractVariableImpl implements ElementViewVariable {
     ...
     * @generated
     */
    protected ElementViewVariableImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.ELEMENT_VIEW_VARIABLE;
    }
    ...
    public EList<SubVariable> getSubVariables() {
        if (subVariables == null) {
            subVariables = new EObjectContainmentEList.Resolving<SubVariable>(SubVariable.class, this, ToolPackage.ELEMENT_VIEW_VARIABLE__SUB_VARIABLES);
        }
        return subVariables;
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == VariableContainer.class) {
            ...
            case ToolPackage.VARIABLE_CONTAINER__SUB_VARIABLES:
                return ToolPackage.ELEMENT_VIEW_VARIABLE__SUB_VARIABLES;
            default:
                return -1;
            }
        }
