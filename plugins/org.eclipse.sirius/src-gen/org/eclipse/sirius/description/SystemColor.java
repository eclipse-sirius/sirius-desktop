 ...
 * <ul>
 * <li>{@link org.eclipse.sirius.description.SystemColor#getName <em>Name
 * </em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.sirius.description.DescriptionPackage#getSystemColor()
 * @model
 * @generated
 */
public interface SystemColor extends FixedColor {
     ...
     * </p>
     * <!-- end-user-doc --> <!-- begin-model-doc --> The name of the color
     * description, as shown to the user in color palettes. <!-- end-model-doc
     * -->
     * 
     * @return the value of the '<em>Name</em>' attribute.
     * @see #setName(String)
     * @see org.eclipse.sirius.description.DescriptionPackage#getSystemColor_Name()
     * @model required="true"
     * @generated
     */
    String getName();
