 ...
 * </p>
 * 
 * @see org.eclipse.sirius.description.style.StylePackage#getNodeStyleDescription()
 * @model abstract="true"
 * @generated
 */
public interface NodeStyleDescription extends StyleDescription, BorderedStyleDescription, LabelStyleDescription, TooltipStyleDescription {
     ...
     * @see org.eclipse.sirius.description.style.StylePackage#getNodeStyleDescription_SizeComputationExpression()
     ...
     * enumeration {@link org.eclipse.sirius.LabelPosition}. <!--
     ...
     * @see org.eclipse.sirius.description.style.StylePackage#getNodeStyleDescription_LabelPosition()
     ...
     * @see org.eclipse.sirius.description.style.StylePackage#getNodeStyleDescription_HideLabelByDefault()
     * @model default="false"
     * @generated
     */
     ...
     * --> <!-- end-user-doc --> <!-- begin-model-doc --> If true then the node
     * can be resized by the user. <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Resize Kind</em>' attribute.
     * @see org.eclipse.sirius.ResizeKind
     * @see #setResizeKind(ResizeKind)
     * @see org.eclipse.sirius.description.style.StylePackage#getNodeStyleDescription_ResizeKind()
