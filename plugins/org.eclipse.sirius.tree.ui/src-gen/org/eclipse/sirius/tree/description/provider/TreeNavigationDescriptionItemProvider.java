...
import org.eclipse.sirius.description.tool.provider.RepresentationNavigationDescriptionItemProvider;
 ...
 * @generated
 */
public class TreeNavigationDescriptionItemProvider extends RepresentationNavigationDescriptionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
    ...
    public String getText(Object object) {
        String label = ((TreeNavigationDescription) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_TreeNavigationDescription_type") : getString("_UI_TreeNavigationDescription_type") + " " + label;
    }
