 ...
 * @generated
 */
public class DTreeItemProvider extends DRepresentationItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
        IItemPropertySource {
    /**
    ...
    protected void addDescriptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_DTree_description_feature"), getString("_UI_PropertyDescriptor_description", "_UI_DTree_description_feature", "_UI_DTree_type"),
