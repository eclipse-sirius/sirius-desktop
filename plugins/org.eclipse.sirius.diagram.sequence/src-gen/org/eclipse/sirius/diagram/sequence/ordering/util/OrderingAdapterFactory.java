...
public class OrderingAdapterFactory extends AdapterFactoryImpl {
     ...
     * <em>Event Ends Ordering</em>}'. <!-- begin-user-doc --> This default
     ...
     * <em>Event End</em>}'. <!-- begin-user-doc --> This default implementation
     ...
     * <em>Single Event End</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     *
     ...
     * <em>Compound Event End</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     *
     ...
     * <em>Instance Roles Ordering</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's
     * useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     *
