...
public interface TLifelineMapping extends TAbstractMapping, TMessageExtremity {
    /**
     * Returns the value of the '<em><b>Eol Visible Expression</b></em>'
     * attribute. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Eol Visible Expression</em>' attribute isn't
     ...
     *        annotation=
     *        "http://www.eclipse.org/sirius/interpreted/expression/variables containerView='the view that sould contain the potential views of the checked elements.' container='the semantic element of $containerView.' viewpoint='(deprecated) the current DSemanticDiagram.' diagram='the current DSemanticDiagram.'"
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Instance Role Style</b></em>'
     * containment reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Instance Role Style</em>' containment
    ...
    /**
     * Returns the value of the '<em><b>Lifeline Style</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Lifeline Style</em>' containment reference
    ...
    /**
     * Returns the value of the '<em><b>End Of Life Style</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>End Of Life Style</em>' containment reference
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Conditional Life Line Styles</b></em>'
