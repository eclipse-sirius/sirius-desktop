...
public class TConditionalMessageStyleImpl extends TTransformerImpl implements TConditionalMessageStyle {
    ...
    public void setStyle(TMessageStyle newStyle) {
        if (newStyle != style) {
            ...
            if (style != null)
                msgs = ((InternalEObject) style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.TCONDITIONAL_MESSAGE_STYLE__STYLE, null, msgs);
            if (newStyle != null)
                msgs = ((InternalEObject) newStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.TCONDITIONAL_MESSAGE_STYLE__STYLE, null, msgs);
