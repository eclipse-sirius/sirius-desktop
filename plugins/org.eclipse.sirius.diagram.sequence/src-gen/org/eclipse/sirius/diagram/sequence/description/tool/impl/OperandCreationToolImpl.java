    ...
    public void setStartingEndPredecessor(MessageEndVariable newStartingEndPredecessor) {
        if (newStartingEndPredecessor != startingEndPredecessor) {
            ...
            if (startingEndPredecessor != null)
                msgs = ((InternalEObject) startingEndPredecessor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.OPERAND_CREATION_TOOL__STARTING_END_PREDECESSOR, null, msgs);
            if (newStartingEndPredecessor != null)
                msgs = ((InternalEObject) newStartingEndPredecessor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.OPERAND_CREATION_TOOL__STARTING_END_PREDECESSOR, null, msgs);
    ...
    public void setFinishingEndPredecessor(MessageEndVariable newFinishingEndPredecessor) {
        if (newFinishingEndPredecessor != finishingEndPredecessor) {
            ...
            if (finishingEndPredecessor != null)
                msgs = ((InternalEObject) finishingEndPredecessor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ToolPackage.OPERAND_CREATION_TOOL__FINISHING_END_PREDECESSOR, null, msgs);
            if (newFinishingEndPredecessor != null)
                msgs = ((InternalEObject) newFinishingEndPredecessor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ToolPackage.OPERAND_CREATION_TOOL__FINISHING_END_PREDECESSOR, null, msgs);
