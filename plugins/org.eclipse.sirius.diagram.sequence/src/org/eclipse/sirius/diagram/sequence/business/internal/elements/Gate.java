...
//    }
    ...
    /**
     * Validate that the gate is reflective. Therefore, its start message must be reflective and its return message must
     * be null (Asynchronous message) or reflexive.
     * 
     * @return if the gate is reflective
     */
