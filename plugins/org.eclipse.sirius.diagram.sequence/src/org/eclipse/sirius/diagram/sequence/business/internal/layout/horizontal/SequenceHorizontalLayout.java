        ...
        if (allInteractionContainers.isPresent()) {
            ...
            if (interactionContainerLayoutConstraint instanceof Bounds interactionContainerBounds) {
                ...
                for (Rectangle sequenceElementRectangle : bounds.values()) {
                    if (sequenceElementRectangle.x() + sequenceElementRectangle.width() + InteractionContainer.MARGIN > rectangle.width()) {
                        // This sequence element east bound + margin is further away than the interaction container east
                        // bounds
                        rectangle.setWidth(sequenceElementRectangle.x() + sequenceElementRectangle.width() + InteractionContainer.MARGIN);
                    }
                    applied = true;
                }
