...
public interface DCell extends DSemanticDecorator, DTableElement {
    ...
    /**
     * Returns the value of the '<em><b>Line</b></em>' container reference. It
    ...
    /**
     * Returns the value of the '<em><b>Column</b></em>' reference. It is
     * bidirectional and its opposite is '
     * {@link org.eclipse.sirius.table.metamodel.table.DColumn#getCells
     * <em>Cells</em>}'. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Column</em>' reference isn't clear, there
     * really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Current Style</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Current Style</em>' containment reference
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc --> <!-- begin-model-doc --> Stores the best style of
     * the IntersectionMapping style updater and ColumnMapping style updater : *
     * Foreground ** The first conditional foreground style of the cell (with
     * predicate expression that returns true). In this case the
     * foregroundStyleOrigin references the intersection mapping and the
     * defaultForegroundStyle is equal false. ** Otherwise the first conditional
     * foreground style of the column (with predicate expression that returns
     * true). In this case the foregroundStyleOrigin references the column
     * mapping and the defaultForegroundStyle is equal false. ** Otherwise, if
     * it exists, the default foreground style of the cell. In this case the
     * foregroundStyleOrigin references the intersection mapping and the
     * defaultForegroundStyle is equal true. ** Otherwise, if the default
     * foreground style of the column uses variable color, the default
     * foreground style of the column. In this case the foregroundStyleOrigin
     * references the column mapping and the defaultForegroundStyle is equal
     * true. * Background ** The first conditional background style of the cell
     * (with predicate expression that returns true). In this case the
     * backgroundStyleOrigin references the intersection mapping and the
     * defaultBackgroundStyle is equal false. ** Otherwise the first conditional
     * background style of the column (with predicate expression that returns
     * true). In this case the backgroundStyleOrigin references the column
     * mapping and the defaultBackgroundStyle is equal false. ** Otherwise, if
     * it exists, the default background style of the cell. In this case the
     * backgroundStyleOrigin references the intersection mapping and the
     * defaultBackgroundStyle is equal true. ** Otherwise, if the default
     * background style of the column uses variable color, the default
    ...
    /**
     * Returns the value of the '<em><b>Intersection Mapping</b></em>'
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Intersection Mapping</em>' reference isn't
