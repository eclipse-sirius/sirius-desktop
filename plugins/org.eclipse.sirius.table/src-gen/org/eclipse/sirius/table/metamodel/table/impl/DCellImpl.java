    ...
    public void setCurrentStyle(DCellStyle newCurrentStyle) {
        if (newCurrentStyle != currentStyle) {
            ...
            if (currentStyle != null)
                msgs = ((InternalEObject) currentStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TablePackage.DCELL__CURRENT_STYLE, null, msgs);
            if (newCurrentStyle != null)
                msgs = ((InternalEObject) newCurrentStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TablePackage.DCELL__CURRENT_STYLE, null, msgs);
