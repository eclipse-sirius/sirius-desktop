...
public interface TableDescription extends RepresentationDescription, DocumentedElement, EndUserDocumentedElement {
     ...
     * @model keys="name" transient="true" changeable="false" volatile="true"
     *        derived="true"
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Owned Create Line</b></em>' containment
     * reference list. The list contents are of type
     * {@link org.eclipse.sirius.table.metamodel.table.description.CreateLineTool}
     * . <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Owned Create Line</em>' containment reference
    ...
    /**
     * Returns the value of the '<em><b>Reused Create Line</b></em>' reference
     * list. The list contents are of type
     * {@link org.eclipse.sirius.table.metamodel.table.description.CreateLineTool}
     * . <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Reused Create Line</em>' reference list isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>All Create Line</b></em>' reference
     * list. The list contents are of type
     * {@link org.eclipse.sirius.table.metamodel.table.description.CreateLineTool}
     * . <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>All Create Line</em>' reference list isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>Initial Header Column Width</b></em>'
    ...
    /**
     * Returns the value of the '<em><b>Imported Elements</b></em>' containment
     * reference list. The list contents are of type
     * {@link org.eclipse.emf.ecore.EObject}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Imported Elements</em>' containment reference
     * list isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
