    ...
    public void setFirstModelOperation(ModelOperation newFirstModelOperation) {
        if (newFirstModelOperation != firstModelOperation) {
            ...
            if (firstModelOperation != null)
                msgs = ((InternalEObject) firstModelOperation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DescriptionPackage.DELETE_TOOL__FIRST_MODEL_OPERATION, null, msgs);
            if (newFirstModelOperation != null)
                msgs = ((InternalEObject) newFirstModelOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DescriptionPackage.DELETE_TOOL__FIRST_MODEL_OPERATION, null, msgs);
