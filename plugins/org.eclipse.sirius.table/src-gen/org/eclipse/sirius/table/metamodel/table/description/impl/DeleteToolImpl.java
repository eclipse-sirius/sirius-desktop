 ...
 * <ul>
 * <li>
 * {@link org.eclipse.sirius.table.metamodel.table.description.impl.DeleteToolImpl#getVariables
 * <em>Variables</em>}</li>
 * <li>
 * {@link org.eclipse.sirius.table.metamodel.table.description.impl.DeleteToolImpl#getFirstModelOperation
 * <em>First Model Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DeleteToolImpl extends AbstractToolDescriptionImpl implements DeleteTool {
    /**
    ...
    protected EClass eStaticClass() {
        return DescriptionPackage.Literals.DELETE_TOOL;
    }
    ...
    public EList<TableVariable> getVariables() {
        if (variables == null) {
            variables = new EObjectContainmentEList<TableVariable>(TableVariable.class, this, DescriptionPackage.DELETE_TOOL__VARIABLES);
        }
        return variables;
    }
    ...
    public NotificationChain basicSetFirstModelOperation(ModelOperation newFirstModelOperation, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DescriptionPackage.DELETE_TOOL__FIRST_MODEL_OPERATION, oldFirstModelOperation, newFirstModelOperation);
            if (msgs == null) {
                msgs = notification;
            } else {
    ...
    public void setFirstModelOperation(ModelOperation newFirstModelOperation) {
        if (newFirstModelOperation != firstModelOperation) {
            ...
            if (firstModelOperation != null) {
                msgs = ((InternalEObject) firstModelOperation).eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE - DescriptionPackage.DELETE_TOOL__FIRST_MODEL_OPERATION, null, msgs);
            }
            if (newFirstModelOperation != null) {
                msgs = ((InternalEObject) newFirstModelOperation).eInverseAdd(this, InternalEObject.EOPPOSITE_FEATURE_BASE - DescriptionPackage.DELETE_TOOL__FIRST_MODEL_OPERATION, null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, DescriptionPackage.DELETE_TOOL__FIRST_MODEL_OPERATION, newFirstModelOperation, newFirstModelOperation));
        }
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == TableTool.class) {
            ...
            case DescriptionPackage.TABLE_TOOL__VARIABLES:
                return DescriptionPackage.DELETE_TOOL__VARIABLES;
            case DescriptionPackage.TABLE_TOOL__FIRST_MODEL_OPERATION:
                return DescriptionPackage.DELETE_TOOL__FIRST_MODEL_OPERATION;
            default:
                return -1;
            }
        }
