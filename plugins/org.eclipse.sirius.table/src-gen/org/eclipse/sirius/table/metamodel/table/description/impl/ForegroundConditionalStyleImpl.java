...
public class ForegroundConditionalStyleImpl extends EObjectImpl implements ForegroundConditionalStyle {
    ...
    public void setStyle(ForegroundStyleDescription newStyle) {
        if (newStyle != style) {
            ...
            if (style != null)
                msgs = ((InternalEObject) style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DescriptionPackage.FOREGROUND_CONDITIONAL_STYLE__STYLE, null, msgs);
            if (newStyle != null)
                msgs = ((InternalEObject) newStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DescriptionPackage.FOREGROUND_CONDITIONAL_STYLE__STYLE, null, msgs);
