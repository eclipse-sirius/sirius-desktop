 ...
 */
public class TExecutionMappingFinishingEndFinderExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return TemplatePackage.eINSTANCE.getTExecutionMapping_FinishingEndFinderExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "interpreted expressions which are evaluated in the context of the semantic element of the execution and which should return the semantic element representing the end of the execution.";
    }
