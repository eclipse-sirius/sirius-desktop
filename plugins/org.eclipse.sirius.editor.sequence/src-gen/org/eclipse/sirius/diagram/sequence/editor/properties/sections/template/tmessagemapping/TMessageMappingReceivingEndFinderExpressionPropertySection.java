 ...
 * object.
 */
public class TMessageMappingReceivingEndFinderExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "ReceivingEndFinderExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return TemplatePackage.eINSTANCE.getTMessageMapping_ReceivingEndFinderExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "interpreted expressions which are evaluated in the context of the semantic element of the message and which should return the semantic element representing the reception of the execution.";
    }
