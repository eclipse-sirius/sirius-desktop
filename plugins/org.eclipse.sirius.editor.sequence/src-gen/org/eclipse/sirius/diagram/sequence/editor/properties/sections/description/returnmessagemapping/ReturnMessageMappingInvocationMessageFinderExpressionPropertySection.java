 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.sequence.editor.properties.sections.description.returnmessagemapping;
...
/**
 * A section for the invocationMessageFinderExpression property of a ReturnMessageMapping object.
 */
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ReturnMessageMappingInvocationMessageFinderExpressionPropertySection.this,
                        text.getText());
                dialog.open();
