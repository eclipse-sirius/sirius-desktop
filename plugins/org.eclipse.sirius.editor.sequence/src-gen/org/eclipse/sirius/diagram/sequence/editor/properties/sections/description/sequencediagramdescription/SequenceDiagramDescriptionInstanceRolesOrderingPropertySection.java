 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.sequence.editor.properties.sections.description.sequencediagramdescription;
 ...
 */
public class SequenceDiagramDescriptionInstanceRolesOrderingPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "InstanceRolesOrdering"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getSequenceDiagramDescription_InstanceRolesOrdering();
    }
    ...
    protected String getPropertyDescription() {
        return "An interpreted expression used to compute the semantic ordering of elements used as InstanceRole on the diagram.";
    }
