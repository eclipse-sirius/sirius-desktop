 ...
 */
public class TLifelineStyleLifelineWidthComputationExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "LifelineWidthComputationExpression"; //$NON-NLS-1$
    }
    ...
    protected String getPropertyDescription() {
        return "An interpreted expression computing the size of the lifeline.";
    }
