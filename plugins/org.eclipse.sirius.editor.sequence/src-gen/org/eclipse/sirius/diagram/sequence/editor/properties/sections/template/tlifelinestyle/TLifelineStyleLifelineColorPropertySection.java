 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.sequence.editor.properties.sections.template.tlifelinestyle;
...
/**
 * A section for the lifelineColor property of a TLifelineStyle object.
 */
public class TLifelineStyleLifelineColorPropertySection extends AbstractComboPropertySection {
    /**
    ...
    protected String getDefaultLabelText() {
        return "LifelineColor"; //$NON-NLS-1$
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        combo.setToolTipText("The color of the lifeline.");
        ...
        help.setToolTipText("The color of the lifeline.");
