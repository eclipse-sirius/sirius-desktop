 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.sequence.editor.properties.sections.template.tlifelinemapping;
 ...
 */
public class TLifelineMappingEolVisibleExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "EolVisibleExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return TemplatePackage.eINSTANCE.getTLifelineMapping_EolVisibleExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "An interpreted expression evaluated in the context of the semantic element of the lifeline and which should return a boolean indicating whether the lifeline is the target of a destruction message (which conditions the visibility of the End of Life marker).";
    }
