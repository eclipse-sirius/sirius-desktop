 ...
 * object.
 */
public class SequenceDiagramDescriptionEndsOrderingPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getSequenceDiagramDescription_EndsOrdering();
    }
    ...
    protected String getPropertyDescription() {
        return "An interpreted expression used to compute the semantic (chronological) ordering of events on the diagram. See below for the details.";
    }
