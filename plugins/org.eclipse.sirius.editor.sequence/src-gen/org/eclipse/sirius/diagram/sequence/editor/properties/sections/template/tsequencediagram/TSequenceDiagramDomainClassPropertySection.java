 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.sequence.editor.properties.sections.template.tsequencediagram;
...
/**
 * A section for the domainClass property of a TSequenceDiagram object.
 */
public class TSequenceDiagramDomainClassPropertySection extends AbstractTextPropertySection {
    ...
    public EAttribute getFeature() {
        return TemplatePackage.eINSTANCE.getTSequenceDiagram_DomainClass();
    }
    ...
    protected String getPropertyDescription() {
        return "The type name of the semantic elements represented by the lifelines.";
    }
