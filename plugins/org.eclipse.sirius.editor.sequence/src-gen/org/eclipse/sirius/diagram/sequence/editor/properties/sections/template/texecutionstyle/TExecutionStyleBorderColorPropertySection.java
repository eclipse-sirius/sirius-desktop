...
/**
 * A section for the borderColor property of a TExecutionStyle object.
 */
public class TExecutionStyleBorderColorPropertySection extends AbstractComboPropertySection {
    /**
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        combo.setToolTipText("The color of the border.");
        ...
        help.setToolTipText("The color of the border.");
