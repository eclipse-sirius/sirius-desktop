 ...
 */
public class TSourceTargetMessageMappingTargetFinderExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getPropertyDescription() {
        return "An interpreted expression returning the edge target starting from the domain element.";
    }
