 ...
 */
public class TMessageStyleLabelExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return TemplatePackage.eINSTANCE.getTMessageStyle_LabelExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "An Interpreted expression computing the label of the message.";
    }
