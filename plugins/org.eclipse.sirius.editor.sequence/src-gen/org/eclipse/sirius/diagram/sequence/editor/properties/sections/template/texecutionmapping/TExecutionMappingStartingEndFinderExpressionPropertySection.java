 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.sequence.editor.properties.sections.template.texecutionmapping;
 ...
 * object.
 */
public class TExecutionMappingStartingEndFinderExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return TemplatePackage.eINSTANCE.getTExecutionMapping_StartingEndFinderExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "Interpreted expressions which are evaluated in the context of the semantic element of the execution and which should return the semantic element representing the start of the execution.";
    }
