...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Element Double Click Variable</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.impl.ElementDoubleClickVariableImpl#getSubVariables <em>Sub
 * Variables</em>}</li>
 * </ul>
 *
 * @generated
...
public class ElementDoubleClickVariableImpl extends AbstractVariableImpl implements ElementDoubleClickVariable {
    ...
    public EList<SubVariable> getSubVariables() {
        if (subVariables == null) {
            subVariables = new EObjectContainmentEList.Resolving<>(SubVariable.class, this, ToolPackage.ELEMENT_DOUBLE_CLICK_VARIABLE__SUB_VARIABLES);
        }
        return subVariables;
    }
