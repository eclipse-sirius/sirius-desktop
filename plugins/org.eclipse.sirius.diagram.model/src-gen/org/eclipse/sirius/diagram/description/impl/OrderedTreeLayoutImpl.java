...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Ordered Tree Layout</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.description.impl.OrderedTreeLayoutImpl#getChildrenExpression <em>Children
 * Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.description.impl.OrderedTreeLayoutImpl#getNodeMapping <em>Node
 * Mapping</em>}</li>
 * </ul>
 *
 * @generated
...
public class OrderedTreeLayoutImpl extends DocumentedElementImpl implements OrderedTreeLayout {
    ...
    public EList<AbstractNodeMapping> getNodeMapping() {
        if (nodeMapping == null) {
            nodeMapping = new EObjectResolvingEList<>(AbstractNodeMapping.class, this, DescriptionPackage.ORDERED_TREE_LAYOUT__NODE_MAPPING);
        }
        return nodeMapping;
    }
