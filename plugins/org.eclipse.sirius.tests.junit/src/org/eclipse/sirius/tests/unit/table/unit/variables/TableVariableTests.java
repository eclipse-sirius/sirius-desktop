...
public class TableVariableTests extends SiriusTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        genericSetUp(TEMPORARY_PROJECT_NAME + '/' + FILENAMES.get(0), 
                "/org.eclipse.sirius.tests.junit/data/table/unit/variables/TableVariable.odesign", 
    ...
    public void testAddLines() {
        assertTableContent(new String[][] {
            { /*Columns*/ "Path", "name", "visibility", "isAbstract", "isLeaf" }, 
            { "A", null, null, null, null, null },
            { "AbstractClass1", "MyModel", "AbstractClass1", "public", "false", "false" },
            { "AbstractClass2", "MyModel", "AbstractClass2", "public", "false", "false" },
            { "C", null, null, null, null, null },
            { "Class1", "MyModel", "Class1", "public", "false", "false" },
            { "Class2", "MyModel", "Class2", "public", "false", "false" },
            { "Class3", "MyModel", "Class3", "protected", "false", "false" },
            { "Class4", "MyModel", "Class4", "public", "false", "false" }
        });
        
        org.eclipse.uml2.uml.Class newEClass = UMLFactory.eINSTANCE.createClass();
        newEClass.setName("Behavior");
        ...
        assertTableContent(new String[][] {
            ...
            { "Behavior", "MyModel", "Behavior", "public", "false", "false" },
            { "C", null, null, null, null, null },
            { "Class1", "MyModel", "Class1", "public", "false", "false" },
            { "Class2", "MyModel", "Class2", "public", "false", "false" },
            { "Class3", "MyModel", "Class3", "protected", "false", "false" },
