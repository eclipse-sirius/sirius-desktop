...
/**
 * <pre>
 * This class tests if active (or unactive) layers are always active (or unactive) after a migration.
 * File (containing Diagram) : /data/unit/migration/TestCampaign_08/TestCampaign_08.aird
 * 
 * Aird details (the number is the name of the diagram) :
 * 1 : test if an active layer is always active after a migration
 * 2 : test if an unactive layer is always active after a migration
 * </pre>
 * 
 * @author MVenisse
 */
@RunWith(value = Parameterized.class)
public class DiagramMigrationTestCampaign08 extends AbstractMigrationTestCase {

    private static final String GENERAL_TEST_CASE_PATH = "/data/unit/migration/do_not_migrate/campaign/TestCampaign_08";

    private static final String SESSION_RESOURCE_FILENAME = "TestCampaign_08.aird";

    private static final String SEMANTIC_RESOURCE_FILENAME = "TestCampaign_08.migrationmodeler";
    ...
    public DiagramMigrationTestCampaign08(int diagramID) throws Exception {
