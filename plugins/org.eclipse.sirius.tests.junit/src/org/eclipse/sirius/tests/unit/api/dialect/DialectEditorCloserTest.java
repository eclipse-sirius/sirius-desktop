...
public class DialectEditorCloserTest extends SiriusTestCase {
    ...
    public void testDialectEditorCloserOnDViewAdditionUndo() {
        final DAnalysis dAnalysis = new AirDResouceQuery((AirdResource) session.getSessionResource()).getDAnalysis().get();
        ...
        final DView dView = ViewpointFactory.eINSTANCE.createDView();
