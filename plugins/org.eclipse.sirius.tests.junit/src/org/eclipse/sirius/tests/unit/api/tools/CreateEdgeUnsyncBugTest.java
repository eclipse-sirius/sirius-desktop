...
public class CreateEdgeUnsyncBugTest extends SiriusDiagramTestCase {
    ...
    private static final String PATH = "/" + SiriusTestsPlugin.PLUGIN_ID + "/data/unit/tool/bugEdge/";

    private static final String SEMANTIC_MODEL_PATH = PATH + "My.ecore";

    private static final String REPRESENTATION_MODEL_PATH = PATH + "representations.aird";

    private static final String MODELER_PATH = PATH + "project.odesign";

    private static final String VIEWPOINT_NAME = "EdgeTest";
    ...
    private void initDiagram(String representationDescName, String representationName) {
        diagram = (DDiagram) getRepresentations(representationDescName).stream().filter(rep -> representationName.equals(rep.getName())).findFirst()
    ...
    /**
     * test that the edge creation tool create only the expected edge (simple case)
     */
    @Test
    public void testEdgeCreationSimpleCase() {
        changeSiriusPreference(SiriusPreferencesKeys.PREF_AUTO_REFRESH.name(), autoRefresh);

        initDiagram("DiagEdgeUnsync", "new DiagEdgeUnsync");
    ...
    /**
     * test that the edge creation tool create only the expected edge (complex case with many mapping on the same
     * object)
     */
    @Test
    public void testEdgeCreationComplexCase() throws Exception {
        ...
        initDiagram("DiagEdgeDepEdge", "new DiagEdgeDepEdge");
