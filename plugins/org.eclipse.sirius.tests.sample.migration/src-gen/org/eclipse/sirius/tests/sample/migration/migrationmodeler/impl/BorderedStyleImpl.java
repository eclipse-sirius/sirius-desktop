...
public class BorderedStyleImpl extends EObjectImpl implements BorderedStyle {
    ...
    public void setBorderColor(Color newBorderColor) {
        if (newBorderColor != borderColor) {
            ...
            if (borderColor != null)
                msgs = ((InternalEObject) borderColor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MigrationmodelerPackage.BORDERED_STYLE__BORDER_COLOR, null, msgs);
            if (newBorderColor != null)
                msgs = ((InternalEObject) newBorderColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MigrationmodelerPackage.BORDERED_STYLE__BORDER_COLOR, null, msgs);
