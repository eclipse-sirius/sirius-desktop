...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.diagram.sequence.description.tool.GateCreationTool}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class GateCreationToolItemProvider extends NodeCreationDescriptionItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public GateCreationToolItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
     * This returns GateCreationTool.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/GateCreationTool")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        String label = ((GateCreationTool) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_GateCreationTool_type") : //$NON-NLS-1$
                getString("_UI_GateCreationTool_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(GateCreationTool.class)) {
