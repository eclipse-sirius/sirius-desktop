 ...
 * {@link org.eclipse.sirius.diagram.sequence.description.tool.ExecutionCreationTool} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class ExecutionCreationToolItemProvider extends NodeCreationDescriptionItemProvider {
    ...
    /**
     * This returns ExecutionCreationTool.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ExecutionCreationTool")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ExecutionCreationTool_type") : getString("_UI_ExecutionCreationTool_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
