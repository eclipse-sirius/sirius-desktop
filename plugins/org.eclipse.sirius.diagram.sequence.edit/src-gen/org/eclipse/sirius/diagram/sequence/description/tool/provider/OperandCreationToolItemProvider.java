 ...
 * {@link org.eclipse.sirius.diagram.sequence.description.tool.OperandCreationTool} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 *
 * @generated
 */
public class OperandCreationToolItemProvider extends ContainerCreationDescriptionItemProvider {
    ...
    /**
     * This returns OperandCreationTool.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/OperandCreationTool")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_OperandCreationTool_type") : getString("_UI_OperandCreationTool_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
