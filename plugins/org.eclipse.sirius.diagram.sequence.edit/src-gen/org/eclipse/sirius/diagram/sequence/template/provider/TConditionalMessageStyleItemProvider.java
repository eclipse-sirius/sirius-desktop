...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.diagram.sequence.template.TConditionalMessageStyle}
...
public class TConditionalMessageStyleItemProvider extends TTransformerItemProvider {
    ...
    protected void addPredicateExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_TConditionalMessageStyle_predicateExpression_feature"), //$NON-NLS-1$
                getString("_UI_PropertyDescriptor_description", "_UI_TConditionalMessageStyle_predicateExpression_feature", "_UI_TConditionalMessageStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    /**
     * This returns TConditionalMessageStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/TConditionalMessageStyle")); //$NON-NLS-1$
    }
