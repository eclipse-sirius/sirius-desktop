...
public class DEdgeBeginNameEditPart extends AbstractDEdgeNameEditPart {
     ...
     */
    static {
        registerSnapBackPosition(SiriusVisualIDRegistry.getType(org.eclipse.sirius.diagram.internal.edit.parts.DEdgeBeginNameEditPart.VISUAL_ID), new Point(0, 10));
    }
