...
/**
 * 
 * ExtensionContributionFactory responsible for "Past Layout" tabbar item
 * creation.
 * 
 * @author fbarbin
 */
public class PasteExtensionContributionFactory extends SiriusTabbarExtensionContributionFactory {

    @Override
    public void createContributionItems(IServiceLocator serviceLocator, IContributionRoot additions) {

        super.createContributionItems(serviceLocator, additions);
        PasteLayoutAction pasteLayoutAction = new PasteLayoutAction(getPage(), getPart());
