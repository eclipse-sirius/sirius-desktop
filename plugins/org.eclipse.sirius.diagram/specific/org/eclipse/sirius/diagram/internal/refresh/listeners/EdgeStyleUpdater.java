...
public class EdgeStyleUpdater extends ResourceSetListenerImpl {
     ...
     * GMF features.
     */
    private static final NotificationFilter LISTENED_FEATURES = NotificationFilter.NOT_TOUCH.and(NotificationFilter.createFeatureFilter(SiriusPackage.eINSTANCE.getDEdge_OwnedStyle()).or(
            NotificationFilter.createFeatureFilter(SiriusPackage.eINSTANCE.getEdgeStyle_RoutingStyle())));
    ...
    public Command transactionAboutToCommit(final ResourceSetChangeEvent event) throws RollbackException {
        ...
        for (Notification notification : event.getNotifications()) {
            ...
            else if (notification.getNotifier() instanceof EdgeStyle && SiriusPackage.eINSTANCE.getEdgeStyle_RoutingStyle().equals(notification.getFeature())) {
