...
public abstract class AbstractDDiagramEditPart extends DiagramEditPart implements IDDiagramEditPart {
    ...
    protected void handleNotificationEvent(final Notification notification) {
         ...
         */
        if (SiriusPackage.eINSTANCE.getDDiagram_ActivatedFilters().equals(notification.getFeature())) {
            refresh();
     ...
     * @param notification
     *            A notification of feature
     *            SiriusPackage.eINSTANCE.getDDiagram_ActivatedFilters()
     */
    ...
    public Command getCommand(final Request request) {
        ...
        return CommonEditPartOperation.appendSelectionCommand(originalCommand, this);
    }
