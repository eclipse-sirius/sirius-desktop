...
public class ImageSelectorService {
    ...
    protected void updateWorkspacePath(BasicLabelStyle basicLabelStyle, String workspacePath) {
        ...
        if (domain != null) {
            if (basicLabelStyle instanceof WorkspaceImage) {
                updateWorkspacePathCmd = SetCommand.create(domain, basicLabelStyle, SiriusPackage.Literals.WORKSPACE_IMAGE__WORKSPACE_PATH, workspacePath);
                if (!basicLabelStyle.getCustomFeatures().contains(SiriusPackage.Literals.WORKSPACE_IMAGE__WORKSPACE_PATH.getName())) {
                    updateWorkspacePathCmd = updateWorkspacePathCmd.chain(AddCommand.create(domain, basicLabelStyle, SiriusPackage.Literals.CUSTOMIZABLE__CUSTOM_FEATURES,
                            SiriusPackage.Literals.WORKSPACE_IMAGE__WORKSPACE_PATH.getName()));
                }
            } else {
    ...
    private Object getFeature(BasicLabelStyle basicLabelStyle) {
        ...
        if (container instanceof DNode) {
            feature = SiriusPackage.Literals.DNODE__OWNED_STYLE;
        } else if (container instanceof DDiagramElementContainer) {
            feature = SiriusPackage.Literals.DDIAGRAM_ELEMENT_CONTAINER__OWNED_STYLE;
        }
        return feature;
    }
    ...
    private Style createAndAffectWorkspaceImageCustomized(final DDiagramElement dde, final WorkspaceImageDescription wid) {
        ...
        newStyle.getCustomFeatures().add(SiriusPackage.Literals.WORKSPACE_IMAGE__WORKSPACE_PATH.getName());
        return newStyle;
    }
