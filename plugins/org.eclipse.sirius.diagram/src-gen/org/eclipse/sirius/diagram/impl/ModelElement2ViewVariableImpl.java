 ...
 * @generated
 */
public class ModelElement2ViewVariableImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<EObject, EMap<EObject, EMap<EObject, StyleDescription>>> {
    /**
