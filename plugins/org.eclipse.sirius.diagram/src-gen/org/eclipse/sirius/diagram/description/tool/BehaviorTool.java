...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Behavior Tool</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> A tool that can be launched by the user. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.BehaviorTool#getDomainClass <em>Domain Class</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.BehaviorTool#getInitialOperation <em>Initial Operation</em>}
 * </li>
 * </ul>
 *
...
public interface BehaviorTool extends AbstractToolDescription {
    /**
     * Returns the value of the '<em><b>Domain Class</b></em>' attribute. The default value is <code>"EObject"</code>.
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> The type of elements on which we want to
     * appy the tool. <!-- end-model-doc -->
     *
     * @return the value of the '<em>Domain Class</em>' attribute.
     * @see #setDomainClass(String)
     * @see org.eclipse.sirius.diagram.description.tool.ToolPackage#getBehaviorTool_DomainClass()
     * @model default="EObject" dataType="org.eclipse.sirius.viewpoint.description.TypeName" required="true"
     * @generated
     */
    String getDomainClass();

    /**
     * Sets the value of the '{@link org.eclipse.sirius.diagram.description.tool.BehaviorTool#getDomainClass
