...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Node Creation Description</b></em>'. <!--
 * end-user-doc -->
 *
 * <!-- begin-model-doc --> Tool to create a ViewNode. It appears in the palette. <!-- end-model-doc -->
 *
 * <p>
 * The following features are supported:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.NodeCreationDescription#getNodeMappings <em>Node Mappings</em>
 * }</li>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.NodeCreationDescription#getVariable <em>Variable</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.NodeCreationDescription#getViewVariable <em>View Variable</em>
 * }</li>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.NodeCreationDescription#getInitialOperation
 * <em>Initial Operation</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.NodeCreationDescription#getIconPath <em>Icon Path</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.NodeCreationDescription#getExtraMappings
...
public interface NodeCreationDescription extends MappingBasedToolDescription {
    /**
     * Returns the value of the '<em><b>Node Mappings</b></em>' reference list. The list contents are of type
     * {@link org.eclipse.sirius.diagram.description.NodeMapping}. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> Node mappings used by this tool. <!-- end-model-doc -->
     *
     ...
     *        "http://www.eclipse.org/emf/2002/GenModel documentedName='container'" annotation=
     ...
     * end-user-doc --> <!-- begin-model-doc --> The variable containerView that represents the clickedView (instance of
     * ViewPoint or ViewPointElement). <!-- end-model-doc -->
     *
     ...
     * @model containment="true" resolveProxies="true" required="true" annotation=
     *        "http://www.eclipse.org/emf/2002/GenModel documentedName='containerView'" annotation=
