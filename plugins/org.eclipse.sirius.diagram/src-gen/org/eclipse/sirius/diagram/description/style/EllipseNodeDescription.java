...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Ellipse Node Description</b></em>'. <!--
 * end-user-doc -->
 *
...
public interface EllipseNodeDescription extends NodeStyleDescription {
     ...
     * begin-model-doc --> The color of the ellipse. <!-- end-model-doc -->
     *
    ...
    /**
     * Returns the value of the ' <em><b>Horizontal Diameter Computation Expression</b></em>' attribute. The default
     * value is <code>"0"</code>. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> An expression
     * to compute the horizontal diameter of the ellipse. (Semimajor axis) <!-- end-model-doc -->
     *
     * @return the value of the ' <em>Horizontal Diameter Computation Expression</em>' attribute.
    ...
    /**
     * Returns the value of the ' <em><b>Vertical Diameter Computation Expression</b></em>' attribute. The default value
     * is <code>"0"</code>. <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> An expression to
     * compute the vertical diameter of the ellipse. (Semiminor axis) <!-- end-model-doc -->
     *
     * @return the value of the ' <em>Vertical Diameter Computation Expression</em>' attribute.
