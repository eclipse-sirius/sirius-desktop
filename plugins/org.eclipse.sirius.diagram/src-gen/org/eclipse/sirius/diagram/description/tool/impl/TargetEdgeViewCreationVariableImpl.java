...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Target Edge View Creation Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.impl.TargetEdgeViewCreationVariableImpl#getSubVariables
...
public class TargetEdgeViewCreationVariableImpl extends AbstractVariableImpl implements TargetEdgeViewCreationVariable {
    ...
    public EList<SubVariable> getSubVariables() {
        if (subVariables == null) {
            subVariables = new EObjectContainmentEList.Resolving<>(SubVariable.class, this, ToolPackage.TARGET_EDGE_VIEW_CREATION_VARIABLE__SUB_VARIABLES);
        }
        return subVariables;
    }
