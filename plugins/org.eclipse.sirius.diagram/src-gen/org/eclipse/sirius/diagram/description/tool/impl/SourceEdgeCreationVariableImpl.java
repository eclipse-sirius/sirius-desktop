...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Source Edge Creation Variable</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.impl.SourceEdgeCreationVariableImpl#getSubVariables <em>Sub
 * Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SourceEdgeCreationVariableImpl extends AbstractVariableImpl implements SourceEdgeCreationVariable {
    /**
     ...
     * @generated
     */
    protected SourceEdgeCreationVariableImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.SOURCE_EDGE_CREATION_VARIABLE;
    }
    ...
    public EList<SubVariable> getSubVariables() {
        if (subVariables == null) {
            subVariables = new EObjectContainmentEList.Resolving<SubVariable>(SubVariable.class, this, ToolPackage.SOURCE_EDGE_CREATION_VARIABLE__SUB_VARIABLES);
        }
        return subVariables;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case ToolPackage.SOURCE_EDGE_CREATION_VARIABLE__SUB_VARIABLES:
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == VariableContainer.class) {
            ...
            case org.eclipse.sirius.viewpoint.description.tool.ToolPackage.VARIABLE_CONTAINER__SUB_VARIABLES:
                return ToolPackage.SOURCE_EDGE_CREATION_VARIABLE__SUB_VARIABLES;
            default:
                return -1;
            }
        }
...
} // SourceEdgeCreationVariableImpl
