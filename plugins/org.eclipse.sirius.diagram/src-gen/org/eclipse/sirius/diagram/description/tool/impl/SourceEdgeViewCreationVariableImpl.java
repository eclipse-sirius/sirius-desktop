...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Source Edge View Creation Variable</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.description.tool.impl.SourceEdgeViewCreationVariableImpl#getSubVariables
...
public class SourceEdgeViewCreationVariableImpl extends AbstractVariableImpl implements SourceEdgeViewCreationVariable {
     ...
     * @generated
     */
    protected SourceEdgeViewCreationVariableImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ToolPackage.Literals.SOURCE_EDGE_VIEW_CREATION_VARIABLE;
    }
    ...
    public EList<SubVariable> getSubVariables() {
        if (subVariables == null) {
            subVariables = new EObjectContainmentEList.Resolving<SubVariable>(SubVariable.class, this, ToolPackage.SOURCE_EDGE_VIEW_CREATION_VARIABLE__SUB_VARIABLES);
        }
        return subVariables;
    }
