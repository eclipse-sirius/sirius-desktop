...
/**
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Gauge Section</b></em>'. <!-- end-user-doc -->
 *
 * <!-- begin-model-doc --> The gauge section represents one gauge of a GaugeCompositeStyle. <!-- end-model-doc -->
 *
 * <p>
 ...
 * <li>{@link org.eclipse.sirius.diagram.GaugeSection#getBackgroundColor <em>Background Color</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.GaugeSection#getForegroundColor <em>Foreground Color</em>}</li>
 * </ul>
 *
...
public interface GaugeSection extends Customizable {
    /**
     * Returns the value of the '<em><b>Min</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The min value of the gauge. <!-- end-model-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.diagram.GaugeSection#getMin <em>Min</em>}' attribute. <!--
    ...
    /**
     * Returns the value of the '<em><b>Max</b></em>' attribute. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc --> The max value of the gauge. <!-- end-model-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.diagram.GaugeSection#getMax <em>Max</em>}' attribute. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     ...
     * begin-model-doc --> The current value. <!-- end-model-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.diagram.GaugeSection#getValue <em>Value</em>}' attribute. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     ...
     * begin-model-doc --> The label of the gauge. <!-- end-model-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.diagram.GaugeSection#getLabel <em>Label</em>}' attribute. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.diagram.GaugeSection#getBackgroundColor
    ...
    /**
     * Returns the value of the '<em><b>Foreground Color</b></em>' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc --> <!-- begin-model-doc --> The foreground color. <!-- end-model-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.diagram.GaugeSection#getForegroundColor
