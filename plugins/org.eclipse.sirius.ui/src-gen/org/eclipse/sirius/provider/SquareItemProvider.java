...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.Square}
...
public class SquareItemProvider extends NodeStyleItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addWidthPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Square_width_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Square_width_feature", "_UI_Square_type"), SiriusPackage.Literals.SQUARE__WIDTH, true, false, false,
    ...
    protected void addHeightPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_Square_height_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_Square_height_feature", "_UI_Square_type"), SiriusPackage.Literals.SQUARE__HEIGHT, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_GeneralPropertyCategory"), null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SiriusPackage.Literals.SQUARE__COLOR);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.SQUARE__COLOR, SiriusFactory.eINSTANCE.createRGBValues()));
    }
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == SiriusPackage.Literals.BASIC_LABEL_STYLE__LABEL_COLOR || childFeature == SiriusPackage.Literals.BORDERED_STYLE__BORDER_COLOR
                || childFeature == SiriusPackage.Literals.SQUARE__COLOR;
