 ...
 * {@link org.eclipse.sirius.DDiagram} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class DDiagramItemProvider extends DRepresentationItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
    ...
    protected void addDiagramElementsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__DIAGRAM_ELEMENTS, false, false, false, null, null, null));
    }
    ...
    protected void addDescriptionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__DESCRIPTION, true, false, true, null, null, null));
    }
    ...
    protected void addInfoPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_DDiagram_info_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_DDiagram_info_feature", "_UI_DDiagram_type"), SiriusPackage.Literals.DDIAGRAM__INFO, true, false, false,
    ...
    protected void addEdgesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_DDiagram_edges_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_DDiagram_edges_feature", "_UI_DDiagram_type"), SiriusPackage.Literals.DDIAGRAM__EDGES, false, false, false, null, null, null));
    }
    ...
    protected void addNodesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_DDiagram_nodes_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_DDiagram_nodes_feature", "_UI_DDiagram_type"), SiriusPackage.Literals.DDIAGRAM__NODES, false, false, false, null, null, null));
    }
    ...
    protected void addNodeListElementsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__NODE_LIST_ELEMENTS, false, false, false, null, null, null));
    }
    ...
    protected void addContainersPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__CONTAINERS, false, false, false, null, null, null));
    }
    ...
    protected void addCurrentConcernPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__CURRENT_CONCERN, true, false, true, null, null, null));
    }
    ...
    protected void addActivatedFiltersPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__ACTIVATED_FILTERS, true, false, true, null, null, null));
    }
    ...
    protected void addAllFiltersPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__ALL_FILTERS, false, false, false, null, null, null));
    }
    ...
    protected void addActivatedRulesPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__ACTIVATED_RULES, true, false, true, null, null, null));
    }
    ...
    protected void addActivateBehaviorsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__ACTIVATE_BEHAVIORS, true, false, true, null, null, null));
    }
    ...
    protected void addActivatedLayersPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__ACTIVATED_LAYERS, true, false, true, null, null, null));
    }
    ...
    protected void addSynchronizedPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__SYNCHRONIZED, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addHiddenElementsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__HIDDEN_ELEMENTS, true, false, true, null, null, null));
    }
    ...
    protected void addIsInLayoutingModePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__IS_IN_LAYOUTING_MODE, true, false, false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
    }
    ...
    protected void addHeaderHeightPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DDIAGRAM__HEADER_HEIGHT, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SiriusPackage.Literals.DDIAGRAM__OWNED_DIAGRAM_ELEMENTS);
            childrenFeatures.add(SiriusPackage.Literals.DDIAGRAM__SUB_DIAGRAMS);
            childrenFeatures.add(SiriusPackage.Literals.DDIAGRAM__FILTER_VARIABLE_HISTORY);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DDIAGRAM__OWNED_DIAGRAM_ELEMENTS, SiriusFactory.eINSTANCE.createDNode()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DDIAGRAM__OWNED_DIAGRAM_ELEMENTS, SiriusFactory.eINSTANCE.createDNodeContainer()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DDIAGRAM__OWNED_DIAGRAM_ELEMENTS, SiriusFactory.eINSTANCE.createDNodeList()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DDIAGRAM__OWNED_DIAGRAM_ELEMENTS, SiriusFactory.eINSTANCE.createDNodeListElement()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DDIAGRAM__OWNED_DIAGRAM_ELEMENTS, SiriusFactory.eINSTANCE.createDEdge()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DDIAGRAM__SUB_DIAGRAMS, SiriusFactory.eINSTANCE.createDDiagram()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DDIAGRAM__SUB_DIAGRAMS, SiriusFactory.eINSTANCE.createDSemanticDiagram()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DDIAGRAM__FILTER_VARIABLE_HISTORY, SiriusFactory.eINSTANCE.createFilterVariableHistory()));
    }
