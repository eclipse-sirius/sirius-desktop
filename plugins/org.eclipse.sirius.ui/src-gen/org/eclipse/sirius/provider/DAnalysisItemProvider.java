 ...
 * {@link org.eclipse.sirius.DAnalysis} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class DAnalysisItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addSelectedViewsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DANALYSIS__SELECTED_VIEWS, true, false, true, null, null, null));
    }
    ...
    protected void addVersionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DANALYSIS__VERSION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addReferencedAnalysisPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DANALYSIS__REFERENCED_ANALYSIS, true, false, true, null, null, null));
    }
    ...
    protected void addModelsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_DAnalysis_models_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_DAnalysis_models_feature", "_UI_DAnalysis_type"), SiriusPackage.Literals.DANALYSIS__MODELS, true, false, true, null,
                        null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SiriusPackage.Literals.DANALYSIS__EANNOTATIONS);
            childrenFeatures.add(SiriusPackage.Literals.DANALYSIS__OWNED_VIEWS);
            childrenFeatures.add(SiriusPackage.Literals.DANALYSIS__OWNED_FEATURE_EXTENSIONS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DANALYSIS__EANNOTATIONS, DescriptionFactory.eINSTANCE.createDAnnotationEntry()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DANALYSIS__OWNED_VIEWS, SiriusFactory.eINSTANCE.createDView()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DANALYSIS__OWNED_VIEWS, SiriusFactory.eINSTANCE.createDRepresentationContainer()));
    }
