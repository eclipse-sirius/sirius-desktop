 ...
 * {@link org.eclipse.sirius.DNodeListElement} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DNodeListElementItemProvider extends DDiagramElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
    ...
    protected void addOriginalStylePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DNODE_LIST_ELEMENT__ORIGINAL_STYLE, true, false, true, null, null, null));
    }
    ...
    protected void addActualMappingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DNODE_LIST_ELEMENT__ACTUAL_MAPPING, true, false, true, null, null, null));
    }
    ...
    protected void addCandidatesMappingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                SiriusPackage.Literals.DNODE_LIST_ELEMENT__CANDIDATES_MAPPING, true, false, true, null, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createDot()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createSquare()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createEllipse()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createLozenge()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createBundledImage()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createWorkspaceImage()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createCustomStyle()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createGaugeCompositeStyle()));

        newChildDescriptors.add(createChildParameter(SiriusPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, SiriusFactory.eINSTANCE.createNote()));
    }
