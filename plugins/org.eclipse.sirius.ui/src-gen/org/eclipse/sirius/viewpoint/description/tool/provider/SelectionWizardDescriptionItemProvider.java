 ...
 * @generated
 */
public class SelectionWizardDescriptionItemProvider extends AbstractToolDescriptionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider,
    ...
    public String getText(Object object) {
        String label = ((SelectionWizardDescription) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_SelectionWizardDescription_type") : getString("_UI_SelectionWizardDescription_type") + " " + label;
    }
