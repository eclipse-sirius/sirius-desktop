 ...
 * @generated
 */
public class ContainerDropDescriptionItemProvider extends MappingBasedToolDescriptionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider,
    ...
    public String getText(Object object) {
        String label = ((ContainerDropDescription) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_ContainerDropDescription_type") : getString("_UI_ContainerDropDescription_type") + " " + label;
    }
