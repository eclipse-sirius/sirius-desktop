...
public class GenericDecorationDescriptionItemProvider extends DecorationDescriptionItemProvider {
     ...
     * @generated
     */
    public GenericDecorationDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/GenericDecorationDescription")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        String label = ((GenericDecorationDescription) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_GenericDecorationDescription_type") : //$NON-NLS-1$
                getString("_UI_GenericDecorationDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
