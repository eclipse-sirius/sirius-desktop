 ...
 * @generated
 */
public class ContainerCreationDescriptionItemProvider extends MappingBasedToolDescriptionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider,
    ...
    public String getText(Object object) {
        String label = ((ContainerCreationDescription) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_ContainerCreationDescription_type") : getString("_UI_ContainerCreationDescription_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ToolPackage.Literals.CONTAINER_CREATION_DESCRIPTION__VIEW_VARIABLE, ToolFactory.eINSTANCE.createContainerViewVariable()));

        newChildDescriptors.add(createChildParameter(ToolPackage.Literals.CONTAINER_CREATION_DESCRIPTION__INITIAL_OPERATION, ToolFactory.eINSTANCE.createInitialNodeCreationOperation()));
    }
