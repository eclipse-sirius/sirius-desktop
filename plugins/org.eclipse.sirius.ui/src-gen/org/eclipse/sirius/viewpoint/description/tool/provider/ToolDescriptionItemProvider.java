...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.viewpoint.description.tool.ToolDescription} object.
...
public class ToolDescriptionItemProvider extends MappingBasedToolDescriptionItemProvider {
    ...
    protected void addIconPathPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ToolDescription_iconPath_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_ToolDescription_iconPath_feature", "_UI_ToolDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        ToolPackage.Literals.TOOL_DESCRIPTION__ICON_PATH, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_GeneralPropertyCategory"), //$NON-NLS-1$
                        null));
    }
    ...
    /**
     * This returns ToolDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/ToolDescription")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return StringUtil.isEmpty(label) ? getString("_UI_ToolDescription_type") : getString("_UI_ToolDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }
