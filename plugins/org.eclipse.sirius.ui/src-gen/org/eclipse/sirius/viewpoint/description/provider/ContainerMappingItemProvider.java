 ...
 * {@link org.eclipse.sirius.viewpoint.description.ContainerMapping} object.
...
public class ContainerMappingItemProvider extends AbstractNodeMappingItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
    ...
    protected EStructuralFeature getChildFeature(Object object, Object child) {
        ...
        if (child instanceof NodeMapping) {
            return DescriptionPackage.eINSTANCE.getContainerMapping_SubNodeMappings();
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.CONTAINER_MAPPING__STYLE, StyleFactory.eINSTANCE.createFlatContainerStyleDescription()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.CONTAINER_MAPPING__STYLE, StyleFactory.eINSTANCE.createShapeContainerStyleDescription()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.CONTAINER_MAPPING__STYLE, StyleFactory.eINSTANCE.createWorkspaceImageDescription()));

        newChildDescriptors.add(createChildParameter(DescriptionPackage.Literals.CONTAINER_MAPPING__CONDITIONNAL_STYLES, DescriptionFactory.eINSTANCE.createConditionalContainerStyleDescription()));
    }
