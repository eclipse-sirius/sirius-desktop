 ...
 * {@link org.eclipse.sirius.viewpoint.DNodeListElement} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DNodeListElementItemProvider extends DDiagramElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
        IItemPropertySource {
    /**
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    protected void addOriginalStylePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                ViewpointPackage.Literals.DNODE_LIST_ELEMENT__ORIGINAL_STYLE, true, false, true, null, null, null));
    }
    ...
    protected void addActualMappingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                ViewpointPackage.Literals.DNODE_LIST_ELEMENT__ACTUAL_MAPPING, true, false, true, null, null, null));
    }
    ...
    protected void addCandidatesMappingPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                ViewpointPackage.Literals.DNODE_LIST_ELEMENT__CANDIDATES_MAPPING, true, false, true, null, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createDot()));

        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createSquare()));

        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createEllipse()));

        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createLozenge()));

        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createBundledImage()));

        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createWorkspaceImage()));

        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createCustomStyle()));

        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createGaugeCompositeStyle()));

        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.DNODE_LIST_ELEMENT__OWNED_STYLE, ViewpointFactory.eINSTANCE.createNote()));
    }
