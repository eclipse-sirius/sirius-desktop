 ...
 * {@link org.eclipse.sirius.viewpoint.GaugeCompositeStyle} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class GaugeCompositeStyleItemProvider extends NodeStyleItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
        IItemPropertySource {
    /**
    ...
    protected void addAlignmentPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                ...
                ViewpointPackage.Literals.GAUGE_COMPOSITE_STYLE__ALIGNMENT, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, getString("_UI_GeneralPropertyCategory"), null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ViewpointPackage.Literals.GAUGE_COMPOSITE_STYLE__SECTIONS);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        case ViewpointPackage.GAUGE_COMPOSITE_STYLE__ALIGNMENT:
            fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
            return;
        case ViewpointPackage.GAUGE_COMPOSITE_STYLE__SECTIONS:
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ViewpointPackage.Literals.GAUGE_COMPOSITE_STYLE__SECTIONS, ViewpointFactory.eINSTANCE.createGaugeSection()));
    }
