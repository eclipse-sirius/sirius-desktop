...
import org.eclipse.sirius.description.audit.util.AuditAdapterFactory;
...
public class AuditItemProviderAdapterFactory extends AuditAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
    ...
    public Adapter createTemplateInformationSectionAdapter() {
        if (templateInformationSectionItemProvider == null) {
            templateInformationSectionItemProvider = new TemplateInformationSectionItemProvider(this);
        }

        return templateInformationSectionItemProvider;
    }
