 ...
 * {@link org.eclipse.sirius.description.tool.ToolDescription} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ToolDescriptionItemProvider extends MappingBasedToolDescriptionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider,
    ...
    public String getText(Object object) {
        String label = ((ToolDescription) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_ToolDescription_type") : getString("_UI_ToolDescription_type") + " " + label;
    }
