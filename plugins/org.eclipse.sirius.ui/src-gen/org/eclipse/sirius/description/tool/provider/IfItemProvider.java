 ...
 * {@link org.eclipse.sirius.description.tool.If} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class IfItemProvider extends ContainerModelOperationItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
        IItemPropertySource {
    /**
    ...
    protected void addConditionExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_If_conditionExpression_feature"), getString("_UI_If_conditionExpression_description"), ToolPackage.Literals.IF__CONDITION_EXPRESSION, true, false, false,
