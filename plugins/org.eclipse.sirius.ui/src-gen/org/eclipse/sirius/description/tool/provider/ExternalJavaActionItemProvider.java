 ...
 * {@link org.eclipse.sirius.description.tool.ExternalJavaAction} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ExternalJavaActionItemProvider extends MenuItemDescriptionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider,
    ...
    public String getText(Object object) {
        String label = ((ExternalJavaAction) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_ExternalJavaAction_type") : getString("_UI_ExternalJavaAction_type") + " " + label;
    }
