...
public class CheckboxWidgetConditionalStyleItemProvider extends WidgetConditionalStyleItemProvider {
    ...
    public Object getStyledText(Object object) {
        ...
        if (label == null || label.length() == 0) {
            styledLabel.append(getString("_UI_CheckboxWidgetConditionalStyle_type"), StyledString.Style.QUALIFIER_STYLER); //$NON-NLS-1$
        } else {
            styledLabel.append(getString("_UI_CheckboxWidgetConditionalStyle_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return styledLabel;
    }
