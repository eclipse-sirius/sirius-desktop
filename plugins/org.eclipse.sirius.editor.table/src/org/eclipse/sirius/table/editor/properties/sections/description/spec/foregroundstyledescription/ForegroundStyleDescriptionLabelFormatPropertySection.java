 ...
 */
public class ForegroundStyleDescriptionLabelFormatPropertySection extends AbstractCheckBoxGroupPropertySection {
    ...
    protected boolean isEqual(List<?> newList) {
        ...
        List<String> value = ForegroundStyleDescriptionLabelFormatPropertySection.convertPropertiesToUI(((ForegroundStyleDescription) eObject).getLabelFormat());
