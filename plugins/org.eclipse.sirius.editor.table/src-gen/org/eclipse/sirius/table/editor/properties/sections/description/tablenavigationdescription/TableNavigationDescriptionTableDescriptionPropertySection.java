 ...
 *******************************************************************************/
package org.eclipse.sirius.table.editor.properties.sections.description.tablenavigationdescription;
...
/**
 * A section for the tableDescription property of a TableNavigationDescription object.
 */
public class TableNavigationDescriptionTableDescriptionPropertySection extends AbstractComboPropertySection {
    /**
     * @see org.eclipse.sirius.table.editor.properties.sections.AbstractComboPropertySection#getDefaultLabelText()
     */
    @Override
    protected String getDefaultLabelText() {
        return "TableDescription"; //$NON-NLS-1$
    }
