...
/**
 * A section for the allSubLines property of a LineMapping object.
 */
public class LineMappingAllSubLinesPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.table.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "AllSubLines"; //$NON-NLS-1$
    }
