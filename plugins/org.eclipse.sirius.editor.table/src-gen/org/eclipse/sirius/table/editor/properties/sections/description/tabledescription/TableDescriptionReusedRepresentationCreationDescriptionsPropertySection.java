...
/**
 * A section for the reusedRepresentationCreationDescriptions property of a
 * TableDescription object.
 */
public class TableDescriptionReusedRepresentationCreationDescriptionsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.table.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "ReusedRepresentationCreationDescriptions"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return DescriptionPackage.eINSTANCE.getTableDescription_ReusedRepresentationCreationDescriptions();
    }
