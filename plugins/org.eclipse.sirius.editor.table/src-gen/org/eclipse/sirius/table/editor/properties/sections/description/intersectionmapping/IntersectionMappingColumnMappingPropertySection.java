...
/**
 * A section for the columnMapping property of a IntersectionMapping object.
 */
public class IntersectionMappingColumnMappingPropertySection extends AbstractComboPropertySection {
    /**
     * @see org.eclipse.sirius.table.editor.properties.sections.AbstractComboPropertySection#getDefaultLabelText()
     */
    @Override
    protected String getDefaultLabelText() {
        return "ColumnMapping"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return DescriptionPackage.eINSTANCE.getIntersectionMapping_ColumnMapping();
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        combo.setToolTipText("Mapping concerned by this intersection");
