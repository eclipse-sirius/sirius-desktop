 ...
 *******************************************************************************/
package org.eclipse.sirius.table.editor.properties.sections.description.elementcolumnmapping;
...
/**
 * A section for the domainClass property of a ElementColumnMapping object.
 */
public class ElementColumnMappingDomainClassPropertySection extends AbstractTextPropertySection {
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getElementColumnMapping_DomainClass();
    }
    ...
    protected String getPropertyDescription() {
        return "Type of the element represented by the Column.";
    }
