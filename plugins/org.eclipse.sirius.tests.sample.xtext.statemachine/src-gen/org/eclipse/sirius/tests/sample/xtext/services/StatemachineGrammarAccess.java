...
*******************************************************************************/
package org.eclipse.sirius.tests.sample.xtext.services;
...
public class StatemachineGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StatemachineElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.tests.sample.xtext.Statemachine.Statemachine");
	...
	public class NamedElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.tests.sample.xtext.Statemachine.NamedElement");
		...
		private final RuleCall cStateParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		...
		//State
		public RuleCall getStateParserRuleCall_2() { return cStateParserRuleCall_2; }
	}
	public class EventElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.tests.sample.xtext.Statemachine.Event");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CommandElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.tests.sample.xtext.Statemachine.Command");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cNameAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cNameIDTerminalRuleCall_0_0 = (RuleCall)cNameAssignment_0.eContents().get(0);
		private final Assignment cDisplaynameAssignment_1 = (Assignment)cGroup.eContents().get(1);
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.tests.sample.xtext.Statemachine.State");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//State:
		//	'state' name=ID displayname=STRING? ('actions' '{' actions+=Command+ '}')?
		//	transitions+=Transition*
		//	'end';
		@Override public ParserRule getRule() { return rule; }
		
		//'state' name=ID displayname=STRING? ('actions' '{' actions+=Command+ '}')? transitions+=Transition* 'end'
		public Group getGroup() { return cGroup; }
	...
	public class TransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.sirius.tests.sample.xtext.Statemachine.Transition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.sirius.tests.sample.xtext.Statemachine".equals(grammar.getName())) {
				return grammar;
			}
