...
import org.eclipse.sirius.tests.sample.xtext.generator.StatemachineGenerator;
import org.eclipse.sirius.tests.sample.xtext.parser.antlr.StatemachineAntlrTokenFileProvider;
import org.eclipse.sirius.tests.sample.xtext.parser.antlr.StatemachineParser;
import org.eclipse.sirius.tests.sample.xtext.parser.antlr.internal.InternalStatemachineLexer;
import org.eclipse.sirius.tests.sample.xtext.scoping.StatemachineScopeProvider;
import org.eclipse.sirius.tests.sample.xtext.serializer.StatemachineSemanticSequencer;
import org.eclipse.sirius.tests.sample.xtext.serializer.StatemachineSyntacticSequencer;
import org.eclipse.sirius.tests.sample.xtext.services.StatemachineGrammarAccess;
import org.eclipse.sirius.tests.sample.xtext.validation.StatemachineValidator;
...
public abstract class AbstractStatemachineRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/sirius/tests/sample/xtext/Statemachine.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.sirius.tests.sample.xtext.Statemachine");
	}
