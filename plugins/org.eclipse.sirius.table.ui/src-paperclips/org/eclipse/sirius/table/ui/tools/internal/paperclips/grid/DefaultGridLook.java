...
public class DefaultGridLook implements GridLook {
    /**
     * Constant cell spacing value indicating that the borders of adjacent cells should overlap so the appear
     * continuous.
     */
    ...
    public int hashCode() {
        ...
        result = prime * result + ((footerBackgroundProvider == null) ? 0 : footerBackgroundProvider.hashCode());
        result = prime * result + footerGap;
        result = prime * result + ((headerBackgroundProvider == null) ? 0 : headerBackgroundProvider.hashCode());
    ...
    /**
     * Returns the border spacing, in points, between adjacent grid cells. Default is (x=BORDER_OVERLAP,
     * y=BORDER_OVERLAP).
     * 
    ...
    /**
     * Sets the border spacing, in points, between adjacent grid cells. A value of {@link #BORDER_OVERLAP} causes the
     * borders to overlap, making the border appear continuous throughout the grid. A value of 0 or more causes the cell
     * borders to be spaced that many points apart. 72 points = 1".
     * 
     * @param cellSpacing
    ...
    /**
     * Returns a rectangle whose public fields denote the left (x), top (y), right (width) and bottom (height) cell
     * padding, expressed in points. 72 points = 1" = 2.54cm.
     * 
    ...
    /**
     * Sets the cell padding to the given horizontal and vertical values. This is equivalent to calling
     * setCellPadding(horizontalPadding, verticalPadding, horizontalPadding, verticalPadding).
     * 
     * @param horizontalPadding
     *            the amount of padding to add to the left and right of each cell, in points.
    ...
    /**
     * Sets the header background color provider. Calls to this method override any previous calls to
     * setHeaderBackground(RGB). Setting this property to null restores the default background provider.
     * 
    ...
    public void setHeaderBackgroundProvider(CellBackgroundProvider headerBackgroundProvider) {
        this.headerBackgroundProvider = headerBackgroundProvider == null ? defaultHeaderBackgroundProvider : headerBackgroundProvider;
    }
    ...
    /**
     * Sets the vertical gap between the header and body cells. A value of {@link #BORDER_OVERLAP} causes the borders to
     * overlap, making the border appear continuous in the transition from the header cells to the body cells.
     * 
     * @param headerGap
     *            the new header gap.
     */
     ...
     * setBodyBackground(RGB). Setting this property to null restores the default background provider.
     * 
     * @param bodyBackgroundProvider
     *            the new background color provider.
     */
    public void setBodyBackgroundProvider(CellBackgroundProvider bodyBackgroundProvider) {
        this.bodyBackgroundProvider = bodyBackgroundProvider == null ? defaultBodyBackgroundProvider : bodyBackgroundProvider;
    }
    ...
    /**
     * Sets the vertical gap between the header and body cells. A value of {@link #BORDER_OVERLAP} causes the borders to
     * overlap, making the border appear continuous in the transition from the body cells to the footer cells.
     * 
     * @param footerGap
     */
    ...
    /**
     * Sets the footer background color provider. Calls to this method override any previous calls to
     * setFooterBackground(RGB). Setting this property to null restores the default background provider.
     * 
     * @param footerBackgroundProvider
     *            the new background color provider.
     */
    public void setFooterBackgroundProvider(CellBackgroundProvider footerBackgroundProvider) {
        this.footerBackgroundProvider = footerBackgroundProvider == null ? defaultFooterBackgroundProvider : footerBackgroundProvider;
    }
