 ...
 * {@link org.eclipse.sirius.table.metamodel.table.description.BackgroundConditionalStyle} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class BackgroundConditionalStyleItemProvider extends ItemProviderAdapter
    ...
    /**
     * This returns BackgroundConditionalStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/BackgroundConditionalStyle")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_BackgroundConditionalStyle_type") : //$NON-NLS-1$
                getString("_UI_BackgroundConditionalStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
