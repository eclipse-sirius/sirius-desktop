 ...
 * @generated
 */
public class CreateLineToolItemProvider extends CreateToolItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
        IItemPropertySource {
    /**
    ...
    public String getText(Object object) {
        String label = ((CreateLineTool) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_CreateLineTool_type") : getString("_UI_CreateLineTool_type") + " " + label;
    }
