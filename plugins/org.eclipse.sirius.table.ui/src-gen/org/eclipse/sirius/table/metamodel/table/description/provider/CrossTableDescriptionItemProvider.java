 ...
 * {@link org.eclipse.sirius.table.metamodel.table.description.CrossTableDescription} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class CrossTableDescriptionItemProvider extends TableDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(DescriptionPackage.Literals.CROSS_TABLE_DESCRIPTION__OWNED_COLUMN_MAPPINGS);
            childrenFeatures.add(DescriptionPackage.Literals.CROSS_TABLE_DESCRIPTION__INTERSECTION);
            childrenFeatures.add(DescriptionPackage.Literals.CROSS_TABLE_DESCRIPTION__CREATE_COLUMN);
        }
    ...
    /**
     * This returns CrossTableDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(CrossTableDescription.class)) {
