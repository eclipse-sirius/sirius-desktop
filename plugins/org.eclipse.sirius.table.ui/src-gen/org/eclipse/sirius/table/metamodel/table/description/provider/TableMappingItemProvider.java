...
import org.eclipse.sirius.description.provider.RepresentationElementMappingItemProvider;
 ...
 * @generated
 */
public class TableMappingItemProvider extends RepresentationElementMappingItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider,
    ...
    public String getText(Object object) {
        String label = ((TableMapping) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_TableMapping_type") : getString("_UI_TableMapping_type") + " " + label;
    }
