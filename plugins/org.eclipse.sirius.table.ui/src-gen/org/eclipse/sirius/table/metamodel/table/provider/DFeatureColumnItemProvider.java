...
public class DFeatureColumnItemProvider extends DColumnItemProvider {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/DFeatureColumn")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_DFeatureColumn_type") : //$NON-NLS-1$
            getString("_UI_DFeatureColumn_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
