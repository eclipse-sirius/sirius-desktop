...
import org.eclipse.sirius.description.tool.provider.RepresentationCreationDescriptionItemProvider;
 ...
 * @generated
 */
public class TableCreationDescriptionItemProvider extends RepresentationCreationDescriptionItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
    ...
    public String getText(Object object) {
        String label = ((TableCreationDescription) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_TableCreationDescription_type") : getString("_UI_TableCreationDescription_type") + " " + label;
    }
