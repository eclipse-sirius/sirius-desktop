 ...
 */
public class CreateEdgeViewTargetExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "TargetExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getCreateEdgeView_TargetExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "Expression returning the semantic target of the newly created Edge";
    }
