 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.editor.properties.sections.style.sizecomputationcontainerstyledescription;
...
/**
 * A section for the widthComputationExpression property of a SizeComputationContainerStyleDescription object.
 */
public class SizeComputationContainerStyleDescriptionWidthComputationExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "WidthComputationExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return StylePackage.eINSTANCE.getSizeComputationContainerStyleDescription_WidthComputationExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), SizeComputationContainerStyleDescriptionWidthComputationExpressionPropertySection.this,
                        text.getText());
                dialog.open();
