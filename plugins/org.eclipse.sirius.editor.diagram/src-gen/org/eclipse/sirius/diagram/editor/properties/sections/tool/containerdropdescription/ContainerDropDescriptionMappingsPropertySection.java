...
/**
 * A section for the mappings property of a ContainerDropDescription object.
 */
public class ContainerDropDescriptionMappingsPropertySection extends AbstractEditorDialogPropertySection {
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        text.setToolTipText("Mapping of the element to drop on the container");
        ...
        help.setToolTipText("Mapping of the element to drop on the container");
