...
/**
 * A section for the allActivatedTools property of a DiagramDescription object.
 */
public class DiagramDescriptionAllActivatedToolsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.diagram.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "AllActivatedTools"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return DescriptionPackage.eINSTANCE.getDiagramDescription_AllActivatedTools();
    }
