 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.editor.properties.sections.filter.mappingfilter;
 ...
 * object.
 */
public class MappingFilterSemanticConditionExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "SemanticConditionExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return FilterPackage.eINSTANCE.getMappingFilter_SemanticConditionExpression();
    }
