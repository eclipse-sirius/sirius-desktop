 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.editor.properties.sections.tool.toolsection;
...
/**
 * A section for the reusedTools property of a ToolSection object.
 */
public class ToolSectionReusedToolsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.diagram.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "ReusedTools"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return ToolPackage.eINSTANCE.getToolSection_ReusedTools();
    }
