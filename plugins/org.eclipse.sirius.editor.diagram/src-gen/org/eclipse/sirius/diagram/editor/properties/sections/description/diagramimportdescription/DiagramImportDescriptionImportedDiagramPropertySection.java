 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.editor.properties.sections.description.diagramimportdescription;
...
/**
 * A section for the importedDiagram property of a DiagramImportDescription object.
 */
public class DiagramImportDescriptionImportedDiagramPropertySection extends AbstractComboPropertySection {
    /**
     * @see org.eclipse.sirius.diagram.editor.properties.sections.AbstractComboPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "ImportedDiagram"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return DescriptionPackage.eINSTANCE.getDiagramImportDescription_ImportedDiagram();
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        combo.setToolTipText("Imported diagram description.");
        ...
        help.setToolTipText("Imported diagram description.");
