 ...
 */
public class OrderedTreeLayoutChildrenExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getPropertyDescription() {
        return "You should write here an expression returning, from a semantic element of the selected mappings, its semantic child so that the layout is able to build the hierarchy.";
    }
