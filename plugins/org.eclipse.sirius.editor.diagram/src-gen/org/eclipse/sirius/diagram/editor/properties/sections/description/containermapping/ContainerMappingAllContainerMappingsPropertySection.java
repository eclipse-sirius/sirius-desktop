...
/**
 * A section for the allContainerMappings property of a ContainerMapping object.
 */
public class ContainerMappingAllContainerMappingsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.diagram.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "AllContainerMappings"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return DescriptionPackage.eINSTANCE.getContainerMapping_AllContainerMappings();
    }
