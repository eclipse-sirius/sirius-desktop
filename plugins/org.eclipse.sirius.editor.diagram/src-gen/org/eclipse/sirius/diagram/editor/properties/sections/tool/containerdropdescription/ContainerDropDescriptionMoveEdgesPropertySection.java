...
/**
 * A section for the moveEdges property of a ContainerDropDescription object.
 */
public class ContainerDropDescriptionMoveEdgesPropertySection extends AbstractCheckBoxPropertySection {
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        checkbox.setToolTipText("If set to true, drop to the container will not invalidate the linked edges.");
