 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.editor.properties.sections.style.ellipsenodedescription;
...
public class EllipseNodeDescriptionHorizontalDiameterComputationExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "HorizontalDiameterComputationExpression"; //$NON-NLS-1$
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), EllipseNodeDescriptionHorizontalDiameterComputationExpressionPropertySection.this,
                        text.getText());
                dialog.open();
