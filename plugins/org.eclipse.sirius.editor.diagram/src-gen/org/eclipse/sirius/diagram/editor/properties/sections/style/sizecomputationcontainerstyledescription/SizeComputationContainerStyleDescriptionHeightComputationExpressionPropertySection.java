...
/**
 * A section for the heightComputationExpression property of a SizeComputationContainerStyleDescription object.
 */
public class SizeComputationContainerStyleDescriptionHeightComputationExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "HeightComputationExpression"; //$NON-NLS-1$
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), SizeComputationContainerStyleDescriptionHeightComputationExpressionPropertySection.this,
                        text.getText());
                dialog.open();
