...
/**
 * A section for the optional property of a AdditionalLayer object.
 */
public class AdditionalLayerOptionalPropertySection extends AbstractCheckBoxPropertySection {
    /**
    ...
    protected EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getAdditionalLayer_Optional();
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        checkbox.setToolTipText("If true, the end-user can deactivate this layer.");
        ...
        help.setToolTipText("If true, the end-user can deactivate this layer.");
    }
}
