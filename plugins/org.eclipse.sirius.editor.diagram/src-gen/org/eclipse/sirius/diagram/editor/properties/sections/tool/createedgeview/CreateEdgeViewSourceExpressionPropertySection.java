 ...
 *******************************************************************************/
package org.eclipse.sirius.diagram.editor.properties.sections.tool.createedgeview;
 ...
 */
public class CreateEdgeViewSourceExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "SourceExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getCreateEdgeView_SourceExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "Expression returning the semantic source of the newly created Edge";
    }
