...
/**
 * A section for the icon property of a Layer object.
 */
public class LayerIconPropertySection extends AbstractTextWithButtonPropertySection {
    ...
    protected String getPropertyDescription() {
        return "Optional icon for the layer.";
    }
