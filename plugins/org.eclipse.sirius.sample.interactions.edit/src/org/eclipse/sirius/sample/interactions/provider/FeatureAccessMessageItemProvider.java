 ...
 * @generated
 */
public class FeatureAccessMessageItemProvider extends MessageItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
        IItemPropertySource {
    /**
    ...
    protected void addIsWritePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_FeatureAccessMessage_isWrite_feature"), getString("_UI_PropertyDescriptor_description", "_UI_FeatureAccessMessage_isWrite_feature", "_UI_FeatureAccessMessage_type"),
    ...
    protected void addFeaturePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_FeatureAccessMessage_feature_feature"), getString("_UI_PropertyDescriptor_description", "_UI_FeatureAccessMessage_feature_feature", "_UI_FeatureAccessMessage_type"),
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/FeatureAccessMessage"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_FeatureAccessMessage_type") : getString("_UI_FeatureAccessMessage_type") + " " + label;
    }
