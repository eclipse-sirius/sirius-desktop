 ...
 * @generated
 */
public class ExecutionEndItemProvider extends AbstractEndItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
        IItemPropertySource {
    /**
    ...
    protected void addExecutionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_ExecutionEnd_execution_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ExecutionEnd_execution_feature", "_UI_ExecutionEnd_type"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ExecutionEnd_type") : getString("_UI_ExecutionEnd_type") + " " + label;
    }
