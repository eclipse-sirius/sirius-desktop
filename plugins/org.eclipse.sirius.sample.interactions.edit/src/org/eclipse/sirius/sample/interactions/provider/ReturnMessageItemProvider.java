...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.sample.interactions.ReturnMessage} object. <!--
...
public class ReturnMessageItemProvider extends MessageItemProvider {
    ...
    /**
     * This adds a property descriptor for the Invocation Message feature. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    protected void addInvocationMessagePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_ReturnMessage_invocationMessage_feature"), //$NON-NLS-1$
