...
public class CombinedFragmentItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider,
    ...
    protected void addOperatorPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_CombinedFragment_operator_feature"), getString("_UI_PropertyDescriptor_description", "_UI_CombinedFragment_operator_feature", "_UI_CombinedFragment_type"),
    ...
    protected void addCoveredParticipantsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_CombinedFragment_coveredParticipants_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_CombinedFragment_coveredParticipants_feature", "_UI_CombinedFragment_type"),
    ...
    protected void addStartPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_CombinedFragment_start_feature"), getString("_UI_PropertyDescriptor_description", "_UI_CombinedFragment_start_feature", "_UI_CombinedFragment_type"),
    ...
    protected void addFinishPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_CombinedFragment_finish_feature"), getString("_UI_PropertyDescriptor_description", "_UI_CombinedFragment_finish_feature", "_UI_CombinedFragment_type"),
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_CombinedFragment_type") : getString("_UI_CombinedFragment_type") + " " + label;
    }
