...
/**
 * A section for the mappings property of a RepresentationCreationDescription
 * object.
 */
public class RepresentationCreationDescriptionMappingsPropertySection extends AbstractEditorDialogWithListPropertySection {
    /**
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        text.setToolTipText("Mapping from which one may create this new representation.");
        ...
        help.setToolTipText("Mapping from which one may create this new representation.");
    ...
    protected List getCurrentValue() {
        return ((RepresentationCreationDescription) eObject).getMappings();
    }
            ...
            if (eObjectList.size() == 1) {
                ...
                if (eGet instanceof EList) {
                    for (Object object : (EList) eGet) {
                        compoundCommand.append(RemoveCommand.create(editingDomain, object, DescriptionPackage.eINSTANCE.getRepresentationElementMapping_DetailDescriptions(), eObject));
                    }
                }
                ...
                if (value instanceof EList) {
                    for (Iterator iterator = ((EList) value).iterator(); iterator.hasNext();) {
                        ...
                        compoundCommand.append(AddCommand.create(editingDomain, object, DescriptionPackage.eINSTANCE.getRepresentationElementMapping_DetailDescriptions(), eObject));
                    }
                }
                editingDomain.getCommandStack().execute(compoundCommand);
                // } else {
