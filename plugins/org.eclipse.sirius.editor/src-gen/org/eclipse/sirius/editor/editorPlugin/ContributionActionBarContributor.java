...
/**
 * This is the action bar contributor for the Contribution model editor.
 */
public class ContributionActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    public void contributeToMenu(IMenuManager menuManager) {
        ...
        IMenuManager submenuManager = new MenuManager(SiriusEditorPlugin.INSTANCE.getString("_UI_SiriusEditor_menu"), "contributionMenuID");
    ...
    public void menuAboutToShow(IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(SiriusEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        populateManager(submenuManager, createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(SiriusEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
