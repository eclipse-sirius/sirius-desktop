...
/**
 * A section for the conflicts property of a Sirius object.
 */
public class SiriusConflictsPropertySection extends AbstractTextPropertySection {
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getSirius_Conflicts();
    }
        ...
        selectionButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (eObject instanceof Sirius) {
                    Option<Set<URI>> userChoice = new SiriusDependenciesSelectionDialog((Sirius) eObject).selectConflictsSiriuss(composite.getShell());
                    if (userChoice.some()) {
