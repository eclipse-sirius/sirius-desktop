 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.validation.viewvalidationrule;
...
/**
 * A section for the targets property of a ViewValidationRule object.
 */
public class ViewValidationRuleTargetsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "Targets"; //$NON-NLS-1$
    }
