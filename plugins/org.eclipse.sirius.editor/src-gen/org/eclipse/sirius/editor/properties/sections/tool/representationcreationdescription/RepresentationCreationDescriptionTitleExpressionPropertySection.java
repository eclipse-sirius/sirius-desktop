 ...
 */
public class RepresentationCreationDescriptionTitleExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getPropertyDescription() {
        return "Expression to compute the default title of the representation to create. (new + name of this description if empty)";
    }
