 ...
 * object.
 */
public class DecorationDescriptionPreconditionExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getPropertyDescription() {
        return "Expression that filters the elements on which we want to display the decoration.";
    }
