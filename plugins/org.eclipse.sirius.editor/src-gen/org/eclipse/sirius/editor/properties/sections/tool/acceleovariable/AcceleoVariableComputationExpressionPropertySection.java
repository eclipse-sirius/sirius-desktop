 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.tool.acceleovariable;
 ...
 */
public class AcceleoVariableComputationExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "ComputationExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getAcceleoVariable_ComputationExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "Expression retrieving the variable value starting from the current element.";
    }
