...
import org.eclipse.sirius.editor.properties.ContributionPropertySheetPage;
 ...
 */
public abstract class AbstractContributionPropertySection extends AbstractPropertySection {
    /** The label width that will be used for section names. */
    public final static int LABEL_WIDTH = 120;

    /** The property sheet page for this section. */
    protected ContributionPropertySheetPage propertySheetPage;
     ...
     */
    public void createControls(Composite parent, ContributionPropertySheetPage aTabbedPropertySheetPage) {
        super.createControls(parent, aTabbedPropertySheetPage);
        this.propertySheetPage = aTabbedPropertySheetPage;
        updateSelection(this.propertySheetPage.getEditor().getSelection());
    }
