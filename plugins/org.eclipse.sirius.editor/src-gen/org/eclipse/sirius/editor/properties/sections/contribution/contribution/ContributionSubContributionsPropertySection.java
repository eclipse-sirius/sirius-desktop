 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.contribution.contribution;
...
/**
 * A section for the subContributions property of a Contribution object.
 */
public class ContributionSubContributionsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "SubContributions"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return ContributionPackage.eINSTANCE.getContribution_SubContributions();
    }
