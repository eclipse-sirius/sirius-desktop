 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.description.diagramelementmapping;
...
/**
 * A section for the synchronizationLock property of a DiagramElementMapping
 * object.
 */
public class DiagramElementMappingSynchronizationLockPropertySection extends AbstractCheckBoxPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractCheckBoxPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "SynchronizationLock"; //$NON-NLS-1$
    }
    ...
    protected EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getDiagramElementMapping_SynchronizationLock();
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        checkbox.setToolTipText("Set to true to force the synchronization of the elements of this mapping when the current diagram is in an unsynchronized mode.\nThis option is used only if createElements is true and the diagram which contain the elements of this mapping is unsynchronized.");
        ...
        help.setToolTipText("Set to true to force the synchronization of the elements of this mapping when the current diagram is in an unsynchronized mode.\nThis option is used only if createElements is true and the diagram which contain the elements of this mapping is unsynchronized.");
    }
}
