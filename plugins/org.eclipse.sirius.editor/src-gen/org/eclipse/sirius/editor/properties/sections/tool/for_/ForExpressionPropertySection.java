 ...
 */
public class ForExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getFor_Expression();
    }
    ...
    protected String getPropertyDescription() {
        return "Expression returning a list of elements to iterate over.";
    }
