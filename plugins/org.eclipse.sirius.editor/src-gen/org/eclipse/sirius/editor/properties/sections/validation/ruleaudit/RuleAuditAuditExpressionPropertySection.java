 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.validation.ruleaudit;
 ...
 */
public class RuleAuditAuditExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "AuditExpression"; //$NON-NLS-1$
    }
    ...
    protected String getPropertyDescription() {
        return "Expression to check, if it returns true, then everything is ok, if it returns false, a new validation error will appear.";
    }
