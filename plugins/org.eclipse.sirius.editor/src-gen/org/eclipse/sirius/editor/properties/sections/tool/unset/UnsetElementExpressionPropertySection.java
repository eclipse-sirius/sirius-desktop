 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.tool.unset;
 ...
 */
public class UnsetElementExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "ElementExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getUnset_ElementExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "Expression returning the value to unset.";
    }
