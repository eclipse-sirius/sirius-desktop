...
/**
 * A section for the name property of a IdentifiedElement object.
 */
public class IdentifiedElementNamePropertySection extends AbstractTextPropertySection {
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getIdentifiedElement_Name();
    }
    ...
    protected String getPropertyDescription() {
        return "The identifier of this element. Must be unique. Changing this identifier will break existing user models which reference the old identifier.";
    }
