...
/**
 * A section for the elementsToSelect property of a AbstractToolDescription object.
 */
public class AbstractToolDescriptionElementsToSelectPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "ElementsToSelect"; //$NON-NLS-1$
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractToolDescriptionElementsToSelectPropertySection.this, text.getText());
                dialog.open();
    ...
    protected String getPropertyDescription() {
        return "An expression used to define the selected elements after the tool execution.";
    }
