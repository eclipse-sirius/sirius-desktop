 ...
 */
public class DiagramDescriptionRootExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getDiagramDescription_RootExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "You can put here an expression to dynamically change the considered root for the diagram.";
    }
