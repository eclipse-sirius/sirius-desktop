 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.description.metamodelextensionsetting;
...
/**
 * A section for the extensionGroup property of a MetamodelExtensionSetting object.
 */
public class MetamodelExtensionSettingExtensionGroupPropertySection extends AbstractComboPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractComboPropertySection#getDefaultLabelText()
     */
    @Override
    protected String getDefaultLabelText() {
        return "ExtensionGroup"; //$NON-NLS-1$
    }
