 ...
 */
public class ColorStepAssociatedValuePropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "AssociatedValue"; //$NON-NLS-1$
    }
