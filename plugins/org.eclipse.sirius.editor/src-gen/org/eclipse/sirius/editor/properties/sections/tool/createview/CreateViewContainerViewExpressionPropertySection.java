 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.tool.createview;
 ...
 */
public class CreateViewContainerViewExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "ContainerViewExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getCreateView_ContainerViewExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "Expression returning the container view which will store the newly created view.";
    }
