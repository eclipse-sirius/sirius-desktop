 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.tool.featurechangelistener;
...
/**
 * A section for the featureName property of a FeatureChangeListener object.
 */
public class FeatureChangeListenerFeatureNamePropertySection extends AbstractTextPropertySection {
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getFeatureChangeListener_FeatureName();
    }
    ...
    protected String getPropertyDescription() {
        return "Feature name of the element to listen ";
    }
