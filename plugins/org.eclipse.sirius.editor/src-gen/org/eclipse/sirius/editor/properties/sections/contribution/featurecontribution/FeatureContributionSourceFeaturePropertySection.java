...
/**
 * A section for the sourceFeature property of a FeatureContribution object.
 */
public class FeatureContributionSourceFeaturePropertySection extends AbstractComboPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractComboPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "SourceFeature"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return ContributionPackage.eINSTANCE.getFeatureContribution_SourceFeature();
    }
    ...
    protected List<?> getChoiceOfValues() {
        ...
        if (eObject.eContainer() instanceof Contribution) {
            Contribution contrib = (Contribution) eObject.eContainer();
            if (contrib.getSource() instanceof DirectEObjectReference) {
                EObject actualSource = ((DirectEObjectReference) contrib.getSource()).getValue();
                if (actualSource != null) {
                    EClass sourceType = actualSource.eClass();
                    values = Lists.newArrayList(sourceType.getEAllStructuralFeatures());
                }
            }
        }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        combo.setToolTipText("The feature in the source object from which the contribution values are obtained.");
