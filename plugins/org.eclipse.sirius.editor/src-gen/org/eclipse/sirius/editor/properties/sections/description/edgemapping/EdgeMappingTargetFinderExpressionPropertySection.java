 ...
 */
public class EdgeMappingTargetFinderExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "TargetFinderExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getEdgeMapping_TargetFinderExpression();
    }
