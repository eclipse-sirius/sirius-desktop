...
public class DiagramElementMappingDeletionDescriptionPropertySection extends AbstractComboPropertySection {
    ...
    protected String getDefaultLabelText() {
        return "DeletionDescription"; //$NON-NLS-1$
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        combo.setToolTipText("Tool to call when the user ask for deletion. If you don't set this reference then\nthe default behavior is to remove all the associated semantic elements.");
        ...
        help.setToolTipText("Tool to call when the user ask for deletion. If you don't set this reference then\nthe default behavior is to remove all the associated semantic elements.");
