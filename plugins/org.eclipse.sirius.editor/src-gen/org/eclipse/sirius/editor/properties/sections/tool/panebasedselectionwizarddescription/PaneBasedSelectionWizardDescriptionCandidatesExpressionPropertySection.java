...
/**
 * A section for the candidatesExpression property of a PaneBasedSelectionWizardDescription object.
 */
public class PaneBasedSelectionWizardDescriptionCandidatesExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getPaneBasedSelectionWizardDescription_CandidatesExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), PaneBasedSelectionWizardDescriptionCandidatesExpressionPropertySection.this,
                        text.getText());
                dialog.open();
