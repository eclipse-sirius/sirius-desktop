 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.description.customization;
...
/**
 * A section for the vsmElementCustomizations property of a Customization
 * object.
 */
public class CustomizationVsmElementCustomizationsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "VsmElementCustomizations"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return DescriptionPackage.eINSTANCE.getCustomization_VsmElementCustomizations();
    }
