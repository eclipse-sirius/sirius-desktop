...
/**
 * A section for the reuses property of a Sirius object.
 */
public class SiriusReusesPropertySection extends AbstractTextPropertySection {
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getSirius_Reuses();
    }
        ...
        selectionButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (eObject instanceof Sirius) {
                    Option<Set<URI>> userChoice = new SiriusDependenciesSelectionDialog((Sirius) eObject).selectReusedSiriuss(composite.getShell());
                    if (userChoice.some()) {
