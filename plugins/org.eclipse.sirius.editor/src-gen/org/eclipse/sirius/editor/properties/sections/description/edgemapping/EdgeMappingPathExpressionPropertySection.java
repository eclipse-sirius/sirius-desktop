 ...
 */
public class EdgeMappingPathExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "PathExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getEdgeMapping_PathExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "You can use this feature to declare a path of element the edge should follow. The Edge will use this expression returning the list of semantic element it has to go through.";
    }
