 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.tool.moveelement;
 ...
 */
public class MoveElementNewContainerExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "NewContainerExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getMoveElement_NewContainerExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "Expression returning the new container instance.";
    }
