 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.tool.containercreationdescription;
...
/**
 * A section for the extraMappings property of a ContainerCreationDescription
 * object.
 */
public class ContainerCreationDescriptionExtraMappingsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "ExtraMappings"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return ToolPackage.eINSTANCE.getContainerCreationDescription_ExtraMappings();
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        text.setToolTipText("Usefull if you want to enable the tool on other mappings and then provide a specific behavior.");
