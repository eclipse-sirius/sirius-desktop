...
public abstract class AbstractCheckBoxPropertySection extends AbstractViewpointPropertySection {
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        checkbox = getWidgetFactory().createButton(composite, "", SWT.CHECK); //$NON-NLS-1$
        data = new FormData();
        ...
        data.right = new FormAttachment(checkbox, -ITabbedPropertyConstants.HSPACE - 20);
    ...
    /**
     * Handle the modification event for the check box.
     */
    protected void handleSelectionModified() {
        String newText = String.valueOf(checkbox.getSelection());
    ...
    public void refresh() {
        if (getFeatureAsText() != null)
            checkbox.setSelection(Boolean.parseBoolean(getFeatureAsText()));
    }
