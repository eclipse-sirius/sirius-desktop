...
/**
 * A section for the nodeMappings property of a NodeCreationDescription object.
 */
public class NodeCreationDescriptionNodeMappingsPropertySection extends AbstractEditorDialogPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractEditorDialogPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "NodeMappings"; //$NON-NLS-1$
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        text.setToolTipText("Node mappings you may need to create once the tool has been executed.");
        ...
        help.setToolTipText("Node mappings you may need to create once the tool has been executed.");
