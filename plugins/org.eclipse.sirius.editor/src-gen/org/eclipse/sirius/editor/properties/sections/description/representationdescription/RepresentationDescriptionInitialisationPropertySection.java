...
/**
 * A section for the initialisation property of a RepresentationDescription object.
 */
public class RepresentationDescriptionInitialisationPropertySection extends AbstractCheckBoxPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractCheckBoxPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "Initialisation"; //$NON-NLS-1$
    }
    ...
    protected EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getRepresentationDescription_Initialisation();
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        checkbox.setToolTipText("If set to true, the representation will be automatically created when creating a new session.");
