...
/**
 * A section for the preSelectedCandidatesExpression property of a PaneBasedSelectionWizardDescription object.
 */
public class PaneBasedSelectionWizardDescriptionPreSelectedCandidatesExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "PreSelectedCandidatesExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return ToolPackage.eINSTANCE.getPaneBasedSelectionWizardDescription_PreSelectedCandidatesExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), PaneBasedSelectionWizardDescriptionPreSelectedCandidatesExpressionPropertySection.this,
                        text.getText());
                dialog.open();
