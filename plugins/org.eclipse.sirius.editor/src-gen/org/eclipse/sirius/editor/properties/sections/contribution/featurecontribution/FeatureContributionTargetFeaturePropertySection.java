...
/**
 * A section for the targetFeature property of a FeatureContribution object.
 */
public class FeatureContributionTargetFeaturePropertySection extends AbstractComboPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractComboPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "TargetFeature"; //$NON-NLS-1$
    }
    ...
    protected List<?> getChoiceOfValues() {
        ...
        if (eObject.eContainer() instanceof Contribution) {
            ...
            if (contrib.getTarget() instanceof DirectEObjectReference) {
                EObject actualTarget = ((DirectEObjectReference) contrib.getTarget()).getValue();
                if (actualTarget != null) {
                    EClass targetType = actualTarget.eClass();
                    values = Lists.newArrayList(targetType.getEAllStructuralFeatures());
                }
            }
        }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        combo.setToolTipText("The feature in the target object to which the contribution values are applied.");
