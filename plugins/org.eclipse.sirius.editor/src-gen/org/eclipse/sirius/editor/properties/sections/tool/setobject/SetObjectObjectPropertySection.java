 ...
 *******************************************************************************/
package org.eclipse.sirius.editor.properties.sections.tool.setobject;
...
/**
 * A section for the object property of a SetObject object.
 */
public class SetObjectObjectPropertySection extends AbstractComboPropertySection {
    /**
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        combo.setToolTipText("Instance to set. To retrieve the instance list you may use the 'load resource' action of the editor.");
