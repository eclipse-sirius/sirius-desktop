...
/**
 * A section for the childrenExpression property of a PaneBasedSelectionWizardDescription object.
 */
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), PaneBasedSelectionWizardDescriptionChildrenExpressionPropertySection.this, text.getText());
                dialog.open();
