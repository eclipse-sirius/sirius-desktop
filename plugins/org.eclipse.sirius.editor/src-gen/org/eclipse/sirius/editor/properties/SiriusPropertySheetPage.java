...
/**
 * The Sirius's property sheet page.
 */
public class SiriusPropertySheetPage extends TabbedPropertySheetPage {
     ...
     */
    public SiriusPropertySheetPage(SiriusEditor editor) {
        super(editor);
        this.editor = editor;
    }
