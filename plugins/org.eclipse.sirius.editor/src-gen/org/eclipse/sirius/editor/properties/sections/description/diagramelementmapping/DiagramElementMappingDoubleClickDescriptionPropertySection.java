 ...
 * object.
 */
public class DiagramElementMappingDoubleClickDescriptionPropertySection extends AbstractComboPropertySection {
    /**
     * @see org.eclipse.sirius.editor.properties.sections.AbstractComboPropertySection#getDefaultLabelText()
     */
    protected String getDefaultLabelText() {
        return "DoubleClickDescription"; //$NON-NLS-1$
    }
    ...
    protected EReference getFeature() {
        return DescriptionPackage.eINSTANCE.getDiagramElementMapping_DoubleClickDescription();
    }
