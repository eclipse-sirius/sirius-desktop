...
/**
 * A section for the customizes property of a Sirius object.
 */
public class SiriusCustomizesPropertySection extends AbstractTextPropertySection {
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getSirius_Customizes();
    }
    ...
    public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
        ...
        selectionButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                if (eObject instanceof Sirius) {
                    Option<Set<URI>> userChoice = new SiriusDependenciesSelectionDialog((Sirius) eObject).selectCustomizedSiriuss(composite.getShell());
                    if (userChoice.some()) {
