 ...
 * object.
 */
public class RepresentationDescriptionTitleExpressionPropertySection extends AbstractTextPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return DescriptionPackage.eINSTANCE.getRepresentationDescription_TitleExpression();
    }
    ...
    protected String getPropertyDescription() {
        return "Expression to compute the default title of the representation. (new + name of this description if empty)";
    }
