...
/**
 * A section for the navigationNameExpression property of a RepresentationNavigationDescription object.
 */
public class RepresentationNavigationDescriptionNavigationNameExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "NavigationNameExpression"; //$NON-NLS-1$
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), RepresentationNavigationDescriptionNavigationNameExpressionPropertySection.this,
                        text.getText());
                dialog.open();
    ...
    protected String getPropertyDescription() {
        return "Expression used to build the name of the action contributed to the contextual menu. It's used only if the \"Browse expression\" field is filled.";
    }
