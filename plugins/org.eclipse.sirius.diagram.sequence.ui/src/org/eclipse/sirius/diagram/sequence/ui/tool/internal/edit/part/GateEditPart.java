...
public class GateEditPart extends AbstractSequenceBordered4EditPart {
    ...
    public IBorderItemLocator createBorderItemLocator(IFigure figure, DDiagramElement vpElementBorderItem) {
        if (AbstractNodeEvent.viewpointElementPredicate().apply(vpElementBorderItem) || AbstractMultiLifelineNodeEvent.viewpointElementPredicate().apply(vpElementBorderItem)) {
