 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.sequence.description.impl.GateMappingImpl#getStartingEndFinderExpression
 * <em>Starting End Finder Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.sequence.description.impl.GateMappingImpl#getFinishingEndFinderExpression
...
public class GateMappingImpl extends NodeMappingImpl implements GateMapping {
     ...
     * @ordered
     */
    protected String startingEndFinderExpression = GateMappingImpl.STARTING_END_FINDER_EXPRESSION_EDEFAULT;
     ...
     * @ordered
     */
    protected String finishingEndFinderExpression = GateMappingImpl.FINISHING_END_FINDER_EXPRESSION_EDEFAULT;
    ...
    public void setStartingEndFinderExpression(String newStartingEndFinderExpression) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, DescriptionPackage.GATE_MAPPING__STARTING_END_FINDER_EXPRESSION, oldStartingEndFinderExpression, startingEndFinderExpression));
        }
    }
    ...
    public void setFinishingEndFinderExpression(String newFinishingEndFinderExpression) {
        ...
        if (eNotificationRequired()) {
            eNotify(new ENotificationImpl(this, Notification.SET, DescriptionPackage.GATE_MAPPING__FINISHING_END_FINDER_EXPRESSION, oldFinishingEndFinderExpression, finishingEndFinderExpression));
        }
    }
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
        case DescriptionPackage.GATE_MAPPING__STARTING_END_FINDER_EXPRESSION:
            setStartingEndFinderExpression(GateMappingImpl.STARTING_END_FINDER_EXPRESSION_EDEFAULT);
            return;
        case DescriptionPackage.GATE_MAPPING__FINISHING_END_FINDER_EXPRESSION:
            setFinishingEndFinderExpression(GateMappingImpl.FINISHING_END_FINDER_EXPRESSION_EDEFAULT);
            return;
        }
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
        case DescriptionPackage.GATE_MAPPING__STARTING_END_FINDER_EXPRESSION:
            return GateMappingImpl.STARTING_END_FINDER_EXPRESSION_EDEFAULT == null ? startingEndFinderExpression != null
                    : !GateMappingImpl.STARTING_END_FINDER_EXPRESSION_EDEFAULT.equals(startingEndFinderExpression);
        case DescriptionPackage.GATE_MAPPING__FINISHING_END_FINDER_EXPRESSION:
            return GateMappingImpl.FINISHING_END_FINDER_EXPRESSION_EDEFAULT == null ? finishingEndFinderExpression != null
                    : !GateMappingImpl.FINISHING_END_FINDER_EXPRESSION_EDEFAULT.equals(finishingEndFinderExpression);
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == DelimitedEventMapping.class) {
            ...
            case DescriptionPackage.DELIMITED_EVENT_MAPPING__STARTING_END_FINDER_EXPRESSION:
                return DescriptionPackage.GATE_MAPPING__STARTING_END_FINDER_EXPRESSION;
            case DescriptionPackage.DELIMITED_EVENT_MAPPING__FINISHING_END_FINDER_EXPRESSION:
                return DescriptionPackage.GATE_MAPPING__FINISHING_END_FINDER_EXPRESSION;
            default:
                return -1;
            }
        }
