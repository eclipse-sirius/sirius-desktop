...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>Interaction Use Creation Tool</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.diagram.sequence.description.tool.impl.InteractionUseCreationToolImpl#getStartingEndPredecessor
 * <em>Starting End Predecessor</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.sequence.description.tool.impl.InteractionUseCreationToolImpl#getFinishingEndPredecessor
 * <em>Finishing End Predecessor</em>}</li>
 * <li>{@link org.eclipse.sirius.diagram.sequence.description.tool.impl.InteractionUseCreationToolImpl#getCoveredLifelines
...
public class InteractionUseCreationToolImpl extends ContainerCreationDescriptionImpl implements InteractionUseCreationTool {
    ...
    public NotificationChain basicSetStartingEndPredecessor(MessageEndVariable newStartingEndPredecessor, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ToolPackage.INTERACTION_USE_CREATION_TOOL__STARTING_END_PREDECESSOR, oldStartingEndPredecessor,
    ...
    public void setStartingEndPredecessor(MessageEndVariable newStartingEndPredecessor) {
        if (newStartingEndPredecessor != startingEndPredecessor) {
            ...
            if (startingEndPredecessor != null) {
                msgs = ((InternalEObject) startingEndPredecessor).eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INTERACTION_USE_CREATION_TOOL__STARTING_END_PREDECESSOR,
                        null, msgs);
            }
            if (newStartingEndPredecessor != null) {
                msgs = ((InternalEObject) newStartingEndPredecessor).eInverseAdd(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INTERACTION_USE_CREATION_TOOL__STARTING_END_PREDECESSOR,
                        null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ToolPackage.INTERACTION_USE_CREATION_TOOL__STARTING_END_PREDECESSOR, newStartingEndPredecessor, newStartingEndPredecessor));
        }
    }
    ...
    public NotificationChain basicSetFinishingEndPredecessor(MessageEndVariable newFinishingEndPredecessor, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ToolPackage.INTERACTION_USE_CREATION_TOOL__FINISHING_END_PREDECESSOR, oldFinishingEndPredecessor,
    ...
    public void setFinishingEndPredecessor(MessageEndVariable newFinishingEndPredecessor) {
        if (newFinishingEndPredecessor != finishingEndPredecessor) {
            ...
            if (finishingEndPredecessor != null) {
                msgs = ((InternalEObject) finishingEndPredecessor).eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INTERACTION_USE_CREATION_TOOL__FINISHING_END_PREDECESSOR,
                        null, msgs);
            }
            if (newFinishingEndPredecessor != null) {
                msgs = ((InternalEObject) newFinishingEndPredecessor).eInverseAdd(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INTERACTION_USE_CREATION_TOOL__FINISHING_END_PREDECESSOR,
                        null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ToolPackage.INTERACTION_USE_CREATION_TOOL__FINISHING_END_PREDECESSOR, newFinishingEndPredecessor, newFinishingEndPredecessor));
        }
    }
    ...
    public NotificationChain basicSetCoveredLifelines(CoveredLifelinesVariable newCoveredLifelines, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ToolPackage.INTERACTION_USE_CREATION_TOOL__COVERED_LIFELINES, oldCoveredLifelines, newCoveredLifelines);
            if (msgs == null) {
                msgs = notification;
            } else {
                msgs.add(notification);
    ...
    public void setCoveredLifelines(CoveredLifelinesVariable newCoveredLifelines) {
        if (newCoveredLifelines != coveredLifelines) {
            ...
            if (coveredLifelines != null) {
                msgs = ((InternalEObject) coveredLifelines).eInverseRemove(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INTERACTION_USE_CREATION_TOOL__COVERED_LIFELINES, null, msgs);
            }
            if (newCoveredLifelines != null) {
                msgs = ((InternalEObject) newCoveredLifelines).eInverseAdd(this, InternalEObject.EOPPOSITE_FEATURE_BASE - ToolPackage.INTERACTION_USE_CREATION_TOOL__COVERED_LIFELINES, null, msgs);
            }
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, ToolPackage.INTERACTION_USE_CREATION_TOOL__COVERED_LIFELINES, newCoveredLifelines, newCoveredLifelines));
        }
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == OrderedElementCreationTool.class) {
            ...
            case ToolPackage.ORDERED_ELEMENT_CREATION_TOOL__STARTING_END_PREDECESSOR:
                return ToolPackage.INTERACTION_USE_CREATION_TOOL__STARTING_END_PREDECESSOR;
            case ToolPackage.ORDERED_ELEMENT_CREATION_TOOL__FINISHING_END_PREDECESSOR:
                return ToolPackage.INTERACTION_USE_CREATION_TOOL__FINISHING_END_PREDECESSOR;
            default:
                return -1;
            }
        }
        if (baseClass == CoveringElementCreationTool.class) {
            ...
            case ToolPackage.COVERING_ELEMENT_CREATION_TOOL__COVERED_LIFELINES:
                return ToolPackage.INTERACTION_USE_CREATION_TOOL__COVERED_LIFELINES;
            default:
                return -1;
            }
        }
...
} // InteractionUseCreationToolImpl
