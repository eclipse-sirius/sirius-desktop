...
public class DescriptionPackageImpl extends EPackageImpl implements DescriptionPackage {
     ...
     */
    @Override
    public EClass getInteractionContainerMapping() {
        return interactionContainerMappingEClass;
    }
    ...
    public void initializePackageContents() {
        ...
        gateMappingEClass.getESuperTypes().add(this.getDelimitedEventMapping());
