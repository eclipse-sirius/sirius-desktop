...
/**
 * This cross referencer will allow us to detect all GMF elements referencing a
 * DDiagram element and have a way to later fix those cross references.
 * 
 * @author lgoubet <a
...
public class DiagramCrossReferencer extends EcoreUtil.CrossReferencer {
    ...
    /**
     * Default constructor. Delegates its work to its super-class then calls the
     * cross referencing.
     * 
     * @param resource
