...
/**
 * Default label alignment of Note's shapes have been updated in GMF runtime
 * 1.8.0 (see https://bugs.eclipse.org/bugs/show_bug.cgi?id=432387). This
 * migration participant restores the old default alignment value.
 * 
...
public class NoteShapeDefaultLabelAlignmentMigrationParticipant extends AbstractRepresentationsFileMigrationParticipant {
     ...
     */
    private static final Version MIGRATION_VERSION = new Version("11.1.5.201704181500"); //$NON-NLS-1$
    ...
    /**
     * Get the {@link Shape}s with Note types contained in the given resource to
     * migrate.
     * 
     * @param dAnalysis
     *            The analysis of the resource to migrate.
     * @return the {@link Shape}s with Note types contained in the given
     *         resource to migrate.
     */
    ...
    /**
     * Get the {@link Shape}s with Note types contained in the given
     * {@link DDiagram}.
     * 
     * @param dDiagram
