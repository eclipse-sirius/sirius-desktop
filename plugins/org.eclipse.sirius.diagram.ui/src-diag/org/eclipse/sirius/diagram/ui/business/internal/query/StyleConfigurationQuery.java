...
public class StyleConfigurationQuery {
    ...
    protected boolean labelIconsMustBeHidden(DDiagramElement element) {
        ...
        if (element instanceof DEdge) {
            mustHideLabelIconsOnShape = prefs.getBoolean(SiriusDiagramPreferencesKeys.PREF_HIDE_LABEL_ICONS_ON_CONNECTORS.name());
        } else {
            if (element instanceof AbstractDNode) {
                mustHideLabelIconsOnShape = prefs.getBoolean(SiriusDiagramPreferencesKeys.PREF_HIDE_LABEL_ICONS_ON_SHAPES.name());
            }
        }
