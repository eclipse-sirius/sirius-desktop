...
public class PasteImageAction extends Action implements IDisposableAction {
     ...
     * tooltip, enabled, checked...) has changed. This method must called <strong>before</strong> <code>init()</code>: the
     * listener will be effective from <code>init()</code> to <code>dispose()</code>. The listener will be removed when
     * action is disposed.
     * 
     * @param listener
