...
/**
 * A section for the imageExpression property of a WidgetAction object.
 * 
 * @author sbegaudeau
 */
public class WidgetActionImageExpressionPropertySectionSpec extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    @Override
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), WidgetActionImageExpressionPropertySectionSpec.this, text.getText());
                dialog.open();
