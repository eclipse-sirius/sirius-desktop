...
/**
 * A section for the tooltip expression of the toolbar action.
 * 
 * @author sbegaudeau
 */
public class ToolbarActionTooltipExpressionPropertySectionSpec extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    @Override
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ToolbarActionTooltipExpressionPropertySectionSpec.this, text.getText());
                dialog.open();
