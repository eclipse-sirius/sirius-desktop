...
/**
 * A section for the filterGroupsFromExtendedPageExpression property of a AbstractPageDescription object.
 */
public class AbstractPageDescriptionFilterGroupsFromExtendedPageExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterGroupsFromExtendedPageExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractPageDescription_FilterGroupsFromExtendedPageExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractPageDescriptionFilterGroupsFromExtendedPageExpressionPropertySection.this,
                        text.getText());
                dialog.open();
