...
/**
 * A section for the descriptionExpression property of a WizardModelOperation object.
 */
public class WizardModelOperationDescriptionExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), WizardModelOperationDescriptionExpressionPropertySection.this, text.getText());
                dialog.open();
