...
/**
 * A section for the helpExpression property of a AbstractWidgetDescription object.
 */
public class AbstractWidgetDescriptionHelpExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractWidgetDescriptionHelpExpressionPropertySection.this, text.getText());
                dialog.open();
