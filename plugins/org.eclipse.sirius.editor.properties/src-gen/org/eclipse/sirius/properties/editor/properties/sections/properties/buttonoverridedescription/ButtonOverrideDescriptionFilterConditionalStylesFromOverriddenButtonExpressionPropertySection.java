 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.buttonoverridedescription;
...
/**
 * A section for the filterConditionalStylesFromOverriddenButtonExpression property of a ButtonOverrideDescription
 * object.
 */
public class ButtonOverrideDescriptionFilterConditionalStylesFromOverriddenButtonExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenButtonExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getButtonOverrideDescription_FilterConditionalStylesFromOverriddenButtonExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        ButtonOverrideDescriptionFilterConditionalStylesFromOverriddenButtonExpressionPropertySection.this, text.getText());
                dialog.open();
