 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractcheckboxdescription;
...
/**
 * A section for the filterConditionalStylesFromExtendedCheckboxExpression property of a AbstractCheckboxDescription
 * object.
 */
public class AbstractCheckboxDescriptionFilterConditionalStylesFromExtendedCheckboxExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedCheckboxExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractCheckboxDescription_FilterConditionalStylesFromExtendedCheckboxExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractCheckboxDescriptionFilterConditionalStylesFromExtendedCheckboxExpressionPropertySection.this, text.getText());
                dialog.open();
