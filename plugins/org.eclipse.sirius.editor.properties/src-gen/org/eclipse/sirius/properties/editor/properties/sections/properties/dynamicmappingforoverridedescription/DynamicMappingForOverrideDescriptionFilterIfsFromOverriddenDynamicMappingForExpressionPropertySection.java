 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.dynamicmappingforoverridedescription;
...
/**
 * A section for the filterIfsFromOverriddenDynamicMappingForExpression property of a
 * DynamicMappingForOverrideDescription object.
 */
public class DynamicMappingForOverrideDescriptionFilterIfsFromOverriddenDynamicMappingForExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterIfsFromOverriddenDynamicMappingForExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getDynamicMappingForOverrideDescription_FilterIfsFromOverriddenDynamicMappingForExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        DynamicMappingForOverrideDescriptionFilterIfsFromOverriddenDynamicMappingForExpressionPropertySection.this, text.getText());
                dialog.open();
