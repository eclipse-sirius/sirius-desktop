...
/**
 * A section for the candidatesExpression property of a RadioDescription object.
 */
public class RadioDescriptionCandidatesExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), RadioDescriptionCandidatesExpressionPropertySection.this, text.getText());
                dialog.open();
