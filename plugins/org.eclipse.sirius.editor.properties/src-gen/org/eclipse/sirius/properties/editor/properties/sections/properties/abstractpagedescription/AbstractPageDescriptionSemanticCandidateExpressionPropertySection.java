...
/**
 * A section for the semanticCandidateExpression property of a AbstractPageDescription object.
 */
public class AbstractPageDescriptionSemanticCandidateExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractPageDescriptionSemanticCandidateExpressionPropertySection.this, text.getText());
                dialog.open();
