 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstracttextareadescription;
...
/**
 * A section for the filterConditionalStylesFromExtendedTextAreaExpression property of a AbstractTextAreaDescription
 * object.
 */
public class AbstractTextAreaDescriptionFilterConditionalStylesFromExtendedTextAreaExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedTextAreaExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractTextAreaDescription_FilterConditionalStylesFromExtendedTextAreaExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractTextAreaDescriptionFilterConditionalStylesFromExtendedTextAreaExpressionPropertySection.this, text.getText());
                dialog.open();
