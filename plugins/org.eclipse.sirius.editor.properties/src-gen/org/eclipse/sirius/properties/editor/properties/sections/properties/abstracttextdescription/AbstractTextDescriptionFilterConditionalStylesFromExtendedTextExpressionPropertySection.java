 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstracttextdescription;
...
/**
 * A section for the filterConditionalStylesFromExtendedTextExpression property of a AbstractTextDescription object.
 */
public class AbstractTextDescriptionFilterConditionalStylesFromExtendedTextExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedTextExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractTextDescription_FilterConditionalStylesFromExtendedTextExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractTextDescriptionFilterConditionalStylesFromExtendedTextExpressionPropertySection.this, text.getText());
                dialog.open();
