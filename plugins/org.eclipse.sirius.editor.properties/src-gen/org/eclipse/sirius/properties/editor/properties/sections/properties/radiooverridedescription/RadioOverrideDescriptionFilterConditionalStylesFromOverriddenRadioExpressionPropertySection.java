 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.radiooverridedescription;
...
/**
 * A section for the filterConditionalStylesFromOverriddenRadioExpression property of a RadioOverrideDescription object.
 */
public class RadioOverrideDescriptionFilterConditionalStylesFromOverriddenRadioExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenRadioExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getRadioOverrideDescription_FilterConditionalStylesFromOverriddenRadioExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        RadioOverrideDescriptionFilterConditionalStylesFromOverriddenRadioExpressionPropertySection.this, text.getText());
                dialog.open();
