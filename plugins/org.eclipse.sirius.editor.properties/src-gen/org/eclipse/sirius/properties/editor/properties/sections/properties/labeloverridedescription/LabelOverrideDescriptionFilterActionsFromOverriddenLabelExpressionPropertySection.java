 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.labeloverridedescription;
...
/**
 * A section for the filterActionsFromOverriddenLabelExpression property of a LabelOverrideDescription object.
 */
public class LabelOverrideDescriptionFilterActionsFromOverriddenLabelExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterActionsFromOverriddenLabelExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getLabelOverrideDescription_FilterActionsFromOverriddenLabelExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), LabelOverrideDescriptionFilterActionsFromOverriddenLabelExpressionPropertySection.this,
                        text.getText());
                dialog.open();
