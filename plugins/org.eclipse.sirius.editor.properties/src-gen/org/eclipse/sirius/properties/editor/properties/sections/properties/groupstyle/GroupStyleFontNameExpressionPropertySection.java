...
/**
 * A section for the fontNameExpression property of a GroupStyle object.
 */
public class GroupStyleFontNameExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getGroupStyle_FontNameExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), GroupStyleFontNameExpressionPropertySection.this, text.getText());
                dialog.open();
