...
/**
 * A section for the filterActionsFromOverriddenHyperlinkExpression property of a HyperlinkOverrideDescription object.
 */
public class HyperlinkOverrideDescriptionFilterActionsFromOverriddenHyperlinkExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterActionsFromOverriddenHyperlinkExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getHyperlinkOverrideDescription_FilterActionsFromOverriddenHyperlinkExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        HyperlinkOverrideDescriptionFilterActionsFromOverriddenHyperlinkExpressionPropertySection.this, text.getText());
                dialog.open();
