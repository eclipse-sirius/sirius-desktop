...
/**
 * A section for the filterConditionalStylesFromExtendedGroupExpression property of a AbstractGroupDescription object.
 */
public class AbstractGroupDescriptionFilterConditionalStylesFromExtendedGroupExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedGroupExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractGroupDescription_FilterConditionalStylesFromExtendedGroupExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractGroupDescriptionFilterConditionalStylesFromExtendedGroupExpressionPropertySection.this, text.getText());
                dialog.open();
