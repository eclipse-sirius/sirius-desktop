...
/**
 * A section for the fontSizeExpression property of a TextWidgetStyle object.
 */
public class TextWidgetStyleFontSizeExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), TextWidgetStyleFontSizeExpressionPropertySection.this, text.getText());
                dialog.open();
