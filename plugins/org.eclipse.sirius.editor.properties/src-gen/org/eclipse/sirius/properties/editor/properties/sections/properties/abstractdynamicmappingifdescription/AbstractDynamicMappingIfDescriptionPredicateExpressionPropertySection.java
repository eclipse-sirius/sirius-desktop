 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractdynamicmappingifdescription;
...
/**
 * A section for the predicateExpression property of a AbstractDynamicMappingIfDescription object.
 */
public class AbstractDynamicMappingIfDescriptionPredicateExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractDynamicMappingIfDescriptionPredicateExpressionPropertySection.this,
                        text.getText());
                dialog.open();
