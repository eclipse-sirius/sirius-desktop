...
/**
 * A section for the fontSizeExpression property of a GroupStyle object.
 */
public class GroupStyleFontSizeExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), GroupStyleFontSizeExpressionPropertySection.this, text.getText());
                dialog.open();
