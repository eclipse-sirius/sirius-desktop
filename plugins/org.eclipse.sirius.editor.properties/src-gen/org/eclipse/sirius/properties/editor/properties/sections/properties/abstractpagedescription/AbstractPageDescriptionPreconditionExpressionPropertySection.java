...
/**
 * A section for the preconditionExpression property of a AbstractPageDescription object.
 */
public class AbstractPageDescriptionPreconditionExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractPageDescriptionPreconditionExpressionPropertySection.this, text.getText());
                dialog.open();
