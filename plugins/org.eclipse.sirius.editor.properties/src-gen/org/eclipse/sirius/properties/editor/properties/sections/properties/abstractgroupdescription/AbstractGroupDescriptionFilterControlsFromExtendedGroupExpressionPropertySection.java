 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractgroupdescription;
...
/**
 * A section for the filterControlsFromExtendedGroupExpression property of a AbstractGroupDescription object.
 */
public class AbstractGroupDescriptionFilterControlsFromExtendedGroupExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterControlsFromExtendedGroupExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractGroupDescription_FilterControlsFromExtendedGroupExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractGroupDescriptionFilterControlsFromExtendedGroupExpressionPropertySection.this,
                        text.getText());
                dialog.open();
