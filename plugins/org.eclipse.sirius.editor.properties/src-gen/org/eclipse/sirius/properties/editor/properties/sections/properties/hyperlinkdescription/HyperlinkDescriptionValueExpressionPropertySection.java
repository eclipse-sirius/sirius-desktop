...
/**
 * A section for the valueExpression property of a HyperlinkDescription object.
 */
public class HyperlinkDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), HyperlinkDescriptionValueExpressionPropertySection.this, text.getText());
                dialog.open();
