...
/**
 * A section for the displayExpression property of a AbstractLabelDescription object.
 */
public class AbstractLabelDescriptionDisplayExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractLabelDescriptionDisplayExpressionPropertySection.this, text.getText());
                dialog.open();
