 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractdynamicmappingfordescription;
...
/**
 * A section for the filterIfsFromExtendedDynamicMappingForExpression property of a AbstractDynamicMappingForDescription
 * object.
 */
public class AbstractDynamicMappingForDescriptionFilterIfsFromExtendedDynamicMappingForExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterIfsFromExtendedDynamicMappingForExpression"; //$NON-NLS-1$
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractDynamicMappingForDescriptionFilterIfsFromExtendedDynamicMappingForExpressionPropertySection.this, text.getText());
                dialog.open();
