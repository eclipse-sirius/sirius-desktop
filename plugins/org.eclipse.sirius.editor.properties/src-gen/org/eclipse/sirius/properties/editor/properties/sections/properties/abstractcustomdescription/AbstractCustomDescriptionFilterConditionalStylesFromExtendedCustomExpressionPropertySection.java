 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractcustomdescription;
...
/**
 * A section for the filterConditionalStylesFromExtendedCustomExpression property of a AbstractCustomDescription object.
 */
public class AbstractCustomDescriptionFilterConditionalStylesFromExtendedCustomExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedCustomExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractCustomDescription_FilterConditionalStylesFromExtendedCustomExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractCustomDescriptionFilterConditionalStylesFromExtendedCustomExpressionPropertySection.this, text.getText());
                dialog.open();
