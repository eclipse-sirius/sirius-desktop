...
/**
 * A section for the fontNameExpression property of a TextWidgetStyle object.
 */
public class TextWidgetStyleFontNameExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), TextWidgetStyleFontNameExpressionPropertySection.this, text.getText());
                dialog.open();
