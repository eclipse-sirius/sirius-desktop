 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.pageoverridedescription;
...
/**
 * A section for the filterGroupsFromOverriddenPageExpression property of a PageOverrideDescription object.
 */
public class PageOverrideDescriptionFilterGroupsFromOverriddenPageExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterGroupsFromOverriddenPageExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getPageOverrideDescription_FilterGroupsFromOverriddenPageExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), PageOverrideDescriptionFilterGroupsFromOverriddenPageExpressionPropertySection.this,
                        text.getText());
                dialog.open();
