 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.buttondescription;
...
/**
 * A section for the buttonLabelExpression property of a ButtonDescription object.
 */
public class ButtonDescriptionButtonLabelExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "ButtonLabelExpression"; //$NON-NLS-1$
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ButtonDescriptionButtonLabelExpressionPropertySection.this, text.getText());
                dialog.open();
