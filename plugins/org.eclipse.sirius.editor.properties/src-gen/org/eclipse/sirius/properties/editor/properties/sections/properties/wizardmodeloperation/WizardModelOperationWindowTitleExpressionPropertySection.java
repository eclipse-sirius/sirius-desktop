...
/**
 * A section for the windowTitleExpression property of a WizardModelOperation object.
 */
public class WizardModelOperationWindowTitleExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), WizardModelOperationWindowTitleExpressionPropertySection.this, text.getText());
                dialog.open();
