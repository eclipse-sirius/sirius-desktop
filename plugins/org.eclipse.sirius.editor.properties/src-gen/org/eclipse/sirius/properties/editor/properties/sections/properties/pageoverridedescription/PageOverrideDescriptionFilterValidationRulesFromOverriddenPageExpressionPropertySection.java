...
/**
 * A section for the filterValidationRulesFromOverriddenPageExpression property of a PageOverrideDescription object.
 */
public class PageOverrideDescriptionFilterValidationRulesFromOverriddenPageExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterValidationRulesFromOverriddenPageExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getPageOverrideDescription_FilterValidationRulesFromOverriddenPageExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        PageOverrideDescriptionFilterValidationRulesFromOverriddenPageExpressionPropertySection.this, text.getText());
                dialog.open();
