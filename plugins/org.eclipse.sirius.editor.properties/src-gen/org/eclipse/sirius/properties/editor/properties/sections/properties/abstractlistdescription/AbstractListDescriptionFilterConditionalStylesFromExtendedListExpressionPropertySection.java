...
/**
 * A section for the filterConditionalStylesFromExtendedListExpression property of a AbstractListDescription object.
 */
public class AbstractListDescriptionFilterConditionalStylesFromExtendedListExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedListExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractListDescription_FilterConditionalStylesFromExtendedListExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractListDescriptionFilterConditionalStylesFromExtendedListExpressionPropertySection.this, text.getText());
                dialog.open();
