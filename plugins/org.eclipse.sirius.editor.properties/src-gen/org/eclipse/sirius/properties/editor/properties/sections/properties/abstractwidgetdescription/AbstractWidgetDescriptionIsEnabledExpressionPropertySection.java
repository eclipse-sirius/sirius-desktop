 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractwidgetdescription;
...
/**
 * A section for the isEnabledExpression property of a AbstractWidgetDescription object.
 */
public class AbstractWidgetDescriptionIsEnabledExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractWidgetDescriptionIsEnabledExpressionPropertySection.this, text.getText());
                dialog.open();
