...
/**
 * A section for the tooltipExpression property of a ToolbarAction object.
 */
public class ToolbarActionTooltipExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ToolbarActionTooltipExpressionPropertySection.this, text.getText());
                dialog.open();
