...
/**
 * A section for the candidatesExpression property of a AbstractSelectDescription object.
 */
public class AbstractSelectDescriptionCandidatesExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractSelectDescriptionCandidatesExpressionPropertySection.this, text.getText());
                dialog.open();
