 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstracthyperlinkdescription;
...
/**
 * A section for the filterConditionalStylesFromExtendedHyperlinkExpression property of a AbstractHyperlinkDescription
 * object.
 */
public class AbstractHyperlinkDescriptionFilterConditionalStylesFromExtendedHyperlinkExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedHyperlinkExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractHyperlinkDescription_FilterConditionalStylesFromExtendedHyperlinkExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractHyperlinkDescriptionFilterConditionalStylesFromExtendedHyperlinkExpressionPropertySection.this, text.getText());
                dialog.open();
