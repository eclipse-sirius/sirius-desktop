...
/**
 * A section for the fontSizeExpression property of a LabelWidgetStyle object.
 */
public class LabelWidgetStyleFontSizeExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FontSizeExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getLabelWidgetStyle_FontSizeExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), LabelWidgetStyleFontSizeExpressionPropertySection.this, text.getText());
                dialog.open();
