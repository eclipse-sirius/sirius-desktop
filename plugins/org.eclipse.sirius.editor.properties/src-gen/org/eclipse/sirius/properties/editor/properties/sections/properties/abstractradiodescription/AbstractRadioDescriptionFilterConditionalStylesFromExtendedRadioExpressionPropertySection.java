 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractradiodescription;
...
/**
 * A section for the filterConditionalStylesFromExtendedRadioExpression property of a AbstractRadioDescription object.
 */
public class AbstractRadioDescriptionFilterConditionalStylesFromExtendedRadioExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedRadioExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractRadioDescription_FilterConditionalStylesFromExtendedRadioExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractRadioDescriptionFilterConditionalStylesFromExtendedRadioExpressionPropertySection.this, text.getText());
                dialog.open();
