...
/**
 * A section for the valueExpression property of a AbstractSelectDescription object.
 */
public class AbstractSelectDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractSelectDescriptionValueExpressionPropertySection.this, text.getText());
                dialog.open();
