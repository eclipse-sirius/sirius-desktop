...
/**
 * A section for the isPageCompleteExpression property of a WizardModelOperation object.
 */
public class WizardModelOperationIsPageCompleteExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), WizardModelOperationIsPageCompleteExpressionPropertySection.this, text.getText());
                dialog.open();
