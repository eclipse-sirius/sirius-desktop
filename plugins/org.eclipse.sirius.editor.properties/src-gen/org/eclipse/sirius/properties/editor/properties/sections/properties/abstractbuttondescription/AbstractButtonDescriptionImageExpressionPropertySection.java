...
/**
 * A section for the imageExpression property of a AbstractButtonDescription object.
 */
public class AbstractButtonDescriptionImageExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractButtonDescriptionImageExpressionPropertySection.this, text.getText());
                dialog.open();
