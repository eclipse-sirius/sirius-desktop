...
/**
 * A section for the filterActionsFromExtendedHyperlinkExpression property of a AbstractHyperlinkDescription object.
 */
public class AbstractHyperlinkDescriptionFilterActionsFromExtendedHyperlinkExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterActionsFromExtendedHyperlinkExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractHyperlinkDescription_FilterActionsFromExtendedHyperlinkExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractHyperlinkDescriptionFilterActionsFromExtendedHyperlinkExpressionPropertySection.this, text.getText());
                dialog.open();
