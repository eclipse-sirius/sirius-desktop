 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.groupoverridedescription;
...
/**
 * A section for the filterControlsFromOverriddenGroupExpression property of a GroupOverrideDescription object.
 */
public class GroupOverrideDescriptionFilterControlsFromOverriddenGroupExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterControlsFromOverriddenGroupExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getGroupOverrideDescription_FilterControlsFromOverriddenGroupExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), GroupOverrideDescriptionFilterControlsFromOverriddenGroupExpressionPropertySection.this,
                        text.getText());
                dialog.open();
