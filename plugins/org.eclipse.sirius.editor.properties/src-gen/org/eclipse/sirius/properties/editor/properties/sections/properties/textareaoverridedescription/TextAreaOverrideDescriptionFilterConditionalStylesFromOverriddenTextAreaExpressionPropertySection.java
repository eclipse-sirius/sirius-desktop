 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.textareaoverridedescription;
...
/**
 * A section for the filterConditionalStylesFromOverriddenTextAreaExpression property of a TextAreaOverrideDescription
 * object.
 */
public class TextAreaOverrideDescriptionFilterConditionalStylesFromOverriddenTextAreaExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenTextAreaExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getTextAreaOverrideDescription_FilterConditionalStylesFromOverriddenTextAreaExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        TextAreaOverrideDescriptionFilterConditionalStylesFromOverriddenTextAreaExpressionPropertySection.this, text.getText());
                dialog.open();
