...
/**
 * A section for the valueExpression property of a RadioDescription object.
 */
public class RadioDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), RadioDescriptionValueExpressionPropertySection.this, text.getText());
                dialog.open();
