 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractcontainerdescription;
...
/**
 * A section for the filterControlsFromExtendedContainerExpression property of a AbstractContainerDescription object.
 */
public class AbstractContainerDescriptionFilterControlsFromExtendedContainerExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterControlsFromExtendedContainerExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractContainerDescription_FilterControlsFromExtendedContainerExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractContainerDescriptionFilterControlsFromExtendedContainerExpressionPropertySection.this, text.getText());
                dialog.open();
