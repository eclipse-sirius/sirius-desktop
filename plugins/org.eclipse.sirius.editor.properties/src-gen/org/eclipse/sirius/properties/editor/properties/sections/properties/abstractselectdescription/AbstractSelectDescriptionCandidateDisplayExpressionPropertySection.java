...
/**
 * A section for the candidateDisplayExpression property of a AbstractSelectDescription object.
 */
public class AbstractSelectDescriptionCandidateDisplayExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractSelectDescriptionCandidateDisplayExpressionPropertySection.this, text.getText());
                dialog.open();
