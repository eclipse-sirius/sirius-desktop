...
/**
 * A section for the fontNameExpression property of a HyperlinkWidgetStyle object.
 */
public class HyperlinkWidgetStyleFontNameExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getHyperlinkWidgetStyle_FontNameExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), HyperlinkWidgetStyleFontNameExpressionPropertySection.this, text.getText());
                dialog.open();
