 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.customexpression;
...
/**
 * A section for the customExpression property of a CustomExpression object.
 */
public class CustomExpressionCustomExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "CustomExpression"; //$NON-NLS-1$
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), CustomExpressionCustomExpressionPropertySection.this, text.getText());
                dialog.open();
