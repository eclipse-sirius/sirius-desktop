...
/**
 * A section for the titleExpression property of a WizardModelOperation object.
 */
public class WizardModelOperationTitleExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), WizardModelOperationTitleExpressionPropertySection.this, text.getText());
                dialog.open();
