...
/**
 * A section for the filterConditionalStylesFromOverriddenLabelExpression property of a LabelOverrideDescription object.
 */
public class LabelOverrideDescriptionFilterConditionalStylesFromOverriddenLabelExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenLabelExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getLabelOverrideDescription_FilterConditionalStylesFromOverriddenLabelExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        LabelOverrideDescriptionFilterConditionalStylesFromOverriddenLabelExpressionPropertySection.this, text.getText());
                dialog.open();
