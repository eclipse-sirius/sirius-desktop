...
/**
 * A section for the fontNameExpression property of a LabelWidgetStyle object.
 */
public class LabelWidgetStyleFontNameExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getLabelWidgetStyle_FontNameExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), LabelWidgetStyleFontNameExpressionPropertySection.this, text.getText());
                dialog.open();
