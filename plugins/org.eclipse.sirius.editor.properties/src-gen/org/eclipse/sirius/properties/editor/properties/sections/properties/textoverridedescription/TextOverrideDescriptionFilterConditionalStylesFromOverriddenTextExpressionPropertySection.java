 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.textoverridedescription;
...
/**
 * A section for the filterConditionalStylesFromOverriddenTextExpression property of a TextOverrideDescription object.
 */
public class TextOverrideDescriptionFilterConditionalStylesFromOverriddenTextExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenTextExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getTextOverrideDescription_FilterConditionalStylesFromOverriddenTextExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        TextOverrideDescriptionFilterConditionalStylesFromOverriddenTextExpressionPropertySection.this, text.getText());
                dialog.open();
