...
/**
 * A section for the filterValidationRulesFromOverriddenGroupExpression property of a GroupOverrideDescription object.
 */
public class GroupOverrideDescriptionFilterValidationRulesFromOverriddenGroupExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterValidationRulesFromOverriddenGroupExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getGroupOverrideDescription_FilterValidationRulesFromOverriddenGroupExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        GroupOverrideDescriptionFilterValidationRulesFromOverriddenGroupExpressionPropertySection.this, text.getText());
                dialog.open();
