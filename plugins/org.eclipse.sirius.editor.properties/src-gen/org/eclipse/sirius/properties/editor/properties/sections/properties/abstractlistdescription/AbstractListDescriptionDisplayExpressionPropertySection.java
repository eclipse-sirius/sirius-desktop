...
/**
 * A section for the displayExpression property of a AbstractListDescription object.
 */
public class AbstractListDescriptionDisplayExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractListDescriptionDisplayExpressionPropertySection.this, text.getText());
                dialog.open();
