...
/**
 * A section for the filterConditionalStylesFromExtendedButtonExpression property of a AbstractButtonDescription object.
 */
public class AbstractButtonDescriptionFilterConditionalStylesFromExtendedButtonExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedButtonExpression"; //$NON-NLS-1$
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractButtonDescriptionFilterConditionalStylesFromExtendedButtonExpressionPropertySection.this, text.getText());
                dialog.open();
