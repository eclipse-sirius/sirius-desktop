 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.customoverridedescription;
...
/**
 * A section for the filterConditionalStylesFromOverriddenCustomExpression property of a CustomOverrideDescription
 * object.
 */
public class CustomOverrideDescriptionFilterConditionalStylesFromOverriddenCustomExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenCustomExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getCustomOverrideDescription_FilterConditionalStylesFromOverriddenCustomExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        CustomOverrideDescriptionFilterConditionalStylesFromOverriddenCustomExpressionPropertySection.this, text.getText());
                dialog.open();
