...
/**
 * A section for the labelExpression property of a AbstractGroupDescription object.
 */
public class AbstractGroupDescriptionLabelExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractGroupDescriptionLabelExpressionPropertySection.this, text.getText());
                dialog.open();
