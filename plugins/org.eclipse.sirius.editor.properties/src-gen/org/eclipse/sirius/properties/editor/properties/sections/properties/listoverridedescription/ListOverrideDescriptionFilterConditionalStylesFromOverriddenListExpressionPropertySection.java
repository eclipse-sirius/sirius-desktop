...
/**
 * A section for the filterConditionalStylesFromOverriddenListExpression property of a ListOverrideDescription object.
 */
public class ListOverrideDescriptionFilterConditionalStylesFromOverriddenListExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenListExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getListOverrideDescription_FilterConditionalStylesFromOverriddenListExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        ListOverrideDescriptionFilterConditionalStylesFromOverriddenListExpressionPropertySection.this, text.getText());
                dialog.open();
