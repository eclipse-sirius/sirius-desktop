...
/**
 * A section for the valueExpression property of a AbstractCheckboxDescription object.
 */
public class AbstractCheckboxDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractCheckboxDescriptionValueExpressionPropertySection.this, text.getText());
                dialog.open();
