...
/**
 * A section for the labelExpression property of a DialogButton object.
 */
public class DialogButtonLabelExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getDialogButton_LabelExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), DialogButtonLabelExpressionPropertySection.this, text.getText());
                dialog.open();
