...
/**
 * A section for the filterConditionalStylesFromExtendedLabelExpression property of a AbstractLabelDescription object.
 */
public class AbstractLabelDescriptionFilterConditionalStylesFromExtendedLabelExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromExtendedLabelExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractLabelDescription_FilterConditionalStylesFromExtendedLabelExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractLabelDescriptionFilterConditionalStylesFromExtendedLabelExpressionPropertySection.this, text.getText());
                dialog.open();
