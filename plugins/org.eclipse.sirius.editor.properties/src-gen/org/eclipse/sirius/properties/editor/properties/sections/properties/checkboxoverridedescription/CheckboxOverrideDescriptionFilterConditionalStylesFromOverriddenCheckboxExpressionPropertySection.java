 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.checkboxoverridedescription;
...
/**
 * A section for the filterConditionalStylesFromOverriddenCheckboxExpression property of a CheckboxOverrideDescription
 * object.
 */
public class CheckboxOverrideDescriptionFilterConditionalStylesFromOverriddenCheckboxExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenCheckboxExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getCheckboxOverrideDescription_FilterConditionalStylesFromOverriddenCheckboxExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        CheckboxOverrideDescriptionFilterConditionalStylesFromOverriddenCheckboxExpressionPropertySection.this, text.getText());
                dialog.open();
