...
/**
 * A section for the valueExpression property of a AbstractHyperlinkDescription object.
 */
public class AbstractHyperlinkDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractHyperlinkDescriptionValueExpressionPropertySection.this, text.getText());
                dialog.open();
