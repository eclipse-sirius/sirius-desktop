...
/**
 * A section for the imageExpression property of a ToolbarAction object.
 */
public class ToolbarActionImageExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ToolbarActionImageExpressionPropertySection.this, text.getText());
                dialog.open();
