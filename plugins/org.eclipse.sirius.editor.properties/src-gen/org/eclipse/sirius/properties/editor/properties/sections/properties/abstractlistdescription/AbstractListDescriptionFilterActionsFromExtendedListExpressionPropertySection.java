 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractlistdescription;
...
/**
 * A section for the filterActionsFromExtendedListExpression property of a AbstractListDescription object.
 */
public class AbstractListDescriptionFilterActionsFromExtendedListExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterActionsFromExtendedListExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractListDescription_FilterActionsFromExtendedListExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractListDescriptionFilterActionsFromExtendedListExpressionPropertySection.this,
                        text.getText());
                dialog.open();
