 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.listoverridedescription;
...
/**
 * A section for the filterActionsFromOverriddenListExpression property of a ListOverrideDescription object.
 */
public class ListOverrideDescriptionFilterActionsFromOverriddenListExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterActionsFromOverriddenListExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getListOverrideDescription_FilterActionsFromOverriddenListExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), ListOverrideDescriptionFilterActionsFromOverriddenListExpressionPropertySection.this,
                        text.getText());
                dialog.open();
