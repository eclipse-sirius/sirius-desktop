...
/**
 * A section for the valueExpression property of a AbstractTextDescription object.
 */
public class AbstractTextDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractTextDescription_ValueExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractTextDescriptionValueExpressionPropertySection.this, text.getText());
                dialog.open();
