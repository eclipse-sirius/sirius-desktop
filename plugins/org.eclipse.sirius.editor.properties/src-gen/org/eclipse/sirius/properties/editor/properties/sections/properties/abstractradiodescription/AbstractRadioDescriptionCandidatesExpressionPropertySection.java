...
/**
 * A section for the candidatesExpression property of a AbstractRadioDescription object.
 */
public class AbstractRadioDescriptionCandidatesExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractRadioDescriptionCandidatesExpressionPropertySection.this, text.getText());
                dialog.open();
