...
/**
 * A section for the preconditionExpression property of a AbstractGroupDescription object.
 */
public class AbstractGroupDescriptionPreconditionExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractGroupDescriptionPreconditionExpressionPropertySection.this, text.getText());
                dialog.open();
