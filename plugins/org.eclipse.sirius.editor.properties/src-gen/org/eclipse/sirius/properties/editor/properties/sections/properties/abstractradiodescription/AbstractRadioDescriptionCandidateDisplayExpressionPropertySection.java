...
/**
 * A section for the candidateDisplayExpression property of a AbstractRadioDescription object.
 */
public class AbstractRadioDescriptionCandidateDisplayExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractRadioDescriptionCandidateDisplayExpressionPropertySection.this, text.getText());
                dialog.open();
