...
/**
 * A section for the semanticCandidateExpression property of a GroupDescription object.
 */
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), GroupDescriptionSemanticCandidateExpressionPropertySection.this, text.getText());
                dialog.open();
