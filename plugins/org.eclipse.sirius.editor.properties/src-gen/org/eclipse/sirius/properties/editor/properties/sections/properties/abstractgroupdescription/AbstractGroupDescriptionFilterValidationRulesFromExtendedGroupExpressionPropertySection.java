...
/**
 * A section for the filterValidationRulesFromExtendedGroupExpression property of a AbstractGroupDescription object.
 */
public class AbstractGroupDescriptionFilterValidationRulesFromExtendedGroupExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterValidationRulesFromExtendedGroupExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractGroupDescription_FilterValidationRulesFromExtendedGroupExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        AbstractGroupDescriptionFilterValidationRulesFromExtendedGroupExpressionPropertySection.this, text.getText());
                dialog.open();
