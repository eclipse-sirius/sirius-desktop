 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.abstractlabeldescription;
...
/**
 * A section for the filterActionsFromExtendedLabelExpression property of a AbstractLabelDescription object.
 */
public class AbstractLabelDescriptionFilterActionsFromExtendedLabelExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterActionsFromExtendedLabelExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractLabelDescription_FilterActionsFromExtendedLabelExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractLabelDescriptionFilterActionsFromExtendedLabelExpressionPropertySection.this,
                        text.getText());
                dialog.open();
