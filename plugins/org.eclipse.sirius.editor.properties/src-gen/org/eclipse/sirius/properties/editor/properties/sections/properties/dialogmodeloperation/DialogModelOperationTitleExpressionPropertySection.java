 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.dialogmodeloperation;
...
/**
 * A section for the titleExpression property of a DialogModelOperation object.
 */
public class DialogModelOperationTitleExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getDialogModelOperation_TitleExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), DialogModelOperationTitleExpressionPropertySection.this, text.getText());
                dialog.open();
