...
/**
 * A section for the filterConditionalStylesFromOverriddenGroupExpression property of a GroupOverrideDescription object.
 */
public class GroupOverrideDescriptionFilterConditionalStylesFromOverriddenGroupExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterConditionalStylesFromOverriddenGroupExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getGroupOverrideDescription_FilterConditionalStylesFromOverriddenGroupExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        GroupOverrideDescriptionFilterConditionalStylesFromOverriddenGroupExpressionPropertySection.this, text.getText());
                dialog.open();
