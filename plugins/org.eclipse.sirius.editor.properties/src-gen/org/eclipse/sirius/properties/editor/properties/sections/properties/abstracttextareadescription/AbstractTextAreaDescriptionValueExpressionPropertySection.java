...
/**
 * A section for the valueExpression property of a AbstractTextAreaDescription object.
 */
public class AbstractTextAreaDescriptionValueExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getAbstractTextAreaDescription_ValueExpression();
    }
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), AbstractTextAreaDescriptionValueExpressionPropertySection.this, text.getText());
                dialog.open();
