 ...
 *******************************************************************************/
package org.eclipse.sirius.properties.editor.properties.sections.properties.containeroverridedescription;
...
/**
 * A section for the filterControlsFromOverriddenContainerExpression property of a ContainerOverrideDescription object.
 */
public class ContainerOverrideDescriptionFilterControlsFromOverriddenContainerExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected String getDefaultLabelText() {
        return "FilterControlsFromOverriddenContainerExpression"; //$NON-NLS-1$
    }
    ...
    public EAttribute getFeature() {
        return PropertiesPackage.eINSTANCE.getContainerOverrideDescription_FilterControlsFromOverriddenContainerExpression();
    }
        ...
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(),
                        ContainerOverrideDescriptionFilterControlsFromOverriddenContainerExpressionPropertySection.this, text.getText());
                dialog.open();
