...
/**
 * A section for the lineCount property of a AbstractTextAreaDescription object.
 */
public class AbstractTextAreaDescriptionLineCountPropertySection extends AbstractSpinnerPropertySection {
    /**
     * @see org.eclipse.sirius.properties.editor.properties.sections.AbstractSpinnerPropertySection#getDefaultLabelText()
     */
    @Override
    protected String getDefaultLabelText() {
        return "LineCount"; //$NON-NLS-1$
    }
