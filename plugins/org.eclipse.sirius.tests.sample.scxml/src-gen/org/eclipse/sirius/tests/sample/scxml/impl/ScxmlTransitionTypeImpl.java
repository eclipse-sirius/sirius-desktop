 ...
 * <ul>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getScxmlCoreExecutablecontent <em>Scxml Core Executablecontent</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getRaise <em>Raise</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getIf <em>If</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getForeach <em>Foreach</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getSend <em>Send</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getAssign <em>Assign</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getLog <em>Log</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getCancel <em>Cancel</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getCond <em>Cond</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlTransitionTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScxmlTransitionTypeImpl extends MinimalEObjectImpl.Container implements ScxmlTransitionType {
     ...
     * @ordered
     */
    protected TransitionTypeDatatype type = TYPE_EDEFAULT;
    ...
    public void unsetType() {
        ...
        typeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ScxmlPackage.SCXML_TRANSITION_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
    }
