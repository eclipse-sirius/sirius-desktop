 ...
 * <ul>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getScxmlParallelMix <em>Scxml Parallel Mix</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getOnentry <em>Onentry</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getOnexit <em>Onexit</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getState <em>State</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getParallel <em>Parallel</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getHistory <em>History</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getDatamodel <em>Datamodel</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getInvoke <em>Invoke</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlParallelTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScxmlParallelTypeImpl extends MinimalEObjectImpl.Container implements ScxmlParallelType {
    /**
     * The cached value of the '{@link #getScxmlParallelMix() <em>Scxml Parallel Mix</em>}' attribute list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ScxmlPackage.SCXML_PARALLEL_TYPE__SCXML_PARALLEL_MIX:
                if (coreType) return getScxmlParallelMix();
