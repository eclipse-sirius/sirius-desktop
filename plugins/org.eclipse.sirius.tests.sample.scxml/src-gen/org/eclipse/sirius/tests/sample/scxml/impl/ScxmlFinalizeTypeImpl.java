...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Finalize Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getScxmlCoreExecutablecontent <em>Scxml Core Executablecontent</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getRaise <em>Raise</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getIf <em>If</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getForeach <em>Foreach</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getSend <em>Send</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getScript <em>Script</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getAssign <em>Assign</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getLog <em>Log</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getCancel <em>Cancel</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlFinalizeTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScxmlFinalizeTypeImpl extends MinimalEObjectImpl.Container implements ScxmlFinalizeType {
     ...
     * @generated
     */
    protected ScxmlFinalizeTypeImpl() {
        super();
    }
    ...
    public FeatureMap getScxmlCoreExecutablecontent() {
        if (scxmlCoreExecutablecontent == null) {
            scxmlCoreExecutablecontent = new BasicFeatureMap(this, ScxmlPackage.SCXML_FINALIZE_TYPE__SCXML_CORE_EXECUTABLECONTENT);
        }
    ...
    public FeatureMap getAny() {
        return (FeatureMap)getScxmlCoreExecutablecontent().<FeatureMap.Entry>list(ScxmlPackage.Literals.SCXML_FINALIZE_TYPE__ANY);
    }
    ...
    public FeatureMap getAnyAttribute() {
        if (anyAttribute == null) {
            anyAttribute = new BasicFeatureMap(this, ScxmlPackage.SCXML_FINALIZE_TYPE__ANY_ATTRIBUTE);
        }
        return anyAttribute;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case ScxmlPackage.SCXML_FINALIZE_TYPE__ANY:
                return ((InternalEList<?>)getAny()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__RAISE:
                return ((InternalEList<?>)getRaise()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__IF:
                return ((InternalEList<?>)getIf()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__FOREACH:
                return ((InternalEList<?>)getForeach()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__SEND:
                return ((InternalEList<?>)getSend()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__SCRIPT:
                return ((InternalEList<?>)getScript()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__ASSIGN:
                return ((InternalEList<?>)getAssign()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__LOG:
                return ((InternalEList<?>)getLog()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__CANCEL:
                return ((InternalEList<?>)getCancel()).basicRemove(otherEnd, msgs);
            case ScxmlPackage.SCXML_FINALIZE_TYPE__ANY_ATTRIBUTE:
