 ...
 * <ul>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlInitialTypeImpl#getScxmlExtraContent <em>Scxml Extra Content</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlInitialTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlInitialTypeImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlInitialTypeImpl#getScxmlExtraContent1 <em>Scxml Extra Content1</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlInitialTypeImpl#getAny1 <em>Any1</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlInitialTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScxmlInitialTypeImpl extends MinimalEObjectImpl.Container implements ScxmlInitialType {
    ...
    public void setTransition(ScxmlTransitionType newTransition) {
        if (newTransition != transition) {
            ...
            if (transition != null)
                msgs = ((InternalEObject)transition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ScxmlPackage.SCXML_INITIAL_TYPE__TRANSITION, null, msgs);
            if (newTransition != null)
                msgs = ((InternalEObject)newTransition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ScxmlPackage.SCXML_INITIAL_TYPE__TRANSITION, null, msgs);
