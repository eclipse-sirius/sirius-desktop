 ...
 * <ul>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlHistoryTypeImpl#getScxmlExtraContent <em>Scxml Extra Content</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlHistoryTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlHistoryTypeImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlHistoryTypeImpl#getScxmlExtraContent1 <em>Scxml Extra Content1</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlHistoryTypeImpl#getAny1 <em>Any1</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlHistoryTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlHistoryTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.sirius.tests.sample.scxml.impl.ScxmlHistoryTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScxmlHistoryTypeImpl extends MinimalEObjectImpl.Container implements ScxmlHistoryType {
    ...
    /**
     * The cached value of the '{@link #getScxmlExtraContent1() <em>Scxml Extra Content1</em>}' attribute list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @ordered
     */
    protected HistoryTypeDatatype type = TYPE_EDEFAULT;
    ...
    public void setTransition(ScxmlTransitionType newTransition) {
        if (newTransition != transition) {
            ...
            if (transition != null)
                msgs = ((InternalEObject)transition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ScxmlPackage.SCXML_HISTORY_TYPE__TRANSITION, null, msgs);
            if (newTransition != null)
                msgs = ((InternalEObject)newTransition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ScxmlPackage.SCXML_HISTORY_TYPE__TRANSITION, null, msgs);
    ...
    public void unsetType() {
        ...
        typeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, ScxmlPackage.SCXML_HISTORY_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ScxmlPackage.SCXML_HISTORY_TYPE__SCXML_EXTRA_CONTENT1:
                if (coreType) return getScxmlExtraContent1();
