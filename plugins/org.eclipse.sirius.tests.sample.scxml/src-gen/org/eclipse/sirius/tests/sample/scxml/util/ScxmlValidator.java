...
public class ScxmlValidator extends EObjectValidator {
     ...
     */
    public static final  PatternMatcher [][] DURATION_DATATYPE__PATTERN__VALUES =
        new PatternMatcher [][] {
            new PatternMatcher [] {
                XMLTypeUtil.createPatternMatcher("\\d*(\\.\\d+)?(ms|s|m|h|d)")
            }
        };
    ...
    public boolean validateDurationDatatype_Pattern(String durationDatatype, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(ScxmlPackage.Literals.DURATION_DATATYPE, durationDatatype, DURATION_DATATYPE__PATTERN__VALUES, diagnostics, context);
    }
    ...
    public boolean validateEventTypeDatatype_Pattern(String eventTypeDatatype, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(ScxmlPackage.Literals.EVENT_TYPE_DATATYPE, eventTypeDatatype, EVENT_TYPE_DATATYPE__PATTERN__VALUES, diagnostics, context);
    }
     ...
     */
    public static final  PatternMatcher [][] EVENT_TYPES_DATATYPE__PATTERN__VALUES =
        new PatternMatcher [][] {
            new PatternMatcher [] {
    ...
    public boolean validateEventTypesDatatype_Pattern(String eventTypesDatatype, DiagnosticChain diagnostics, Map<Object, Object> context) {
        return validatePattern(ScxmlPackage.Literals.EVENT_TYPES_DATATYPE, eventTypesDatatype, EVENT_TYPES_DATATYPE__PATTERN__VALUES, diagnostics, context);
    }
