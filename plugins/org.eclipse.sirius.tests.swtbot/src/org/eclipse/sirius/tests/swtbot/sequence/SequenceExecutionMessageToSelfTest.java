    ...
    public void test_Delete_Message_And_Sub_Reflexive_Messages() throws Exception {
        ...
        try {
            ...
            try {
                ...
                Rectangle boundsE2 = assertExecutionHasValidScreenBounds(LIFELINE_B, 1, new Rectangle(0, verticalPosition + LayoutConstants.MIN_INTER_SEQUENCE_EVENTS_VERTICAL_GAP
                        + LayoutConstants.MESSAGE_TO_SELF_BENDPOINT_VERTICAL_GAP, 0, LayoutConstants.INTERACTION_EXECUTION_MIN_HEIGHT_AFTER_LAYOUT), false);
                Rectangle boundsM3 = assertNamedMessageHasValidScreenBounds(THIRD_MESSAGE_SYNC_CALL_ON_LIFELINE_B, new Rectangle(new Point(0, verticalPosition
                        + LayoutConstants.MIN_INTER_SEQUENCE_EVENTS_VERTICAL_GAP), new Point(0, verticalPosition + LayoutConstants.MIN_INTER_SEQUENCE_EVENTS_VERTICAL_GAP
                        + LayoutConstants.MESSAGE_TO_SELF_BENDPOINT_VERTICAL_GAP)), true, false);
                Rectangle boundsM4 = assertReturnMessageHasValidScreenBounds(LIFELINE_B, 1, new Rectangle(new Point(0, verticalPosition + LayoutConstants.MIN_INTER_SEQUENCE_EVENTS_VERTICAL_GAP
                        + LayoutConstants.MESSAGE_TO_SELF_BENDPOINT_VERTICAL_GAP + LayoutConstants.INTERACTION_EXECUTION_MIN_HEIGHT_AFTER_LAYOUT), new Point(0, verticalPosition
                        + LayoutConstants.MIN_INTER_SEQUENCE_EVENTS_VERTICAL_GAP + LayoutConstants.MESSAGE_TO_SELF_BENDPOINT_VERTICAL_GAP
                        + LayoutConstants.INTERACTION_EXECUTION_MIN_HEIGHT_AFTER_LAYOUT + LayoutConstants.MESSAGE_TO_SELF_BENDPOINT_VERTICAL_GAP)), false, false);

                // update E1
                boundsE1 = getExecutionScreenBounds(LIFELINE_B, 0);

                // Select all created messages
                ICondition checkSelected = CheckSelectedCondition.multipleSelection(editor, callMessageOnE1Bot.part(), returnMessageOfE1Bot.part(), e1Bot.part(), e2Bot.part(),
                        callMessageOnE2Bot.part(), returnMessageOfE2Bot.part());
