...
public class SequenceSpaceTest extends AbstractDefaultModelSequenceTests {
    ...
    /**
     * Verifies that vertical space insertion at the level of the first execution do add the space in the execution when
    ...
    /**
     * Verifies that vertical space insertion at the level of the first execution do add the space in the execution when
     * triggered from inside the execution.
     * 
     * @throws Exception
     *             Test error.
     */
    ...
    /**
     * Verifies that vertical space removal at the level of the first execution do remove the space in the execution and
     * triggered from canvas.
     * 
     * @throws Exception
     *             Test error.
    ...
    /**
     * Verifies that vertical space insertion in an operand condition in a combined fragment is OK.
     * 
     * @throws Exception
     *             Test error.
     */
    ...
    /**
     * Verifies that vertical space removal in an operand condition in a combined fragment is OK.
     * 
     * @throws Exception
     *             Test error.
     */
