...
import org.eclipse.sirius.diagram.ui.internal.edit.parts.DNodeEditPart.ViewNodeFigure;
...
public class NodeLabelPositionTest extends AbstractSiriusSwtBotGefTestCase {
    ...
    private static final String VIEWPOINT_LABEL = "tc-2321";
    ...
    protected void onSetUpAfterOpeningDesignerPerspective() throws Exception {
        ...
        final UIDiagramRepresentation diagram = localSession.getLocalSessionBrowser().perCategory().selectViewpoint(VIEWPOINT_LABEL).selectRepresentation(REPRESENTATION_NAME)
