 ...
 * @generated
 */
public class SiriusExpressionDescriptionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SiriusExpressionDescription_lowerBound_feature", "_UI_SiriusExpressionDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ExpressionPackage.Literals.SIRIUS_EXPRESSION_DESCRIPTION__LOWER_BOUND,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SiriusExpressionDescription_upperBound_feature", "_UI_SiriusExpressionDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ExpressionPackage.Literals.SIRIUS_EXPRESSION_DESCRIPTION__UPPER_BOUND,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SiriusExpressionDescription_expression_feature", "_UI_SiriusExpressionDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ExpressionPackage.Literals.SIRIUS_EXPRESSION_DESCRIPTION__EXPRESSION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SiriusExpressionDescription_returnType_feature", "_UI_SiriusExpressionDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ExpressionPackage.Literals.SIRIUS_EXPRESSION_DESCRIPTION__RETURN_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Variable Containers feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_SiriusExpressionDescription_variableContainers_feature", "_UI_SiriusExpressionDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ExpressionPackage.Literals.SIRIUS_EXPRESSION_DESCRIPTION__VARIABLE_CONTAINERS,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SiriusExpressionDescription.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionPackage.Literals.SIRIUS_EXPRESSION_DESCRIPTION__PARAMETERS,
