 ...
 * @generated
 */
public class SiriusVariableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SiriusVariable_name_feature"), //$NON-NLS-1$
				 ...
				 ExpressionPackage.Literals.SIRIUS_VARIABLE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExpressionPackage.Literals.SIRIUS_VARIABLE__DOCUMENTATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addETypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SiriusVariable_eType_feature"), //$NON-NLS-1$
				 ...
				 ExpressionPackage.Literals.SIRIUS_VARIABLE__ETYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SiriusVariable.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SiriusVariable_type") : //$NON-NLS-1$
