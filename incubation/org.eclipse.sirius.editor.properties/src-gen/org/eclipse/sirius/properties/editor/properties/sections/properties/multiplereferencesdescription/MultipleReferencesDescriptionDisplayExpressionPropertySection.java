...
/**
 * A section for the displayExpression property of a
 * MultipleReferencesDescription object.
 */
public class MultipleReferencesDescriptionDisplayExpressionPropertySection extends AbstractTextWithButtonPropertySection implements ContentProposalClient {
    ...
    protected SelectionListener createButtonListener() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                TextWithContentProposalDialog dialog = new TextWithContentProposalDialog(composite.getShell(), MultipleReferencesDescriptionDisplayExpressionPropertySection.this, text.getText());
                dialog.open();
