...
public class LabelWidgetStyleItemProvider extends WidgetStyleItemProvider {
    ...
    protected void addFontNameExpressionPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(
                createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(), getString("_UI_LabelWidgetStyle_fontNameExpression_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_LabelWidgetStyle_fontNameExpression_feature", "_UI_LabelWidgetStyle_type"),
    ...
    protected void addFontSizePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_LabelWidgetStyle_fontSize_feature"), getString("_UI_PropertyDescriptor_description", "_UI_LabelWidgetStyle_fontSize_feature", "_UI_LabelWidgetStyle_type"),
                PropertiesPackage.Literals.LABEL_WIDGET_STYLE__FONT_SIZE, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
    }
    ...
    protected void addBackgroundColorPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_LabelWidgetStyle_backgroundColor_feature"), getString("_UI_PropertyDescriptor_description", "_UI_LabelWidgetStyle_backgroundColor_feature", "_UI_LabelWidgetStyle_type"),
    ...
    protected void addForegroundColorPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_LabelWidgetStyle_foregroundColor_feature"), getString("_UI_PropertyDescriptor_description", "_UI_LabelWidgetStyle_foregroundColor_feature", "_UI_LabelWidgetStyle_type"),
    ...
    protected void addFontFormatPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_LabelWidgetStyle_fontFormat_feature"), getString("_UI_PropertyDescriptor_description", "_UI_LabelWidgetStyle_fontFormat_feature", "_UI_LabelWidgetStyle_type"),
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/LabelWidgetStyle"));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_LabelWidgetStyle_type") : getString("_UI_LabelWidgetStyle_type") + " " + label;
    }
